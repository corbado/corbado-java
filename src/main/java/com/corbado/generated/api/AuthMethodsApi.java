...
import com.corbado.generated.model.AuthMethodsListReq;
import com.corbado.generated.model.AuthMethodsListRsp;
...
public class AuthMethodsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AuthMethodsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AuthMethodsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for authMethodsList
     * @param authMethodsListReq  (required)
     ...
     */
    public okhttp3.Call authMethodsListCall(AuthMethodsListReq authMethodsListReq, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = authMethodsListReq;

        // create path and map variables
        String localVarPath = "/v1/authMethods";
    ...
    private okhttp3.Call authMethodsListValidateBeforeCall(AuthMethodsListReq authMethodsListReq, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'authMethodsListReq' is set
        if (authMethodsListReq == null) {
            throw new ApiException("Missing the required parameter 'authMethodsListReq' when calling authMethodsList(Async)");
        }

        return authMethodsListCall(authMethodsListReq, _callback);
     ...
     */
    public AuthMethodsListRsp authMethodsList(AuthMethodsListReq authMethodsListReq) throws ApiException {
        ApiResponse<AuthMethodsListRsp> localVarResp = authMethodsListWithHttpInfo(authMethodsListReq);
     ...
     * Retrieves possible authentication methods for provided username
     * @param authMethodsListReq  (required)
     * @return ApiResponse&lt;AuthMethodsListRsp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AuthMethodsListRsp> authMethodsListWithHttpInfo(AuthMethodsListReq authMethodsListReq) throws ApiException {
        okhttp3.Call localVarCall = authMethodsListValidateBeforeCall(authMethodsListReq, null);
        Type localVarReturnType = new TypeToken<AuthMethodsListRsp>(){}.getType();
     ...
     */
    public okhttp3.Call authMethodsListAsync(AuthMethodsListReq authMethodsListReq, final ApiCallback<AuthMethodsListRsp> _callback) throws ApiException {

        okhttp3.Call localVarCall = authMethodsListValidateBeforeCall(authMethodsListReq, _callback);
        Type localVarReturnType = new TypeToken<AuthMethodsListRsp>(){}.getType();
