...
import com.corbado.generated.model.AssociationTokenCreateReq;
import com.corbado.generated.model.AssociationTokenCreateRsp;
...
public class AssociationTokensApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AssociationTokensApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AssociationTokensApi(ApiClient apiClient) {
    ...
    /**
     * Build call for associationTokenCreate
     * @param associationTokenCreateReq  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Association token successfully created </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call associationTokenCreateCall(AssociationTokenCreateReq associationTokenCreateReq, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = associationTokenCreateReq;

        // create path and map variables
        String localVarPath = "/v1/associationTokens";
    ...
    private okhttp3.Call associationTokenCreateValidateBeforeCall(AssociationTokenCreateReq associationTokenCreateReq, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'associationTokenCreateReq' is set
        if (associationTokenCreateReq == null) {
            throw new ApiException("Missing the required parameter 'associationTokenCreateReq' when calling associationTokenCreate(Async)");
        }

        return associationTokenCreateCall(associationTokenCreateReq, _callback);
     ...
     * @param associationTokenCreateReq  (required)
     * @return AssociationTokenCreateRsp
     ...
     */
    public AssociationTokenCreateRsp associationTokenCreate(AssociationTokenCreateReq associationTokenCreateReq) throws ApiException {
        ApiResponse<AssociationTokenCreateRsp> localVarResp = associationTokenCreateWithHttpInfo(associationTokenCreateReq);
     ...
     * Creates a new association token
     * @param associationTokenCreateReq  (required)
     * @return ApiResponse&lt;AssociationTokenCreateRsp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AssociationTokenCreateRsp> associationTokenCreateWithHttpInfo(AssociationTokenCreateReq associationTokenCreateReq) throws ApiException {
        okhttp3.Call localVarCall = associationTokenCreateValidateBeforeCall(associationTokenCreateReq, null);
        Type localVarReturnType = new TypeToken<AssociationTokenCreateRsp>(){}.getType();
     ...
     */
    public okhttp3.Call associationTokenCreateAsync(AssociationTokenCreateReq associationTokenCreateReq, final ApiCallback<AssociationTokenCreateRsp> _callback) throws ApiException {

        okhttp3.Call localVarCall = associationTokenCreateValidateBeforeCall(associationTokenCreateReq, _callback);
        Type localVarReturnType = new TypeToken<AssociationTokenCreateRsp>(){}.getType();
