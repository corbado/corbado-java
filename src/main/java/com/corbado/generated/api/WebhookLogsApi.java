...
import com.corbado.generated.model.WebhookLogsListRsp;
...
public class WebhookLogsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WebhookLogsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WebhookLogsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for webhookLogsList
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Webhook logs successfully retrieved </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call webhookLogsListCall(String remoteAddress, String userAgent, String sort, List<String> filter, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/webhookLogs";
    ...
    private okhttp3.Call webhookLogsListValidateBeforeCall(String remoteAddress, String userAgent, String sort, List<String> filter, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        return webhookLogsListCall(remoteAddress, userAgent, sort, filter, page, pageSize, _callback);
     ...
     */
    public WebhookLogsListRsp webhookLogsList(String remoteAddress, String userAgent, String sort, List<String> filter, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<WebhookLogsListRsp> localVarResp = webhookLogsListWithHttpInfo(remoteAddress, userAgent, sort, filter, page, pageSize);
     ...
     * @param page Page number (optional, default to 1)
     * @param pageSize Number of items per page (optional, default to 10)
     * @return ApiResponse&lt;WebhookLogsListRsp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WebhookLogsListRsp> webhookLogsListWithHttpInfo(String remoteAddress, String userAgent, String sort, List<String> filter, Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = webhookLogsListValidateBeforeCall(remoteAddress, userAgent, sort, filter, page, pageSize, null);
        Type localVarReturnType = new TypeToken<WebhookLogsListRsp>(){}.getType();
     ...
     */
    public okhttp3.Call webhookLogsListAsync(String remoteAddress, String userAgent, String sort, List<String> filter, Integer page, Integer pageSize, final ApiCallback<WebhookLogsListRsp> _callback) throws ApiException {

        okhttp3.Call localVarCall = webhookLogsListValidateBeforeCall(remoteAddress, userAgent, sort, filter, page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<WebhookLogsListRsp>(){}.getType();
