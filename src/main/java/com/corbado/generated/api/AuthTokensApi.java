...
import com.corbado.generated.model.AuthTokenValidateReq;
import com.corbado.generated.model.AuthTokenValidateRsp;
...
public class AuthTokensApi {
    ...
    /**
     * Build call for authTokenValidate
     * @param authTokenValidateReq  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Auth token successfully validated </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call authTokenValidateCall(AuthTokenValidateReq authTokenValidateReq, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = authTokenValidateReq;

        // create path and map variables
        String localVarPath = "/v1/authTokens/validate";
    ...
    private okhttp3.Call authTokenValidateValidateBeforeCall(AuthTokenValidateReq authTokenValidateReq, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'authTokenValidateReq' is set
        if (authTokenValidateReq == null) {
            throw new ApiException("Missing the required parameter 'authTokenValidateReq' when calling authTokenValidate(Async)");
        }

        return authTokenValidateCall(authTokenValidateReq, _callback);
     ...
     */
    public AuthTokenValidateRsp authTokenValidate(AuthTokenValidateReq authTokenValidateReq) throws ApiException {
        ApiResponse<AuthTokenValidateRsp> localVarResp = authTokenValidateWithHttpInfo(authTokenValidateReq);
     ...
     * Validates auth token and returns attached user data
     * @param authTokenValidateReq  (required)
     * @return ApiResponse&lt;AuthTokenValidateRsp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AuthTokenValidateRsp> authTokenValidateWithHttpInfo(AuthTokenValidateReq authTokenValidateReq) throws ApiException {
        okhttp3.Call localVarCall = authTokenValidateValidateBeforeCall(authTokenValidateReq, null);
        Type localVarReturnType = new TypeToken<AuthTokenValidateRsp>(){}.getType();
     ...
     */
    public okhttp3.Call authTokenValidateAsync(AuthTokenValidateReq authTokenValidateReq, final ApiCallback<AuthTokenValidateRsp> _callback) throws ApiException {

        okhttp3.Call localVarCall = authTokenValidateValidateBeforeCall(authTokenValidateReq, _callback);
        Type localVarReturnType = new TypeToken<AuthTokenValidateRsp>(){}.getType();
