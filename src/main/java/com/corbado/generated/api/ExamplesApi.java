...
import com.corbado.generated.model.ExampleGetRsp;
...
public class ExamplesApi {
     ...
     * @param fileName Name of the example to get (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Example project successfully retrieved </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call exampleGetCall(String fileName, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/examples/{fileName}"
    ...
    private okhttp3.Call exampleGetValidateBeforeCall(String fileName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fileName' is set
        if (fileName == null) {
            throw new ApiException("Missing the required parameter 'fileName' when calling exampleGet(Async)");
        }

        return exampleGetCall(fileName, _callback);
     ...
     */
    public ExampleGetRsp exampleGet(String fileName) throws ApiException {
        ApiResponse<ExampleGetRsp> localVarResp = exampleGetWithHttpInfo(fileName);
     ...
     * Retrieves file containing the named example project
     * @param fileName Name of the example to get (required)
     * @return ApiResponse&lt;ExampleGetRsp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ExampleGetRsp> exampleGetWithHttpInfo(String fileName) throws ApiException {
        okhttp3.Call localVarCall = exampleGetValidateBeforeCall(fileName, null);
        Type localVarReturnType = new TypeToken<ExampleGetRsp>(){}.getType();
     ...
     */
    public okhttp3.Call exampleGetAsync(String fileName, final ApiCallback<ExampleGetRsp> _callback) throws ApiException {

        okhttp3.Call localVarCall = exampleGetValidateBeforeCall(fileName, _callback);
        Type localVarReturnType = new TypeToken<ExampleGetRsp>(){}.getType();
