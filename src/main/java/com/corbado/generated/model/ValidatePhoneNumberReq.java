...
public class ValidatePhoneNumberReq {
  ...
  public ValidatePhoneNumberReq() {
  }

  public ValidatePhoneNumberReq regionCode(String regionCode) {
  ...
  **/
  ...
  public ValidatePhoneNumberReq phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public ValidatePhoneNumberReq requestID(String requestID) {
  ...
  **/
  ...
  public ValidatePhoneNumberReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ValidatePhoneNumberReq validatePhoneNumberReq = (ValidatePhoneNumberReq) o;
    return Objects.equals(this.regionCode, validatePhoneNumberReq.regionCode) &&
        Objects.equals(this.phoneNumber, validatePhoneNumberReq.phoneNumber) &&
        Objects.equals(this.requestID, validatePhoneNumberReq.requestID) &&
        Objects.equals(this.clientInfo, validatePhoneNumberReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regionCode, phoneNumber, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidatePhoneNumberReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ValidatePhoneNumberReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidatePhoneNumberReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidatePhoneNumberReq is not found in the empty JSON string", ValidatePhoneNumberReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidatePhoneNumberReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidatePhoneNumberReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidatePhoneNumberReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidatePhoneNumberReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidatePhoneNumberReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidatePhoneNumberReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidatePhoneNumberReq.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidatePhoneNumberReq>() {
           @Override
           public void write(JsonWriter out, ValidatePhoneNumberReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidatePhoneNumberReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ValidatePhoneNumberReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidatePhoneNumberReq
  * @throws IOException if the JSON string is invalid with respect to ValidatePhoneNumberReq
  */
  public static ValidatePhoneNumberReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidatePhoneNumberReq.class);
  }

 /**
  * Convert an instance of ValidatePhoneNumberReq to an JSON string
  *
  * @return JSON string
  */
