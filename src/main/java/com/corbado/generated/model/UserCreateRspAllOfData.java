...
public class UserCreateRspAllOfData {
  public static final String SERIALIZED_NAME_USER_I_D = "userID";
  @SerializedName(SERIALIZED_NAME_USER_I_D)
  private String userID;

  public static final String SERIALIZED_NAME_EMAIL_I_D = "emailID";
  @SerializedName(SERIALIZED_NAME_EMAIL_I_D)
  ...
  public UserCreateRspAllOfData() {
  }

  public UserCreateRspAllOfData userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public UserCreateRspAllOfData emailID(String emailID) {
  ...
  **/
  ...
  public UserCreateRspAllOfData phoneNumberID(String phoneNumberID) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserCreateRspAllOfData userCreateRspAllOfData = (UserCreateRspAllOfData) o;
    return Objects.equals(this.userID, userCreateRspAllOfData.userID) &&
        Objects.equals(this.emailID, userCreateRspAllOfData.emailID) &&
        Objects.equals(this.phoneNumberID, userCreateRspAllOfData.phoneNumberID);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userID, emailID, phoneNumberID);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserCreateRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserCreateRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserCreateRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserCreateRspAllOfData is not found in the empty JSON string", UserCreateRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserCreateRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserCreateRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserCreateRspAllOfData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserCreateRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserCreateRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserCreateRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserCreateRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<UserCreateRspAllOfData>() {
           @Override
           public void write(JsonWriter out, UserCreateRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserCreateRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserCreateRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserCreateRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to UserCreateRspAllOfData
  */
  public static UserCreateRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserCreateRspAllOfData.class);
  }

 /**
  * Convert an instance of UserCreateRspAllOfData to an JSON string
  *
  * @return JSON string
  */
