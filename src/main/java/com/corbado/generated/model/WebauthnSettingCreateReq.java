...
public class WebauthnSettingCreateReq {
  ...
  public WebauthnSettingCreateReq() {
  }

  public WebauthnSettingCreateReq name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingCreateReq origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingCreateReq requestID(String requestID) {
  ...
  **/
  ...
  public WebauthnSettingCreateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingCreateReq webauthnSettingCreateReq = (WebauthnSettingCreateReq) o;
    return Objects.equals(this.name, webauthnSettingCreateReq.name) &&
        Objects.equals(this.origin, webauthnSettingCreateReq.origin) &&
        Objects.equals(this.requestID, webauthnSettingCreateReq.requestID) &&
        Objects.equals(this.clientInfo, webauthnSettingCreateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, origin, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebauthnSettingCreateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingCreateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingCreateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingCreateReq is not found in the empty JSON string", WebauthnSettingCreateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingCreateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingCreateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingCreateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingCreateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingCreateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingCreateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingCreateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingCreateReq>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingCreateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingCreateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingCreateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingCreateReq
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingCreateReq
  */
  public static WebauthnSettingCreateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingCreateReq.class);
  }

 /**
  * Convert an instance of WebauthnSettingCreateReq to an JSON string
  *
  * @return JSON string
  */
