...
import com.corbado.generated.model.UserAuthLogListRspAllOfData;
...
public class UserAuthLogListRsp {
  ...
  private UserAuthLogListRspAllOfData data;

  public UserAuthLogListRsp() {
  }

  public UserAuthLogListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserAuthLogListRsp message(String message) {
  ...
  **/
  ...
  public UserAuthLogListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserAuthLogListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserAuthLogListRsp data(UserAuthLogListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserAuthLogListRspAllOfData getData() {
    return data;
  }

  public void setData(UserAuthLogListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserAuthLogListRsp userAuthLogListRsp = (UserAuthLogListRsp) o;
    return Objects.equals(this.httpStatusCode, userAuthLogListRsp.httpStatusCode) &&
        Objects.equals(this.message, userAuthLogListRsp.message) &&
        Objects.equals(this.requestData, userAuthLogListRsp.requestData) &&
        Objects.equals(this.runtime, userAuthLogListRsp.runtime) &&
        Objects.equals(this.data, userAuthLogListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserAuthLogListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserAuthLogListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAuthLogListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAuthLogListRsp is not found in the empty JSON string", UserAuthLogListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAuthLogListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAuthLogListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserAuthLogListRsp.openapiRequiredFields) {
      ...
      UserAuthLogListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAuthLogListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAuthLogListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAuthLogListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAuthLogListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAuthLogListRsp>() {
           @Override
           public void write(JsonWriter out, UserAuthLogListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAuthLogListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserAuthLogListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserAuthLogListRsp
  * @throws IOException if the JSON string is invalid with respect to UserAuthLogListRsp
  */
  public static UserAuthLogListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAuthLogListRsp.class);
  }

 /**
  * Convert an instance of UserAuthLogListRsp to an JSON string
  *
  * @return JSON string
  */
