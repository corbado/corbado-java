...
public class IOSAppConfigUpdateReq {
  ...
  public IOSAppConfigUpdateReq() {
  }

  public IOSAppConfigUpdateReq appIDPrefix(String appIDPrefix) {
  ...
  **/
  ...
  public IOSAppConfigUpdateReq bundleID(String bundleID) {
  ...
  **/
  ...
  public IOSAppConfigUpdateReq requestID(String requestID) {
  ...
  **/
  ...
  public IOSAppConfigUpdateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IOSAppConfigUpdateReq iOSAppConfigUpdateReq = (IOSAppConfigUpdateReq) o;
    return Objects.equals(this.appIDPrefix, iOSAppConfigUpdateReq.appIDPrefix) &&
        Objects.equals(this.bundleID, iOSAppConfigUpdateReq.bundleID) &&
        Objects.equals(this.requestID, iOSAppConfigUpdateReq.requestID) &&
        Objects.equals(this.clientInfo, iOSAppConfigUpdateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appIDPrefix, bundleID, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IOSAppConfigUpdateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IOSAppConfigUpdateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSAppConfigUpdateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSAppConfigUpdateReq is not found in the empty JSON string", IOSAppConfigUpdateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSAppConfigUpdateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSAppConfigUpdateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IOSAppConfigUpdateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSAppConfigUpdateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSAppConfigUpdateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSAppConfigUpdateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSAppConfigUpdateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSAppConfigUpdateReq>() {
           @Override
           public void write(JsonWriter out, IOSAppConfigUpdateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSAppConfigUpdateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IOSAppConfigUpdateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IOSAppConfigUpdateReq
  * @throws IOException if the JSON string is invalid with respect to IOSAppConfigUpdateReq
  */
  public static IOSAppConfigUpdateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSAppConfigUpdateReq.class);
  }

 /**
  * Convert an instance of IOSAppConfigUpdateReq to an JSON string
  *
  * @return JSON string
  */
