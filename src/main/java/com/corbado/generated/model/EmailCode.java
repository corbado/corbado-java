...
public class EmailCode {
  ...
  **/
  ...
  public EmailCode userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public EmailCode email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public EmailCode userFullName(String userFullName) {
  ...
  **/
  ...
  public EmailCode additionalPayload(String additionalPayload) {
  ...
  **/
  ...
  public EmailCode created(String created) {
  ...
  **/
  ...
  public EmailCode updated(String updated) {
  ...
  **/
  ...
  public EmailCode status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ID, emailCode.ID) &&
        Objects.equals(this.userID, emailCode.userID) &&
        Objects.equals(this.email, emailCode.email) &&
        Objects.equals(this.userFullName, emailCode.userFullName) &&
        Objects.equals(this.additionalPayload, emailCode.additionalPayload) &&
        Objects.equals(this.created, emailCode.created) &&
        Objects.equals(this.updated, emailCode.updated) &&
        Objects.equals(this.status, emailCode.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ID, userID, email, userFullName, additionalPayload, created, updated, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailCode {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailCode
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCode is not found in the empty JSON string", EmailCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCode.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCode>() {
           @Override
           public void write(JsonWriter out, EmailCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCode read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCode given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCode
  * @throws IOException if the JSON string is invalid with respect to EmailCode
  */
  public static EmailCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCode.class);
  }

 /**
  * Convert an instance of EmailCode to an JSON string
  *
  * @return JSON string
  */
