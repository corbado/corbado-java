...
public class EmailCodeValidateReq {
  ...
  public EmailCodeValidateReq() {
  }

  public EmailCodeValidateReq code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public EmailCodeValidateReq createLoginToken(Boolean createLoginToken) {
  ...
  **/
  ...
  public EmailCodeValidateReq requestID(String requestID) {
  ...
  **/
  ...
  public EmailCodeValidateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailCodeValidateReq emailCodeValidateReq = (EmailCodeValidateReq) o;
    return Objects.equals(this.code, emailCodeValidateReq.code) &&
        Objects.equals(this.createLoginToken, emailCodeValidateReq.createLoginToken) &&
        Objects.equals(this.requestID, emailCodeValidateReq.requestID) &&
        Objects.equals(this.clientInfo, emailCodeValidateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, createLoginToken, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailCodeValidateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailCodeValidateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailCodeValidateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCodeValidateReq is not found in the empty JSON string", EmailCodeValidateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailCodeValidateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCodeValidateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCodeValidateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCodeValidateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCodeValidateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCodeValidateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCodeValidateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCodeValidateReq>() {
           @Override
           public void write(JsonWriter out, EmailCodeValidateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCodeValidateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCodeValidateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCodeValidateReq
  * @throws IOException if the JSON string is invalid with respect to EmailCodeValidateReq
  */
  public static EmailCodeValidateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCodeValidateReq.class);
  }

 /**
  * Convert an instance of EmailCodeValidateReq to an JSON string
  *
  * @return JSON string
  */
