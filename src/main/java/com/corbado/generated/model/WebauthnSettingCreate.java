...
public class WebauthnSettingCreate {
  ...
  public WebauthnSettingCreate() {
  }

  public WebauthnSettingCreate name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingCreate origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingCreate webauthnSettingCreate = (WebauthnSettingCreate) o;
    return Objects.equals(this.name, webauthnSettingCreate.name) &&
        Objects.equals(this.origin, webauthnSettingCreate.origin);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnSettingCreate {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingCreate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingCreate is not found in the empty JSON string", WebauthnSettingCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingCreate>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingCreate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingCreate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingCreate
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingCreate
  */
  public static WebauthnSettingCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingCreate.class);
  }

 /**
  * Convert an instance of WebauthnSettingCreate to an JSON string
  *
  * @return JSON string
  */
