...
import com.corbado.generated.model.WebhookLogsListRspAllOfData;
...
public class WebhookLogsListRsp {
  ...
  private WebhookLogsListRspAllOfData data;

  public WebhookLogsListRsp() {
  }

  public WebhookLogsListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebhookLogsListRsp message(String message) {
  ...
  **/
  ...
  public WebhookLogsListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebhookLogsListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebhookLogsListRsp data(WebhookLogsListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public WebhookLogsListRspAllOfData getData() {
    return data;
  }

  public void setData(WebhookLogsListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookLogsListRsp webhookLogsListRsp = (WebhookLogsListRsp) o;
    return Objects.equals(this.httpStatusCode, webhookLogsListRsp.httpStatusCode) &&
        Objects.equals(this.message, webhookLogsListRsp.message) &&
        Objects.equals(this.requestData, webhookLogsListRsp.requestData) &&
        Objects.equals(this.runtime, webhookLogsListRsp.runtime) &&
        Objects.equals(this.data, webhookLogsListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookLogsListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebhookLogsListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookLogsListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookLogsListRsp is not found in the empty JSON string", WebhookLogsListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookLogsListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookLogsListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookLogsListRsp.openapiRequiredFields) {
      ...
      WebhookLogsListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookLogsListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookLogsListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookLogsListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookLogsListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookLogsListRsp>() {
           @Override
           public void write(JsonWriter out, WebhookLogsListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookLogsListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookLogsListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookLogsListRsp
  * @throws IOException if the JSON string is invalid with respect to WebhookLogsListRsp
  */
  public static WebhookLogsListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookLogsListRsp.class);
  }

 /**
  * Convert an instance of WebhookLogsListRsp to an JSON string
  *
  * @return JSON string
  */
