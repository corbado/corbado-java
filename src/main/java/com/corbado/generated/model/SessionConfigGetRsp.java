...
import com.corbado.generated.model.SessionConfig;
...
public class SessionConfigGetRsp {
  ...
  private SessionConfig data;

  public SessionConfigGetRsp() {
  }

  public SessionConfigGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public SessionConfigGetRsp message(String message) {
  ...
  **/
  ...
  public SessionConfigGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public SessionConfigGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public SessionConfigGetRsp data(SessionConfig data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public SessionConfig getData() {
    return data;
  }

  public void setData(SessionConfig data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SessionConfigGetRsp sessionConfigGetRsp = (SessionConfigGetRsp) o;
    return Objects.equals(this.httpStatusCode, sessionConfigGetRsp.httpStatusCode) &&
        Objects.equals(this.message, sessionConfigGetRsp.message) &&
        Objects.equals(this.requestData, sessionConfigGetRsp.requestData) &&
        Objects.equals(this.runtime, sessionConfigGetRsp.runtime) &&
        Objects.equals(this.data, sessionConfigGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionConfigGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SessionConfigGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionConfigGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionConfigGetRsp is not found in the empty JSON string", SessionConfigGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionConfigGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionConfigGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SessionConfigGetRsp.openapiRequiredFields) {
      ...
      SessionConfig.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionConfigGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionConfigGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionConfigGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionConfigGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionConfigGetRsp>() {
           @Override
           public void write(JsonWriter out, SessionConfigGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionConfigGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SessionConfigGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionConfigGetRsp
  * @throws IOException if the JSON string is invalid with respect to SessionConfigGetRsp
  */
  public static SessionConfigGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionConfigGetRsp.class);
  }

 /**
  * Convert an instance of SessionConfigGetRsp to an JSON string
  *
  * @return JSON string
  */
