...
public class AndroidAppConfigDeleteReq {
  ...
  public AndroidAppConfigDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public AndroidAppConfigDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AndroidAppConfigDeleteReq androidAppConfigDeleteReq = (AndroidAppConfigDeleteReq) o;
    return Objects.equals(this.requestID, androidAppConfigDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, androidAppConfigDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class AndroidAppConfigDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AndroidAppConfigDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AndroidAppConfigDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AndroidAppConfigDeleteReq is not found in the empty JSON string", AndroidAppConfigDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AndroidAppConfigDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AndroidAppConfigDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AndroidAppConfigDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AndroidAppConfigDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AndroidAppConfigDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AndroidAppConfigDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<AndroidAppConfigDeleteReq>() {
           @Override
           public void write(JsonWriter out, AndroidAppConfigDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AndroidAppConfigDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AndroidAppConfigDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AndroidAppConfigDeleteReq
  * @throws IOException if the JSON string is invalid with respect to AndroidAppConfigDeleteReq
  */
  public static AndroidAppConfigDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AndroidAppConfigDeleteReq.class);
  }

 /**
  * Convert an instance of AndroidAppConfigDeleteReq to an JSON string
  *
  * @return JSON string
  */
