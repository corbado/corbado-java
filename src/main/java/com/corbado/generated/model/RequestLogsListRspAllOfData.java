...
import com.corbado.generated.model.RequestLog;
...
public class RequestLogsListRspAllOfData {
  ...
  public RequestLogsListRspAllOfData() {
  }

  public RequestLogsListRspAllOfData logs(List<RequestLog> logs) {
    this.logs = logs;
    return this;
  }

  public RequestLogsListRspAllOfData addLogsItem(RequestLog logsItem) {
    if (this.logs == null) {
  ...
  **/
  ...
  public RequestLogsListRspAllOfData paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RequestLogsListRspAllOfData requestLogsListRspAllOfData = (RequestLogsListRspAllOfData) o;
    return Objects.equals(this.logs, requestLogsListRspAllOfData.logs) &&
        Objects.equals(this.paging, requestLogsListRspAllOfData.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestLogsListRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to RequestLogsListRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestLogsListRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestLogsListRspAllOfData is not found in the empty JSON string", RequestLogsListRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestLogsListRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestLogsListRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestLogsListRspAllOfData.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraylogs.size(); i++) {
        RequestLog.validateJsonElement(jsonArraylogs.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestLogsListRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestLogsListRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestLogsListRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestLogsListRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestLogsListRspAllOfData>() {
           @Override
           public void write(JsonWriter out, RequestLogsListRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestLogsListRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RequestLogsListRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RequestLogsListRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to RequestLogsListRspAllOfData
  */
  public static RequestLogsListRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestLogsListRspAllOfData.class);
  }

 /**
  * Convert an instance of RequestLogsListRspAllOfData to an JSON string
  *
  * @return JSON string
  */
