...
import com.corbado.generated.model.AuthMethodsListRspAllOfData;
...
public class AuthMethodsListRsp {
  ...
  private AuthMethodsListRspAllOfData data;

  public AuthMethodsListRsp() {
  }

  public AuthMethodsListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public AuthMethodsListRsp message(String message) {
  ...
  **/
  ...
  public AuthMethodsListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public AuthMethodsListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public AuthMethodsListRsp data(AuthMethodsListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public AuthMethodsListRspAllOfData getData() {
    return data;
  }

  public void setData(AuthMethodsListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodsListRsp authMethodsListRsp = (AuthMethodsListRsp) o;
    return Objects.equals(this.httpStatusCode, authMethodsListRsp.httpStatusCode) &&
        Objects.equals(this.message, authMethodsListRsp.message) &&
        Objects.equals(this.requestData, authMethodsListRsp.requestData) &&
        Objects.equals(this.runtime, authMethodsListRsp.runtime) &&
        Objects.equals(this.data, authMethodsListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthMethodsListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuthMethodsListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodsListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthMethodsListRsp is not found in the empty JSON string", AuthMethodsListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodsListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthMethodsListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodsListRsp.openapiRequiredFields) {
      ...
      AuthMethodsListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodsListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodsListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodsListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodsListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodsListRsp>() {
           @Override
           public void write(JsonWriter out, AuthMethodsListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodsListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AuthMethodsListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthMethodsListRsp
  * @throws IOException if the JSON string is invalid with respect to AuthMethodsListRsp
  */
  public static AuthMethodsListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodsListRsp.class);
  }

 /**
  * Convert an instance of AuthMethodsListRsp to an JSON string
  *
  * @return JSON string
  */
