...
public class EmptyReq {
  ...
  public EmptyReq requestID(String requestID) {
  ...
  **/
  ...
  public EmptyReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmptyReq emptyReq = (EmptyReq) o;
    return Objects.equals(this.requestID, emptyReq.requestID) &&
        Objects.equals(this.clientInfo, emptyReq.clientInfo);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmptyReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmptyReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmptyReq is not found in the empty JSON string", EmptyReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmptyReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmptyReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmptyReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmptyReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmptyReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmptyReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmptyReq>() {
           @Override
           public void write(JsonWriter out, EmptyReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmptyReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmptyReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmptyReq
  * @throws IOException if the JSON string is invalid with respect to EmptyReq
  */
  public static EmptyReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmptyReq.class);
  }

 /**
  * Convert an instance of EmptyReq to an JSON string
  *
  * @return JSON string
  */
