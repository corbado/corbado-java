...
public class SocialAccountList {
  ...
  public SocialAccountList paging(@javax.annotation.Nonnull UserListPaging paging) {
    this.paging = paging;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SocialAccountList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SocialAccountList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
