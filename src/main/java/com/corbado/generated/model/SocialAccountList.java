...
public class SocialAccountList {
   ...
   * @return the SocialAccountList instance itself
   */
  public SocialAccountList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.socialAccounts, socialAccountList.socialAccounts) &&
        ...
        Objects.equals(this.additionalProperties, socialAccountList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(socialAccounts, paging, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("socialAccounts", "paging"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("socialAccounts", "paging"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SocialAccountList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SocialAccountList is not found in the empty JSON string", SocialAccountList.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SocialAccountList>() {
           ...
           public SocialAccountList read(JsonReader in) throws IOException {
             ...
             SocialAccountList instance = thisAdapter.fromJsonTree(jsonObj);
