...
public class SocialAccount {
   ...
   * @return the SocialAccount instance itself
   */
  public SocialAccount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.socialAccountID, socialAccount.socialAccountID) &&
        ...
        Objects.equals(this.additionalProperties, socialAccount.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(socialAccountID, providerType, identifierValue, userID, foreignID, avatarURL, fullName, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SocialAccount>() {
           ...
           public SocialAccount read(JsonReader in) throws IOException {
             ...
             SocialAccount instance = thisAdapter.fromJsonTree(jsonObj);
