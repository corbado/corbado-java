...
public class PasskeyPostLoginRsp {
   ...
   * @return the PasskeyPostLoginRsp instance itself
   */
  public PasskeyPostLoginRsp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.session, passkeyPostLoginRsp.session)&&
        Objects.equals(this.additionalProperties, passkeyPostLoginRsp.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("session"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("session"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasskeyPostLoginRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PasskeyPostLoginRsp is not found in the empty JSON string", PasskeyPostLoginRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("session").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `session` to be a primitive type in the JSON string but got `%s`", jsonObj.get("session").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasskeyPostLoginRsp>() {
           ...
           public PasskeyPostLoginRsp read(JsonReader in) throws IOException {
             ...
             PasskeyPostLoginRsp instance = thisAdapter.fromJsonTree(jsonObj);
