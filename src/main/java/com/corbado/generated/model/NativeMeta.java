...
public class NativeMeta {
   ...
   * @return the NativeMeta instance itself
   */
  public NativeMeta putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.build, nativeMeta.build) &&
        ...
        Objects.equals(this.additionalProperties, nativeMeta.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(build, deviceOwnerAuth, isPlatformAuthenticatorAPISupported, isBluetoothAvailable, isBluetoothOn, googlePlayServices, deviceSecure, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NativeMeta>() {
           ...
           public NativeMeta read(JsonReader in) throws IOException {
             ...
             NativeMeta instance = thisAdapter.fromJsonTree(jsonObj);
