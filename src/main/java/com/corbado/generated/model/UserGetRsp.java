...
public class UserGetRsp {
  ...
  private FullUser data;

  public UserGetRsp() {
  }

  public UserGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserGetRsp message(String message) {
  ...
  **/
  ...
  public UserGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserGetRsp data(FullUser data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public FullUser getData() {
    return data;
  }

  public void setData(FullUser data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserGetRsp userGetRsp = (UserGetRsp) o;
    return Objects.equals(this.httpStatusCode, userGetRsp.httpStatusCode) &&
        Objects.equals(this.message, userGetRsp.message) &&
        Objects.equals(this.requestData, userGetRsp.requestData) &&
        Objects.equals(this.runtime, userGetRsp.runtime) &&
        Objects.equals(this.data, userGetRsp.data);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserGetRsp is not found in the empty JSON string", UserGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserGetRsp.openapiRequiredFields) {
      ...
      FullUser.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserGetRsp>() {
           @Override
           public void write(JsonWriter out, UserGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserGetRsp
  * @throws IOException if the JSON string is invalid with respect to UserGetRsp
  */
  public static UserGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserGetRsp.class);
  }

 /**
  * Convert an instance of UserGetRsp to an JSON string
  *
  * @return JSON string
  */
