...
public class UserUsername {
  ...
  public UserUsername ID(String ID) {
    this.ID = ID;
    return this;
  }
  ...
  **/
  ...
  public UserUsername username(String username) {
  ...
  **/
  ...
  public UserUsername created(String created) {
  ...
  **/
  ...
  public UserUsername updated(String updated) {
  ...
  **/
  ...
  public UserUsername status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserUsername userUsername = (UserUsername) o;
    return Objects.equals(this.ID, userUsername.ID) &&
        Objects.equals(this.username, userUsername.username) &&
        Objects.equals(this.created, userUsername.created) &&
        Objects.equals(this.updated, userUsername.updated) &&
        Objects.equals(this.status, userUsername.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ID, username, created, updated, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserUsername {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserUsername
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserUsername.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserUsername is not found in the empty JSON string", UserUsername.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserUsername.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserUsername` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserUsername.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserUsername.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserUsername' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserUsername> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserUsername.class));

       return (TypeAdapter<T>) new TypeAdapter<UserUsername>() {
           @Override
           public void write(JsonWriter out, UserUsername value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserUsername read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserUsername given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserUsername
  * @throws IOException if the JSON string is invalid with respect to UserUsername
  */
  public static UserUsername fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserUsername.class);
  }

 /**
  * Convert an instance of UserUsername to an JSON string
  *
  * @return JSON string
  */
