...
public class EmailLinkSendReq {
  ...
  public static final String SERIALIZED_NAME_TOKEN_LIFETIME = "tokenLifetime";
  ...
  private PurposeEnum purpose = PurposeEnum.AUTHENTICATION;

  public static final String SERIALIZED_NAME_REDIRECT = "redirect";
  @SerializedName(SERIALIZED_NAME_REDIRECT)
  private URI redirect;

  public static final String SERIALIZED_NAME_ADDITIONAL_PAYLOAD = "additionalPayload";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL_PAYLOAD)
  ...
  public EmailLinkSendReq email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public EmailLinkSendReq create(Boolean create) {
    this.create = create;
    return this;
  }
  ...
  **/
  ...
  public EmailLinkSendReq tokenLifetime(String tokenLifetime) {
  ...
  **/
  ...
  public EmailLinkSendReq userFullName(String userFullName) {
  ...
  **/
  ...
  public EmailLinkSendReq templateName(String templateName) {
  ...
  **/
  ...
  public EmailLinkSendReq purpose(PurposeEnum purpose) {
  ...
  **/
  ...
  public EmailLinkSendReq redirect(URI redirect) {
  ...
  **/
  ...
  public EmailLinkSendReq additionalPayload(String additionalPayload) {
  ...
  **/
  ...
  public EmailLinkSendReq requestID(String requestID) {
  ...
  **/
  ...
  public EmailLinkSendReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailLinkSendReq emailLinkSendReq = (EmailLinkSendReq) o;
    return Objects.equals(this.email, emailLinkSendReq.email) &&
        Objects.equals(this.create, emailLinkSendReq.create) &&
        Objects.equals(this.tokenLifetime, emailLinkSendReq.tokenLifetime) &&
        Objects.equals(this.userFullName, emailLinkSendReq.userFullName) &&
        Objects.equals(this.templateName, emailLinkSendReq.templateName) &&
        Objects.equals(this.purpose, emailLinkSendReq.purpose) &&
        Objects.equals(this.redirect, emailLinkSendReq.redirect) &&
        Objects.equals(this.additionalPayload, emailLinkSendReq.additionalPayload) &&
        Objects.equals(this.requestID, emailLinkSendReq.requestID) &&
        Objects.equals(this.clientInfo, emailLinkSendReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, create, tokenLifetime, userFullName, templateName, purpose, redirect, additionalPayload, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailLinkSendReq {\n");
  ...
  static {
    ...
    openapiFields.add("tokenLifetime");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLinkSendReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLinkSendReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLinkSendReq is not found in the empty JSON string", EmailLinkSendReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLinkSendReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLinkSendReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLinkSendReq.openapiRequiredFields) {
      ...
      if ((jsonObj.get("tokenLifetime") != null && !jsonObj.get("tokenLifetime").isJsonNull()) && !jsonObj.get("tokenLifetime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tokenLifetime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tokenLifetime").toString()));
      }
      ...
      if (!jsonObj.get("redirect").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("additionalPayload") != null && !jsonObj.get("additionalPayload").isJsonNull()) && !jsonObj.get("additionalPayload").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `additionalPayload` to be a primitive type in the JSON string but got `%s`", jsonObj.get("additionalPayload").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLinkSendReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLinkSendReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLinkSendReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLinkSendReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLinkSendReq>() {
           @Override
           public void write(JsonWriter out, EmailLinkSendReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLinkSendReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLinkSendReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLinkSendReq
  * @throws IOException if the JSON string is invalid with respect to EmailLinkSendReq
  */
  public static EmailLinkSendReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLinkSendReq.class);
  }

 /**
  * Convert an instance of EmailLinkSendReq to an JSON string
  *
  * @return JSON string
  */
