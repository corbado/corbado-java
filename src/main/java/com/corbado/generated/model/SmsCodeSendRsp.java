...
import com.corbado.generated.model.SmsCodeSendRspAllOfData;
...
public class SmsCodeSendRsp {
  ...
  private SmsCodeSendRspAllOfData data;

  public SmsCodeSendRsp() {
  }

  public SmsCodeSendRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public SmsCodeSendRsp message(String message) {
  ...
  **/
  ...
  public SmsCodeSendRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public SmsCodeSendRsp runtime(Float runtime) {
  ...
  **/
  ...
  public SmsCodeSendRsp data(SmsCodeSendRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public SmsCodeSendRspAllOfData getData() {
    return data;
  }

  public void setData(SmsCodeSendRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SmsCodeSendRsp smsCodeSendRsp = (SmsCodeSendRsp) o;
    return Objects.equals(this.httpStatusCode, smsCodeSendRsp.httpStatusCode) &&
        Objects.equals(this.message, smsCodeSendRsp.message) &&
        Objects.equals(this.requestData, smsCodeSendRsp.requestData) &&
        Objects.equals(this.runtime, smsCodeSendRsp.runtime) &&
        Objects.equals(this.data, smsCodeSendRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmsCodeSendRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SmsCodeSendRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsCodeSendRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsCodeSendRsp is not found in the empty JSON string", SmsCodeSendRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsCodeSendRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsCodeSendRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsCodeSendRsp.openapiRequiredFields) {
      ...
      SmsCodeSendRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsCodeSendRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsCodeSendRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsCodeSendRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsCodeSendRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsCodeSendRsp>() {
           @Override
           public void write(JsonWriter out, SmsCodeSendRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsCodeSendRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsCodeSendRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsCodeSendRsp
  * @throws IOException if the JSON string is invalid with respect to SmsCodeSendRsp
  */
  public static SmsCodeSendRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsCodeSendRsp.class);
  }

 /**
  * Convert an instance of SmsCodeSendRsp to an JSON string
  *
  * @return JSON string
  */
