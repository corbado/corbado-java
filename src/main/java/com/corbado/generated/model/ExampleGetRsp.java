...
public class ExampleGetRsp {
  ...
  public ExampleGetRsp() {
  }

  public ExampleGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public ExampleGetRsp message(String message) {
  ...
  **/
  ...
  public ExampleGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public ExampleGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public ExampleGetRsp data(String data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ExampleGetRsp extension(ExtensionEnum extension) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ExampleGetRsp exampleGetRsp = (ExampleGetRsp) o;
    return Objects.equals(this.httpStatusCode, exampleGetRsp.httpStatusCode) &&
        Objects.equals(this.message, exampleGetRsp.message) &&
        Objects.equals(this.requestData, exampleGetRsp.requestData) &&
        Objects.equals(this.runtime, exampleGetRsp.runtime) &&
        Objects.equals(this.data, exampleGetRsp.data) &&
        Objects.equals(this.extension, exampleGetRsp.extension);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, data, extension);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExampleGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ExampleGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExampleGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExampleGetRsp is not found in the empty JSON string", ExampleGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExampleGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExampleGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExampleGetRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExampleGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExampleGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExampleGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExampleGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<ExampleGetRsp>() {
           @Override
           public void write(JsonWriter out, ExampleGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExampleGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ExampleGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExampleGetRsp
  * @throws IOException if the JSON string is invalid with respect to ExampleGetRsp
  */
  public static ExampleGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExampleGetRsp.class);
  }

 /**
  * Convert an instance of ExampleGetRsp to an JSON string
  *
  * @return JSON string
  */
