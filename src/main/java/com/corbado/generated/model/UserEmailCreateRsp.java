...
import com.corbado.generated.model.UserEmailCreateRspAllOfData;
...
public class UserEmailCreateRsp {
  ...
  private UserEmailCreateRspAllOfData data;

  public UserEmailCreateRsp() {
  }

  public UserEmailCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserEmailCreateRsp message(String message) {
  ...
  **/
  ...
  public UserEmailCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserEmailCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserEmailCreateRsp data(UserEmailCreateRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserEmailCreateRspAllOfData getData() {
    return data;
  }

  public void setData(UserEmailCreateRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserEmailCreateRsp userEmailCreateRsp = (UserEmailCreateRsp) o;
    return Objects.equals(this.httpStatusCode, userEmailCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, userEmailCreateRsp.message) &&
        Objects.equals(this.requestData, userEmailCreateRsp.requestData) &&
        Objects.equals(this.runtime, userEmailCreateRsp.runtime) &&
        Objects.equals(this.data, userEmailCreateRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserEmailCreateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserEmailCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEmailCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserEmailCreateRsp is not found in the empty JSON string", UserEmailCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEmailCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserEmailCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserEmailCreateRsp.openapiRequiredFields) {
      ...
      UserEmailCreateRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserEmailCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserEmailCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserEmailCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserEmailCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserEmailCreateRsp>() {
           @Override
           public void write(JsonWriter out, UserEmailCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserEmailCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserEmailCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserEmailCreateRsp
  * @throws IOException if the JSON string is invalid with respect to UserEmailCreateRsp
  */
  public static UserEmailCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserEmailCreateRsp.class);
  }

 /**
  * Convert an instance of UserEmailCreateRsp to an JSON string
  *
  * @return JSON string
  */
