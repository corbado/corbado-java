...
public class WebauthnSettingUpdateRsp {
  ...
  public WebauthnSettingUpdateRsp() {
  }

  public WebauthnSettingUpdateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp message(String message) {
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp created(String created) {
  ...
  **/
  ...
  public WebauthnSettingUpdateRsp updated(String updated) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingUpdateRsp webauthnSettingUpdateRsp = (WebauthnSettingUpdateRsp) o;
    return Objects.equals(this.httpStatusCode, webauthnSettingUpdateRsp.httpStatusCode) &&
        Objects.equals(this.message, webauthnSettingUpdateRsp.message) &&
        Objects.equals(this.requestData, webauthnSettingUpdateRsp.requestData) &&
        Objects.equals(this.runtime, webauthnSettingUpdateRsp.runtime) &&
        Objects.equals(this.name, webauthnSettingUpdateRsp.name) &&
        Objects.equals(this.origin, webauthnSettingUpdateRsp.origin) &&
        Objects.equals(this.id, webauthnSettingUpdateRsp.id) &&
        Objects.equals(this.created, webauthnSettingUpdateRsp.created) &&
        Objects.equals(this.updated, webauthnSettingUpdateRsp.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, name, origin, id, created, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebauthnSettingUpdateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingUpdateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingUpdateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingUpdateRsp is not found in the empty JSON string", WebauthnSettingUpdateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingUpdateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingUpdateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingUpdateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingUpdateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingUpdateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingUpdateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingUpdateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingUpdateRsp>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingUpdateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingUpdateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingUpdateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingUpdateRsp
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingUpdateRsp
  */
  public static WebauthnSettingUpdateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingUpdateRsp.class);
  }

 /**
  * Convert an instance of WebauthnSettingUpdateRsp to an JSON string
  *
  * @return JSON string
  */
