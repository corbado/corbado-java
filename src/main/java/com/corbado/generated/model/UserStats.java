...
public class UserStats {
  ...
  public static final String SERIALIZED_NAME_SIGN_UPS = "signUps";
  @SerializedName(SERIALIZED_NAME_SIGN_UPS)
  ...
  public static final String SERIALIZED_NAME_COUNT_PASSKEY_LOGIN = "countPasskeyLogin";
  @SerializedName(SERIALIZED_NAME_COUNT_PASSKEY_LOGIN)
  private Integer countPasskeyLogin;

  public static final String SERIALIZED_NAME_COUNT_EMAIL_LOGIN = "countEmailLogin";
  @SerializedName(SERIALIZED_NAME_COUNT_EMAIL_LOGIN)
  private Integer countEmailLogin;

  public static final String SERIALIZED_NAME_COUNT_PASSWORD_LOGIN = "countPasswordLogin";
  @SerializedName(SERIALIZED_NAME_COUNT_PASSWORD_LOGIN)
  private Integer countPasswordLogin;

  public static final String SERIALIZED_NAME_SUCCESSFUL_LOGINS = "successfulLogins";
  @SerializedName(SERIALIZED_NAME_SUCCESSFUL_LOGINS)
  private Integer successfulLogins;

  public static final String SERIALIZED_NAME_FAILED_LOGINS = "failedLogins";
  @SerializedName(SERIALIZED_NAME_FAILED_LOGINS)
  private Integer failedLogins;

  public UserStats() {
  }

  public UserStats timePoint(String timePoint) {
  ...
  **/
  ...
  public UserStats totalUsers(Integer totalUsers) {
  ...
  **/
  ...
  public UserStats signUps(Integer signUps) {
  ...
  **/
  ...
  public UserStats activeUsers(Integer activeUsers) {
  ...
  **/
  ...
  public UserStats countPasskeyLogin(Integer countPasskeyLogin) {
    this.countPasskeyLogin = countPasskeyLogin;
    return this;
  }

   /**
   * Get countPasskeyLogin
   * @return countPasskeyLogin
  **/
  @javax.annotation.Nonnull
  public Integer getCountPasskeyLogin() {
    return countPasskeyLogin;
  }

  public void setCountPasskeyLogin(Integer countPasskeyLogin) {
    this.countPasskeyLogin = countPasskeyLogin;
  }


  public UserStats countEmailLogin(Integer countEmailLogin) {
    this.countEmailLogin = countEmailLogin;
    return this;
  }

   /**
   * Get countEmailLogin
   * @return countEmailLogin
  **/
  @javax.annotation.Nonnull
  public Integer getCountEmailLogin() {
    return countEmailLogin;
  }

  public void setCountEmailLogin(Integer countEmailLogin) {
    this.countEmailLogin = countEmailLogin;
  }


  public UserStats countPasswordLogin(Integer countPasswordLogin) {
    this.countPasswordLogin = countPasswordLogin;
    return this;
  }

   /**
   * Get countPasswordLogin
   * @return countPasswordLogin
  **/
  @javax.annotation.Nonnull
  public Integer getCountPasswordLogin() {
    return countPasswordLogin;
  }

  public void setCountPasswordLogin(Integer countPasswordLogin) {
    this.countPasswordLogin = countPasswordLogin;
  }
  ...
  **/
  ...
  public UserStats failedLogins(Integer failedLogins) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timePoint, userStats.timePoint) &&
        Objects.equals(this.totalUsers, userStats.totalUsers) &&
        Objects.equals(this.signUps, userStats.signUps) &&
        Objects.equals(this.activeUsers, userStats.activeUsers) &&
        Objects.equals(this.countPasskeyLogin, userStats.countPasskeyLogin) &&
        Objects.equals(this.countEmailLogin, userStats.countEmailLogin) &&
        Objects.equals(this.countPasswordLogin, userStats.countPasswordLogin) &&
        Objects.equals(this.successfulLogins, userStats.successfulLogins) &&
        Objects.equals(this.failedLogins, userStats.failedLogins);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timePoint, totalUsers, signUps, activeUsers, countPasskeyLogin, countEmailLogin, countPasswordLogin, successfulLogins, failedLogins);
  }
  ...
  static {
    ...
    openapiFields.add("signUps");
    openapiFields.add("activeUsers");
    openapiFields.add("countPasskeyLogin");
    openapiFields.add("countEmailLogin");
    openapiFields.add("countPasswordLogin");
    openapiFields.add("successfulLogins");
    openapiFields.add("failedLogins");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("timePoint");
    openapiRequiredFields.add("totalUsers");
    openapiRequiredFields.add("signUps");
    openapiRequiredFields.add("activeUsers");
    openapiRequiredFields.add("countPasskeyLogin");
    openapiRequiredFields.add("countEmailLogin");
    openapiRequiredFields.add("countPasswordLogin");
    openapiRequiredFields.add("successfulLogins");
    openapiRequiredFields.add("failedLogins");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserStats
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
