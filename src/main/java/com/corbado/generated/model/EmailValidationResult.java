...
import com.corbado.generated.model.ValidationEmail;
...
public class EmailValidationResult {
  ...
  public EmailValidationResult isValid(Boolean isValid) {
  ...
  **/
  ...
  public EmailValidationResult validationCode(ValidationCodeEnum validationCode) {
  ...
  **/
  ...
  public EmailValidationResult suggestion(String suggestion) {
  ...
  **/
  ...
  public EmailValidationResult email(ValidationEmail email) {
    this.email = email;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public ValidationEmail getEmail() {
    return email;
  }

  public void setEmail(ValidationEmail email) {
    this.email = email;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isValid, emailValidationResult.isValid) &&
        Objects.equals(this.validationCode, emailValidationResult.validationCode) &&
        Objects.equals(this.suggestion, emailValidationResult.suggestion) &&
        Objects.equals(this.email, emailValidationResult.email);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isValid, validationCode, suggestion, email);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : EmailValidationResult.openapiRequiredFields) {
      ...
      if (jsonObj.get("email") != null && !jsonObj.get("email").isJsonNull()) {
        ValidationEmail.validateJsonElement(jsonObj.get("email"));
      }
  }
