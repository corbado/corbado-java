...
public class UserEmail {
  ...
  **/
  ...
  public UserEmail created(String created) {
  ...
  **/
  ...
  public UserEmail updated(String updated) {
  ...
  **/
  ...
  public UserEmail status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ID, userEmail.ID) &&
        ...
        Objects.equals(this.created, userEmail.created) &&
        Objects.equals(this.updated, userEmail.updated) &&
        Objects.equals(this.status, userEmail.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ID, email, created, updated, status);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserEmail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserEmail is not found in the empty JSON string", UserEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserEmail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<UserEmail>() {
           @Override
           public void write(JsonWriter out, UserEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserEmail read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserEmail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserEmail
  * @throws IOException if the JSON string is invalid with respect to UserEmail
  */
  public static UserEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserEmail.class);
  }

 /**
  * Convert an instance of UserEmail to an JSON string
  *
  * @return JSON string
  */
