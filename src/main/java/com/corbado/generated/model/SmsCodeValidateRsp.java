...
public class SmsCodeValidateRsp {
  ...
  public SmsCodeValidateRsp() {
  }

  public SmsCodeValidateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public SmsCodeValidateRsp message(String message) {
  ...
  **/
  ...
  public SmsCodeValidateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public SmsCodeValidateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public SmsCodeValidateRsp loginToken(String loginToken) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SmsCodeValidateRsp smsCodeValidateRsp = (SmsCodeValidateRsp) o;
    return Objects.equals(this.httpStatusCode, smsCodeValidateRsp.httpStatusCode) &&
        Objects.equals(this.message, smsCodeValidateRsp.message) &&
        Objects.equals(this.requestData, smsCodeValidateRsp.requestData) &&
        Objects.equals(this.runtime, smsCodeValidateRsp.runtime) &&
        Objects.equals(this.loginToken, smsCodeValidateRsp.loginToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, loginToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmsCodeValidateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SmsCodeValidateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsCodeValidateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsCodeValidateRsp is not found in the empty JSON string", SmsCodeValidateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsCodeValidateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsCodeValidateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsCodeValidateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsCodeValidateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsCodeValidateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsCodeValidateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsCodeValidateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsCodeValidateRsp>() {
           @Override
           public void write(JsonWriter out, SmsCodeValidateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsCodeValidateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsCodeValidateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsCodeValidateRsp
  * @throws IOException if the JSON string is invalid with respect to SmsCodeValidateRsp
  */
  public static SmsCodeValidateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsCodeValidateRsp.class);
  }

 /**
  * Convert an instance of SmsCodeValidateRsp to an JSON string
  *
  * @return JSON string
  */
