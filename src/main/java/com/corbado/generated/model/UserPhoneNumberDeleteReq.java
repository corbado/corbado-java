...
public class UserPhoneNumberDeleteReq {
  ...
  public UserPhoneNumberDeleteReq() {
  }

  public UserPhoneNumberDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public UserPhoneNumberDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserPhoneNumberDeleteReq userPhoneNumberDeleteReq = (UserPhoneNumberDeleteReq) o;
    return Objects.equals(this.requestID, userPhoneNumberDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, userPhoneNumberDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPhoneNumberDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserPhoneNumberDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPhoneNumberDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPhoneNumberDeleteReq is not found in the empty JSON string", UserPhoneNumberDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPhoneNumberDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPhoneNumberDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPhoneNumberDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPhoneNumberDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPhoneNumberDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPhoneNumberDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPhoneNumberDeleteReq>() {
           @Override
           public void write(JsonWriter out, UserPhoneNumberDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPhoneNumberDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserPhoneNumberDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserPhoneNumberDeleteReq
  * @throws IOException if the JSON string is invalid with respect to UserPhoneNumberDeleteReq
  */
  public static UserPhoneNumberDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPhoneNumberDeleteReq.class);
  }

 /**
  * Convert an instance of UserPhoneNumberDeleteReq to an JSON string
  *
  * @return JSON string
  */
