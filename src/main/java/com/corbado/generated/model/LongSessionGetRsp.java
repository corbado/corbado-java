...
import com.corbado.generated.model.LongSessionGetRspAllOfData;
...
public class LongSessionGetRsp {
  ...
  private LongSessionGetRspAllOfData data;

  public LongSessionGetRsp() {
  }

  public LongSessionGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public LongSessionGetRsp message(String message) {
  ...
  **/
  ...
  public LongSessionGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public LongSessionGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public LongSessionGetRsp data(LongSessionGetRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public LongSessionGetRspAllOfData getData() {
    return data;
  }

  public void setData(LongSessionGetRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    LongSessionGetRsp longSessionGetRsp = (LongSessionGetRsp) o;
    return Objects.equals(this.httpStatusCode, longSessionGetRsp.httpStatusCode) &&
        Objects.equals(this.message, longSessionGetRsp.message) &&
        Objects.equals(this.requestData, longSessionGetRsp.requestData) &&
        Objects.equals(this.runtime, longSessionGetRsp.runtime) &&
        Objects.equals(this.data, longSessionGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class LongSessionGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LongSessionGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongSessionGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongSessionGetRsp is not found in the empty JSON string", LongSessionGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongSessionGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongSessionGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LongSessionGetRsp.openapiRequiredFields) {
      ...
      LongSessionGetRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongSessionGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongSessionGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongSessionGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongSessionGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<LongSessionGetRsp>() {
           @Override
           public void write(JsonWriter out, LongSessionGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongSessionGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LongSessionGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LongSessionGetRsp
  * @throws IOException if the JSON string is invalid with respect to LongSessionGetRsp
  */
  public static LongSessionGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongSessionGetRsp.class);
  }

 /**
  * Convert an instance of LongSessionGetRsp to an JSON string
  *
  * @return JSON string
  */
