...
public class WebauthnSettingUpdateReq {
  ...
  public WebauthnSettingUpdateReq name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingUpdateReq origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingUpdateReq requestID(String requestID) {
  ...
  **/
  ...
  public WebauthnSettingUpdateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingUpdateReq webauthnSettingUpdateReq = (WebauthnSettingUpdateReq) o;
    return Objects.equals(this.name, webauthnSettingUpdateReq.name) &&
        Objects.equals(this.origin, webauthnSettingUpdateReq.origin) &&
        Objects.equals(this.requestID, webauthnSettingUpdateReq.requestID) &&
        Objects.equals(this.clientInfo, webauthnSettingUpdateReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnSettingUpdateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingUpdateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingUpdateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingUpdateReq is not found in the empty JSON string", WebauthnSettingUpdateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingUpdateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingUpdateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingUpdateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingUpdateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingUpdateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingUpdateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingUpdateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingUpdateReq>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingUpdateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingUpdateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingUpdateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingUpdateReq
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingUpdateReq
  */
  public static WebauthnSettingUpdateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingUpdateReq.class);
  }

 /**
  * Convert an instance of WebauthnSettingUpdateReq to an JSON string
  *
  * @return JSON string
  */
