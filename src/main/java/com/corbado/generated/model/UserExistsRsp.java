...
public class UserExistsRsp {
  ...
  public UserExistsRsp() {
  }

  public UserExistsRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserExistsRsp message(String message) {
  ...
  **/
  ...
  public UserExistsRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserExistsRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserExistsRsp exists(Boolean exists) {
    this.exists = exists;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserExistsRsp userExistsRsp = (UserExistsRsp) o;
    return Objects.equals(this.httpStatusCode, userExistsRsp.httpStatusCode) &&
        Objects.equals(this.message, userExistsRsp.message) &&
        Objects.equals(this.requestData, userExistsRsp.requestData) &&
        Objects.equals(this.runtime, userExistsRsp.runtime) &&
        Objects.equals(this.exists, userExistsRsp.exists);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserExistsRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserExistsRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserExistsRsp is not found in the empty JSON string", UserExistsRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserExistsRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserExistsRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserExistsRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserExistsRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserExistsRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserExistsRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserExistsRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserExistsRsp>() {
           @Override
           public void write(JsonWriter out, UserExistsRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserExistsRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserExistsRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserExistsRsp
  * @throws IOException if the JSON string is invalid with respect to UserExistsRsp
  */
  public static UserExistsRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserExistsRsp.class);
  }

 /**
  * Convert an instance of UserExistsRsp to an JSON string
  *
  * @return JSON string
  */
