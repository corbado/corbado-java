...
import com.corbado.generated.model.WebauthnSettingItem;
...
public class WebauthnSettingListRsp {
  ...
  private List<WebauthnSettingItem> rows = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public WebauthnSettingListRsp() {
  }

  public WebauthnSettingListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebauthnSettingListRsp message(String message) {
  ...
  **/
  ...
  public WebauthnSettingListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebauthnSettingListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebauthnSettingListRsp rows(List<WebauthnSettingItem> rows) {
    this.rows = rows;
    return this;
  }

  public WebauthnSettingListRsp addRowsItem(WebauthnSettingItem rowsItem) {
    if (this.rows == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<WebauthnSettingItem> getRows() {
    return rows;
  }

  public void setRows(List<WebauthnSettingItem> rows) {
    this.rows = rows;
  }


  public WebauthnSettingListRsp paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingListRsp webauthnSettingListRsp = (WebauthnSettingListRsp) o;
    return Objects.equals(this.httpStatusCode, webauthnSettingListRsp.httpStatusCode) &&
        Objects.equals(this.message, webauthnSettingListRsp.message) &&
        Objects.equals(this.requestData, webauthnSettingListRsp.requestData) &&
        Objects.equals(this.runtime, webauthnSettingListRsp.runtime) &&
        Objects.equals(this.rows, webauthnSettingListRsp.rows) &&
        Objects.equals(this.paging, webauthnSettingListRsp.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnSettingListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingListRsp is not found in the empty JSON string", WebauthnSettingListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingListRsp.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrows.size(); i++) {
        WebauthnSettingItem.validateJsonElement(jsonArrayrows.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingListRsp>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingListRsp
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingListRsp
  */
  public static WebauthnSettingListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingListRsp.class);
  }

 /**
  * Convert an instance of WebauthnSettingListRsp to an JSON string
  *
  * @return JSON string
  */
