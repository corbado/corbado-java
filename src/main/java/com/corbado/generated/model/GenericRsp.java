...
public class GenericRsp {
   ...
   * @return the GenericRsp instance itself
   */
  public GenericRsp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpStatusCode, genericRsp.httpStatusCode) &&
        ...
        Objects.equals(this.additionalProperties, genericRsp.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericRsp>() {
           ...
           public GenericRsp read(JsonReader in) throws IOException {
             ...
             GenericRsp instance = thisAdapter.fromJsonTree(jsonObj);
