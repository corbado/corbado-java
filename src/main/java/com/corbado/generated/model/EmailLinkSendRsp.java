...
import com.corbado.generated.model.EmailLinkSendRspAllOfData;
...
public class EmailLinkSendRsp {
  ...
  private EmailLinkSendRspAllOfData data;

  public EmailLinkSendRsp() {
  }

  public EmailLinkSendRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailLinkSendRsp message(String message) {
  ...
  **/
  ...
  public EmailLinkSendRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailLinkSendRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailLinkSendRsp data(EmailLinkSendRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public EmailLinkSendRspAllOfData getData() {
    return data;
  }

  public void setData(EmailLinkSendRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailLinkSendRsp emailLinkSendRsp = (EmailLinkSendRsp) o;
    return Objects.equals(this.httpStatusCode, emailLinkSendRsp.httpStatusCode) &&
        Objects.equals(this.message, emailLinkSendRsp.message) &&
        Objects.equals(this.requestData, emailLinkSendRsp.requestData) &&
        Objects.equals(this.runtime, emailLinkSendRsp.runtime) &&
        Objects.equals(this.data, emailLinkSendRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLinkSendRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLinkSendRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLinkSendRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLinkSendRsp is not found in the empty JSON string", EmailLinkSendRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLinkSendRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLinkSendRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLinkSendRsp.openapiRequiredFields) {
      ...
      EmailLinkSendRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLinkSendRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLinkSendRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLinkSendRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLinkSendRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLinkSendRsp>() {
           @Override
           public void write(JsonWriter out, EmailLinkSendRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLinkSendRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLinkSendRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLinkSendRsp
  * @throws IOException if the JSON string is invalid with respect to EmailLinkSendRsp
  */
  public static EmailLinkSendRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLinkSendRsp.class);
  }

 /**
  * Convert an instance of EmailLinkSendRsp to an JSON string
  *
  * @return JSON string
  */
