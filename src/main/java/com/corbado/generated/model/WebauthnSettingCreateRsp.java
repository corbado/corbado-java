...
public class WebauthnSettingCreateRsp {
  ...
  public WebauthnSettingCreateRsp() {
  }

  public WebauthnSettingCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebauthnSettingCreateRsp message(String message) {
  ...
  **/
  ...
  public WebauthnSettingCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebauthnSettingCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebauthnSettingCreateRsp name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingCreateRsp origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingCreateRsp id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingCreateRsp created(String created) {
  ...
  **/
  ...
  public WebauthnSettingCreateRsp updated(String updated) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingCreateRsp webauthnSettingCreateRsp = (WebauthnSettingCreateRsp) o;
    return Objects.equals(this.httpStatusCode, webauthnSettingCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, webauthnSettingCreateRsp.message) &&
        Objects.equals(this.requestData, webauthnSettingCreateRsp.requestData) &&
        Objects.equals(this.runtime, webauthnSettingCreateRsp.runtime) &&
        Objects.equals(this.name, webauthnSettingCreateRsp.name) &&
        Objects.equals(this.origin, webauthnSettingCreateRsp.origin) &&
        Objects.equals(this.id, webauthnSettingCreateRsp.id) &&
        Objects.equals(this.created, webauthnSettingCreateRsp.created) &&
        Objects.equals(this.updated, webauthnSettingCreateRsp.updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnSettingCreateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingCreateRsp is not found in the empty JSON string", WebauthnSettingCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingCreateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingCreateRsp>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingCreateRsp
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingCreateRsp
  */
  public static WebauthnSettingCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingCreateRsp.class);
  }

 /**
  * Convert an instance of WebauthnSettingCreateRsp to an JSON string
  *
  * @return JSON string
  */
