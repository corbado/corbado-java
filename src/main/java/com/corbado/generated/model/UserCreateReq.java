...
public class UserCreateReq {
   ...
   * @return the UserCreateReq instance itself
   */
  public UserCreateReq putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fullName, userCreateReq.fullName) &&
        ...
        Objects.equals(this.additionalProperties, userCreateReq.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fullName, status, explicitWebauthnID, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserCreateReq>() {
           ...
           public UserCreateReq read(JsonReader in) throws IOException {
             ...
             UserCreateReq instance = thisAdapter.fromJsonTree(jsonObj);
