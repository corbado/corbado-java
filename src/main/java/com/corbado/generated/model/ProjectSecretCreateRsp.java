...
public class ProjectSecretCreateRsp {
  ...
  public ProjectSecretCreateRsp() {
  }

  public ProjectSecretCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public ProjectSecretCreateRsp message(String message) {
  ...
  **/
  ...
  public ProjectSecretCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public ProjectSecretCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public ProjectSecretCreateRsp id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ProjectSecretCreateRsp secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  **/
  ...
  public ProjectSecretCreateRsp hint(String hint) {
    this.hint = hint;
    return this;
  }
  ...
  **/
  ...
  public ProjectSecretCreateRsp created(String created) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectSecretCreateRsp projectSecretCreateRsp = (ProjectSecretCreateRsp) o;
    return Objects.equals(this.httpStatusCode, projectSecretCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, projectSecretCreateRsp.message) &&
        Objects.equals(this.requestData, projectSecretCreateRsp.requestData) &&
        Objects.equals(this.runtime, projectSecretCreateRsp.runtime) &&
        Objects.equals(this.id, projectSecretCreateRsp.id) &&
        Objects.equals(this.secret, projectSecretCreateRsp.secret) &&
        Objects.equals(this.hint, projectSecretCreateRsp.hint) &&
        Objects.equals(this.created, projectSecretCreateRsp.created);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, id, secret, hint, created);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectSecretCreateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectSecretCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSecretCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSecretCreateRsp is not found in the empty JSON string", ProjectSecretCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSecretCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSecretCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectSecretCreateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSecretCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSecretCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSecretCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSecretCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSecretCreateRsp>() {
           @Override
           public void write(JsonWriter out, ProjectSecretCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSecretCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectSecretCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectSecretCreateRsp
  * @throws IOException if the JSON string is invalid with respect to ProjectSecretCreateRsp
  */
  public static ProjectSecretCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSecretCreateRsp.class);
  }

 /**
  * Convert an instance of ProjectSecretCreateRsp to an JSON string
  *
  * @return JSON string
  */
