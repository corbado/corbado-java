...
public class IOSAppConfigSaveReq {
  ...
  public IOSAppConfigSaveReq() {
  }

  public IOSAppConfigSaveReq appIDPrefix(String appIDPrefix) {
  ...
  **/
  ...
  public IOSAppConfigSaveReq bundleID(String bundleID) {
  ...
  **/
  ...
  public IOSAppConfigSaveReq requestID(String requestID) {
  ...
  **/
  ...
  public IOSAppConfigSaveReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IOSAppConfigSaveReq iOSAppConfigSaveReq = (IOSAppConfigSaveReq) o;
    return Objects.equals(this.appIDPrefix, iOSAppConfigSaveReq.appIDPrefix) &&
        Objects.equals(this.bundleID, iOSAppConfigSaveReq.bundleID) &&
        Objects.equals(this.requestID, iOSAppConfigSaveReq.requestID) &&
        Objects.equals(this.clientInfo, iOSAppConfigSaveReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class IOSAppConfigSaveReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IOSAppConfigSaveReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSAppConfigSaveReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSAppConfigSaveReq is not found in the empty JSON string", IOSAppConfigSaveReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSAppConfigSaveReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSAppConfigSaveReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IOSAppConfigSaveReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSAppConfigSaveReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSAppConfigSaveReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSAppConfigSaveReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSAppConfigSaveReq.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSAppConfigSaveReq>() {
           @Override
           public void write(JsonWriter out, IOSAppConfigSaveReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSAppConfigSaveReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IOSAppConfigSaveReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IOSAppConfigSaveReq
  * @throws IOException if the JSON string is invalid with respect to IOSAppConfigSaveReq
  */
  public static IOSAppConfigSaveReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSAppConfigSaveReq.class);
  }

 /**
  * Convert an instance of IOSAppConfigSaveReq to an JSON string
  *
  * @return JSON string
  */
