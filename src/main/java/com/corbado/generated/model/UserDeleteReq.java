...
public class UserDeleteReq {
  ...
  public UserDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public UserDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserDeleteReq userDeleteReq = (UserDeleteReq) o;
    return Objects.equals(this.requestID, userDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, userDeleteReq.clientInfo);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDeleteReq is not found in the empty JSON string", UserDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDeleteReq>() {
           @Override
           public void write(JsonWriter out, UserDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserDeleteReq
  * @throws IOException if the JSON string is invalid with respect to UserDeleteReq
  */
  public static UserDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDeleteReq.class);
  }

 /**
  * Convert an instance of UserDeleteReq to an JSON string
  *
  * @return JSON string
  */
