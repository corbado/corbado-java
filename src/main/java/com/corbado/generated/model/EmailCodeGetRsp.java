...
import com.corbado.generated.model.EmailCodeGetRspAllOfData;
...
public class EmailCodeGetRsp {
  ...
  private EmailCodeGetRspAllOfData data;

  public EmailCodeGetRsp() {
  }

  public EmailCodeGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailCodeGetRsp message(String message) {
  ...
  **/
  ...
  public EmailCodeGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailCodeGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailCodeGetRsp data(EmailCodeGetRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public EmailCodeGetRspAllOfData getData() {
    return data;
  }

  public void setData(EmailCodeGetRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailCodeGetRsp emailCodeGetRsp = (EmailCodeGetRsp) o;
    return Objects.equals(this.httpStatusCode, emailCodeGetRsp.httpStatusCode) &&
        Objects.equals(this.message, emailCodeGetRsp.message) &&
        Objects.equals(this.requestData, emailCodeGetRsp.requestData) &&
        Objects.equals(this.runtime, emailCodeGetRsp.runtime) &&
        Objects.equals(this.data, emailCodeGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailCodeGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailCodeGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailCodeGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCodeGetRsp is not found in the empty JSON string", EmailCodeGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailCodeGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCodeGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCodeGetRsp.openapiRequiredFields) {
      ...
      EmailCodeGetRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCodeGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCodeGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCodeGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCodeGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCodeGetRsp>() {
           @Override
           public void write(JsonWriter out, EmailCodeGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCodeGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCodeGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCodeGetRsp
  * @throws IOException if the JSON string is invalid with respect to EmailCodeGetRsp
  */
  public static EmailCodeGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCodeGetRsp.class);
  }

 /**
  * Convert an instance of EmailCodeGetRsp to an JSON string
  *
  * @return JSON string
  */
