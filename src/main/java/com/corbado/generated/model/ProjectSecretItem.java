...
public class ProjectSecretItem {
  ...
  public ProjectSecretItem() {
  }

  public ProjectSecretItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ProjectSecretItem secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  **/
  ...
  public ProjectSecretItem hint(String hint) {
    this.hint = hint;
    return this;
  }
  ...
  **/
  ...
  public ProjectSecretItem created(String created) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectSecretItem projectSecretItem = (ProjectSecretItem) o;
    return Objects.equals(this.id, projectSecretItem.id) &&
        Objects.equals(this.secret, projectSecretItem.secret) &&
        Objects.equals(this.hint, projectSecretItem.hint) &&
        Objects.equals(this.created, projectSecretItem.created);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, secret, hint, created);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectSecretItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectSecretItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSecretItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSecretItem is not found in the empty JSON string", ProjectSecretItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSecretItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSecretItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectSecretItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSecretItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSecretItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSecretItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSecretItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSecretItem>() {
           @Override
           public void write(JsonWriter out, ProjectSecretItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSecretItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectSecretItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectSecretItem
  * @throws IOException if the JSON string is invalid with respect to ProjectSecretItem
  */
  public static ProjectSecretItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSecretItem.class);
  }

 /**
  * Convert an instance of ProjectSecretItem to an JSON string
  *
  * @return JSON string
  */
