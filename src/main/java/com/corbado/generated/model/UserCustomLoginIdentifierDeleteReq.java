...
public class UserCustomLoginIdentifierDeleteReq {
  ...
  public UserCustomLoginIdentifierDeleteReq() {
  }

  public UserCustomLoginIdentifierDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public UserCustomLoginIdentifierDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserCustomLoginIdentifierDeleteReq userCustomLoginIdentifierDeleteReq = (UserCustomLoginIdentifierDeleteReq) o;
    return Objects.equals(this.requestID, userCustomLoginIdentifierDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, userCustomLoginIdentifierDeleteReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserCustomLoginIdentifierDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserCustomLoginIdentifierDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserCustomLoginIdentifierDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserCustomLoginIdentifierDeleteReq is not found in the empty JSON string", UserCustomLoginIdentifierDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserCustomLoginIdentifierDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserCustomLoginIdentifierDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserCustomLoginIdentifierDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserCustomLoginIdentifierDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserCustomLoginIdentifierDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserCustomLoginIdentifierDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<UserCustomLoginIdentifierDeleteReq>() {
           @Override
           public void write(JsonWriter out, UserCustomLoginIdentifierDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserCustomLoginIdentifierDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserCustomLoginIdentifierDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserCustomLoginIdentifierDeleteReq
  * @throws IOException if the JSON string is invalid with respect to UserCustomLoginIdentifierDeleteReq
  */
  public static UserCustomLoginIdentifierDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserCustomLoginIdentifierDeleteReq.class);
  }

 /**
  * Convert an instance of UserCustomLoginIdentifierDeleteReq to an JSON string
  *
  * @return JSON string
  */
