...
import com.corbado.generated.model.SessionTokenCreateRspAllOfData;
...
public class SessionTokenCreateRsp {
  ...
  private SessionTokenCreateRspAllOfData data;

  public SessionTokenCreateRsp() {
  }

  public SessionTokenCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public SessionTokenCreateRsp message(String message) {
  ...
  **/
  ...
  public SessionTokenCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public SessionTokenCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public SessionTokenCreateRsp data(SessionTokenCreateRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public SessionTokenCreateRspAllOfData getData() {
    return data;
  }

  public void setData(SessionTokenCreateRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SessionTokenCreateRsp sessionTokenCreateRsp = (SessionTokenCreateRsp) o;
    return Objects.equals(this.httpStatusCode, sessionTokenCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, sessionTokenCreateRsp.message) &&
        Objects.equals(this.requestData, sessionTokenCreateRsp.requestData) &&
        Objects.equals(this.runtime, sessionTokenCreateRsp.runtime) &&
        Objects.equals(this.data, sessionTokenCreateRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionTokenCreateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SessionTokenCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionTokenCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionTokenCreateRsp is not found in the empty JSON string", SessionTokenCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionTokenCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionTokenCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SessionTokenCreateRsp.openapiRequiredFields) {
      ...
      SessionTokenCreateRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionTokenCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionTokenCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionTokenCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionTokenCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionTokenCreateRsp>() {
           @Override
           public void write(JsonWriter out, SessionTokenCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionTokenCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SessionTokenCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionTokenCreateRsp
  * @throws IOException if the JSON string is invalid with respect to SessionTokenCreateRsp
  */
  public static SessionTokenCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionTokenCreateRsp.class);
  }

 /**
  * Convert an instance of SessionTokenCreateRsp to an JSON string
  *
  * @return JSON string
  */
