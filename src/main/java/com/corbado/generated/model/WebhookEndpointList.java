...
public class WebhookEndpointList {
   ...
   * @return the WebhookEndpointList instance itself
   */
  public WebhookEndpointList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.webhookEndpoints, webhookEndpointList.webhookEndpoints)&&
        Objects.equals(this.additionalProperties, webhookEndpointList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhookEndpoints, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("webhookEndpoints"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("webhookEndpoints"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEndpointList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookEndpointList is not found in the empty JSON string", WebhookEndpointList.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("webhookEndpoints").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `webhookEndpoints` to be an array in the JSON string but got `%s`", jsonObj.get("webhookEndpoints").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookEndpointList>() {
           ...
           public WebhookEndpointList read(JsonReader in) throws IOException {
             ...
             WebhookEndpointList instance = thisAdapter.fromJsonTree(jsonObj);
