...
public class AndroidAppConfigUpdateReq {
  ...
  public AndroidAppConfigUpdateReq packageName(String packageName) {
  ...
  **/
  ...
  public AndroidAppConfigUpdateReq fingerprint(String fingerprint) {
  ...
  **/
  ...
  public AndroidAppConfigUpdateReq requestID(String requestID) {
  ...
  **/
  ...
  public AndroidAppConfigUpdateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AndroidAppConfigUpdateReq androidAppConfigUpdateReq = (AndroidAppConfigUpdateReq) o;
    return Objects.equals(this.packageName, androidAppConfigUpdateReq.packageName) &&
        Objects.equals(this.fingerprint, androidAppConfigUpdateReq.fingerprint) &&
        Objects.equals(this.requestID, androidAppConfigUpdateReq.requestID) &&
        Objects.equals(this.clientInfo, androidAppConfigUpdateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(packageName, fingerprint, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AndroidAppConfigUpdateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AndroidAppConfigUpdateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AndroidAppConfigUpdateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AndroidAppConfigUpdateReq is not found in the empty JSON string", AndroidAppConfigUpdateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AndroidAppConfigUpdateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AndroidAppConfigUpdateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AndroidAppConfigUpdateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AndroidAppConfigUpdateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AndroidAppConfigUpdateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AndroidAppConfigUpdateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AndroidAppConfigUpdateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<AndroidAppConfigUpdateReq>() {
           @Override
           public void write(JsonWriter out, AndroidAppConfigUpdateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AndroidAppConfigUpdateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AndroidAppConfigUpdateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AndroidAppConfigUpdateReq
  * @throws IOException if the JSON string is invalid with respect to AndroidAppConfigUpdateReq
  */
  public static AndroidAppConfigUpdateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AndroidAppConfigUpdateReq.class);
  }

 /**
  * Convert an instance of AndroidAppConfigUpdateReq to an JSON string
  *
  * @return JSON string
  */
