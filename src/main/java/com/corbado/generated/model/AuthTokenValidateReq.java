...
public class AuthTokenValidateReq {
  ...
  public AuthTokenValidateReq token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public AuthTokenValidateReq requestID(String requestID) {
  ...
  **/
  ...
  public AuthTokenValidateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthTokenValidateReq authTokenValidateReq = (AuthTokenValidateReq) o;
    return Objects.equals(this.token, authTokenValidateReq.token) &&
        Objects.equals(this.requestID, authTokenValidateReq.requestID) &&
        Objects.equals(this.clientInfo, authTokenValidateReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthTokenValidateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuthTokenValidateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthTokenValidateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthTokenValidateReq is not found in the empty JSON string", AuthTokenValidateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthTokenValidateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthTokenValidateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthTokenValidateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthTokenValidateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthTokenValidateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthTokenValidateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthTokenValidateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthTokenValidateReq>() {
           @Override
           public void write(JsonWriter out, AuthTokenValidateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthTokenValidateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AuthTokenValidateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthTokenValidateReq
  * @throws IOException if the JSON string is invalid with respect to AuthTokenValidateReq
  */
  public static AuthTokenValidateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthTokenValidateReq.class);
  }

 /**
  * Convert an instance of AuthTokenValidateReq to an JSON string
  *
  * @return JSON string
  */
