...
import com.corbado.generated.model.EmailTemplateCreateRspAllOfData;
...
public class EmailTemplateCreateRsp {
  ...
  private EmailTemplateCreateRspAllOfData data;

  public EmailTemplateCreateRsp() {
  }

  public EmailTemplateCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailTemplateCreateRsp message(String message) {
  ...
  **/
  ...
  public EmailTemplateCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailTemplateCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailTemplateCreateRsp data(EmailTemplateCreateRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public EmailTemplateCreateRspAllOfData getData() {
    return data;
  }

  public void setData(EmailTemplateCreateRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailTemplateCreateRsp emailTemplateCreateRsp = (EmailTemplateCreateRsp) o;
    return Objects.equals(this.httpStatusCode, emailTemplateCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, emailTemplateCreateRsp.message) &&
        Objects.equals(this.requestData, emailTemplateCreateRsp.requestData) &&
        Objects.equals(this.runtime, emailTemplateCreateRsp.runtime) &&
        Objects.equals(this.data, emailTemplateCreateRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailTemplateCreateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailTemplateCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailTemplateCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailTemplateCreateRsp is not found in the empty JSON string", EmailTemplateCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailTemplateCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailTemplateCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailTemplateCreateRsp.openapiRequiredFields) {
      ...
      EmailTemplateCreateRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailTemplateCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailTemplateCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailTemplateCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailTemplateCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailTemplateCreateRsp>() {
           @Override
           public void write(JsonWriter out, EmailTemplateCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailTemplateCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailTemplateCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailTemplateCreateRsp
  * @throws IOException if the JSON string is invalid with respect to EmailTemplateCreateRsp
  */
  public static EmailTemplateCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailTemplateCreateRsp.class);
  }

 /**
  * Convert an instance of EmailTemplateCreateRsp to an JSON string
  *
  * @return JSON string
  */
