...
import com.corbado.generated.model.TrackingStatsListRspAllOfData;
...
public class TrackingStatsListRsp {
  ...
  private TrackingStatsListRspAllOfData data;

  public TrackingStatsListRsp() {
  }

  public TrackingStatsListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public TrackingStatsListRsp message(String message) {
  ...
  **/
  ...
  public TrackingStatsListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public TrackingStatsListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public TrackingStatsListRsp data(TrackingStatsListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public TrackingStatsListRspAllOfData getData() {
    return data;
  }

  public void setData(TrackingStatsListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrackingStatsListRsp trackingStatsListRsp = (TrackingStatsListRsp) o;
    return Objects.equals(this.httpStatusCode, trackingStatsListRsp.httpStatusCode) &&
        Objects.equals(this.message, trackingStatsListRsp.message) &&
        Objects.equals(this.requestData, trackingStatsListRsp.requestData) &&
        Objects.equals(this.runtime, trackingStatsListRsp.runtime) &&
        Objects.equals(this.data, trackingStatsListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrackingStatsListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingStatsListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingStatsListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingStatsListRsp is not found in the empty JSON string", TrackingStatsListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingStatsListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingStatsListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingStatsListRsp.openapiRequiredFields) {
      ...
      TrackingStatsListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingStatsListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingStatsListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingStatsListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingStatsListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingStatsListRsp>() {
           @Override
           public void write(JsonWriter out, TrackingStatsListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingStatsListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingStatsListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingStatsListRsp
  * @throws IOException if the JSON string is invalid with respect to TrackingStatsListRsp
  */
  public static TrackingStatsListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingStatsListRsp.class);
  }

 /**
  * Convert an instance of TrackingStatsListRsp to an JSON string
  *
  * @return JSON string
  */
