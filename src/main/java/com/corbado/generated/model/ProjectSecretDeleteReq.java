...
public class ProjectSecretDeleteReq {
  ...
  public ProjectSecretDeleteReq() {
  }

  public ProjectSecretDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public ProjectSecretDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectSecretDeleteReq projectSecretDeleteReq = (ProjectSecretDeleteReq) o;
    return Objects.equals(this.requestID, projectSecretDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, projectSecretDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectSecretDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectSecretDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSecretDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSecretDeleteReq is not found in the empty JSON string", ProjectSecretDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSecretDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSecretDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSecretDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSecretDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSecretDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSecretDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSecretDeleteReq>() {
           @Override
           public void write(JsonWriter out, ProjectSecretDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSecretDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectSecretDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectSecretDeleteReq
  * @throws IOException if the JSON string is invalid with respect to ProjectSecretDeleteReq
  */
  public static ProjectSecretDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSecretDeleteReq.class);
  }

 /**
  * Convert an instance of ProjectSecretDeleteReq to an JSON string
  *
  * @return JSON string
  */
