...
public class EmailTemplateDeleteReq {
  ...
  public EmailTemplateDeleteReq() {
  }

  public EmailTemplateDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public EmailTemplateDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailTemplateDeleteReq emailTemplateDeleteReq = (EmailTemplateDeleteReq) o;
    return Objects.equals(this.requestID, emailTemplateDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, emailTemplateDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailTemplateDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailTemplateDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailTemplateDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailTemplateDeleteReq is not found in the empty JSON string", EmailTemplateDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailTemplateDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailTemplateDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailTemplateDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailTemplateDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailTemplateDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailTemplateDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailTemplateDeleteReq>() {
           @Override
           public void write(JsonWriter out, EmailTemplateDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailTemplateDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailTemplateDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailTemplateDeleteReq
  * @throws IOException if the JSON string is invalid with respect to EmailTemplateDeleteReq
  */
  public static EmailTemplateDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailTemplateDeleteReq.class);
  }

 /**
  * Convert an instance of EmailTemplateDeleteReq to an JSON string
  *
  * @return JSON string
  */
