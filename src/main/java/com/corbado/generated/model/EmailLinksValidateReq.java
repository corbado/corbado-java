...
public class EmailLinksValidateReq {
  public static final String SERIALIZED_NAME_TOKEN = "token";
  @SerializedName(SERIALIZED_NAME_TOKEN)
  private String token;

  public static final String SERIALIZED_NAME_CREATE_LOGIN_TOKEN = "createLoginToken";
  @SerializedName(SERIALIZED_NAME_CREATE_LOGIN_TOKEN)
  private Boolean createLoginToken;
  ...
  public EmailLinksValidateReq() {
  }

  public EmailLinksValidateReq token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public EmailLinksValidateReq createLoginToken(Boolean createLoginToken) {
  ...
  **/
  ...
  public Boolean getCreateLoginToken() {
    return createLoginToken;
  }

  public void setCreateLoginToken(Boolean createLoginToken) {
    this.createLoginToken = createLoginToken;
  }


  public EmailLinksValidateReq requestID(String requestID) {
  ...
  **/
  ...
  public EmailLinksValidateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailLinksValidateReq emailLinksValidateReq = (EmailLinksValidateReq) o;
    return Objects.equals(this.token, emailLinksValidateReq.token) &&
        Objects.equals(this.createLoginToken, emailLinksValidateReq.createLoginToken) &&
        Objects.equals(this.requestID, emailLinksValidateReq.requestID) &&
        Objects.equals(this.clientInfo, emailLinksValidateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, createLoginToken, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailLinksValidateReq {\n");
  ...
  static {
    ...
    openapiFields.add("createLoginToken");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLinksValidateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLinksValidateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLinksValidateReq is not found in the empty JSON string", EmailLinksValidateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLinksValidateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLinksValidateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLinksValidateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLinksValidateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLinksValidateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLinksValidateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLinksValidateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLinksValidateReq>() {
           @Override
           public void write(JsonWriter out, EmailLinksValidateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLinksValidateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLinksValidateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLinksValidateReq
  * @throws IOException if the JSON string is invalid with respect to EmailLinksValidateReq
  */
  public static EmailLinksValidateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLinksValidateReq.class);
  }

 /**
  * Convert an instance of EmailLinksValidateReq to an JSON string
  *
  * @return JSON string
  */
