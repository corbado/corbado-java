 ...
 */
@JsonAdapter(LoginIdentifierType.Adapter.class)
public enum LoginIdentifierType {
  ...
  LoginIdentifierType(String value) {
    this.value = value;
  }
  ...
  public static LoginIdentifierType fromValue(String value) {
    for (LoginIdentifierType b : LoginIdentifierType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LoginIdentifierType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LoginIdentifierType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LoginIdentifierType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LoginIdentifierType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LoginIdentifierType.fromValue(value);
  }
}
