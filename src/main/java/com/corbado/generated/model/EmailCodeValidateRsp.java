...
public class EmailCodeValidateRsp {
  ...
  public EmailCodeValidateRsp() {
  }

  public EmailCodeValidateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailCodeValidateRsp message(String message) {
  ...
  **/
  ...
  public EmailCodeValidateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailCodeValidateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailCodeValidateRsp additionalPayload(String additionalPayload) {
  ...
  **/
  ...
  public EmailCodeValidateRsp userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public EmailCodeValidateRsp userFullName(String userFullName) {
  ...
  **/
  ...
  public EmailCodeValidateRsp userEmail(String userEmail) {
  ...
  **/
  ...
  public EmailCodeValidateRsp loginToken(String loginToken) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailCodeValidateRsp emailCodeValidateRsp = (EmailCodeValidateRsp) o;
    return Objects.equals(this.httpStatusCode, emailCodeValidateRsp.httpStatusCode) &&
        Objects.equals(this.message, emailCodeValidateRsp.message) &&
        Objects.equals(this.requestData, emailCodeValidateRsp.requestData) &&
        Objects.equals(this.runtime, emailCodeValidateRsp.runtime) &&
        Objects.equals(this.additionalPayload, emailCodeValidateRsp.additionalPayload) &&
        Objects.equals(this.userID, emailCodeValidateRsp.userID) &&
        Objects.equals(this.userFullName, emailCodeValidateRsp.userFullName) &&
        Objects.equals(this.userEmail, emailCodeValidateRsp.userEmail) &&
        Objects.equals(this.loginToken, emailCodeValidateRsp.loginToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, additionalPayload, userID, userFullName, userEmail, loginToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailCodeValidateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailCodeValidateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailCodeValidateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCodeValidateRsp is not found in the empty JSON string", EmailCodeValidateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailCodeValidateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCodeValidateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCodeValidateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCodeValidateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCodeValidateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCodeValidateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCodeValidateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCodeValidateRsp>() {
           @Override
           public void write(JsonWriter out, EmailCodeValidateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCodeValidateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCodeValidateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCodeValidateRsp
  * @throws IOException if the JSON string is invalid with respect to EmailCodeValidateRsp
  */
  public static EmailCodeValidateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCodeValidateRsp.class);
  }

 /**
  * Convert an instance of EmailCodeValidateRsp to an JSON string
  *
  * @return JSON string
  */
