...
public class WebAuthnAuthenticateFinishRsp {
  ...
  public enum StatusEnum {
    ...
    UNCONFIRMED_CREDENTIAL("unconfirmedCredential");
  ...
  public WebAuthnAuthenticateFinishRsp() {
  }

  public WebAuthnAuthenticateFinishRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp message(String message) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp username(String username) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp credentialID(String credentialID) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp userFullName(String userFullName) {
  ...
  **/
  ...
  public WebAuthnAuthenticateFinishRsp status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnAuthenticateFinishRsp webAuthnAuthenticateFinishRsp = (WebAuthnAuthenticateFinishRsp) o;
    return Objects.equals(this.httpStatusCode, webAuthnAuthenticateFinishRsp.httpStatusCode) &&
        Objects.equals(this.message, webAuthnAuthenticateFinishRsp.message) &&
        Objects.equals(this.requestData, webAuthnAuthenticateFinishRsp.requestData) &&
        Objects.equals(this.runtime, webAuthnAuthenticateFinishRsp.runtime) &&
        Objects.equals(this.userID, webAuthnAuthenticateFinishRsp.userID) &&
        Objects.equals(this.username, webAuthnAuthenticateFinishRsp.username) &&
        Objects.equals(this.credentialID, webAuthnAuthenticateFinishRsp.credentialID) &&
        Objects.equals(this.userFullName, webAuthnAuthenticateFinishRsp.userFullName) &&
        Objects.equals(this.status, webAuthnAuthenticateFinishRsp.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebAuthnAuthenticateFinishRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnAuthenticateFinishRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnAuthenticateFinishRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnAuthenticateFinishRsp is not found in the empty JSON string", WebAuthnAuthenticateFinishRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnAuthenticateFinishRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnAuthenticateFinishRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnAuthenticateFinishRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnAuthenticateFinishRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnAuthenticateFinishRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnAuthenticateFinishRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnAuthenticateFinishRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnAuthenticateFinishRsp>() {
           @Override
           public void write(JsonWriter out, WebAuthnAuthenticateFinishRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnAuthenticateFinishRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnAuthenticateFinishRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnAuthenticateFinishRsp
  * @throws IOException if the JSON string is invalid with respect to WebAuthnAuthenticateFinishRsp
  */
  public static WebAuthnAuthenticateFinishRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnAuthenticateFinishRsp.class);
  }

 /**
  * Convert an instance of WebAuthnAuthenticateFinishRsp to an JSON string
  *
  * @return JSON string
  */
