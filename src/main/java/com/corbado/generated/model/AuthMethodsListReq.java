...
public class AuthMethodsListReq {
  ...
  public AuthMethodsListReq() {
  }

  public AuthMethodsListReq username(String username) {
  ...
  **/
  ...
  public AuthMethodsListReq requestID(String requestID) {
  ...
  **/
  ...
  public AuthMethodsListReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodsListReq authMethodsListReq = (AuthMethodsListReq) o;
    return Objects.equals(this.username, authMethodsListReq.username) &&
        Objects.equals(this.requestID, authMethodsListReq.requestID) &&
        Objects.equals(this.clientInfo, authMethodsListReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthMethodsListReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuthMethodsListReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodsListReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthMethodsListReq is not found in the empty JSON string", AuthMethodsListReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodsListReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthMethodsListReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodsListReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodsListReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodsListReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodsListReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodsListReq.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodsListReq>() {
           @Override
           public void write(JsonWriter out, AuthMethodsListReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodsListReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AuthMethodsListReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthMethodsListReq
  * @throws IOException if the JSON string is invalid with respect to AuthMethodsListReq
  */
  public static AuthMethodsListReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodsListReq.class);
  }

 /**
  * Convert an instance of AuthMethodsListReq to an JSON string
  *
  * @return JSON string
  */
