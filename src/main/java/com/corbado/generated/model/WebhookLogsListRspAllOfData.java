...
import com.corbado.generated.model.WebhookLog;
...
public class WebhookLogsListRspAllOfData {
  ...
  public WebhookLogsListRspAllOfData logs(List<WebhookLog> logs) {
    this.logs = logs;
    return this;
  }

  public WebhookLogsListRspAllOfData addLogsItem(WebhookLog logsItem) {
    if (this.logs == null) {
  ...
  **/
  ...
  public void setLogs(List<WebhookLog> logs) {
    this.logs = logs;
  }


  public WebhookLogsListRspAllOfData paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookLogsListRspAllOfData webhookLogsListRspAllOfData = (WebhookLogsListRspAllOfData) o;
    return Objects.equals(this.logs, webhookLogsListRspAllOfData.logs) &&
        Objects.equals(this.paging, webhookLogsListRspAllOfData.paging);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logs, paging);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookLogsListRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebhookLogsListRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookLogsListRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookLogsListRspAllOfData is not found in the empty JSON string", WebhookLogsListRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookLogsListRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookLogsListRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookLogsListRspAllOfData.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraylogs.size(); i++) {
        WebhookLog.validateJsonElement(jsonArraylogs.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookLogsListRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookLogsListRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookLogsListRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookLogsListRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookLogsListRspAllOfData>() {
           @Override
           public void write(JsonWriter out, WebhookLogsListRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookLogsListRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookLogsListRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookLogsListRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to WebhookLogsListRspAllOfData
  */
  public static WebhookLogsListRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookLogsListRspAllOfData.class);
  }

 /**
  * Convert an instance of WebhookLogsListRspAllOfData to an JSON string
  *
  * @return JSON string
  */
