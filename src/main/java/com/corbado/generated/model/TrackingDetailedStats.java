...
public class TrackingDetailedStats {
  ...
  public static final String SERIALIZED_NAME_CONDITIONAL_UI = "conditionalUi";
  ...
  public TrackingDetailedStats timePoint(String timePoint) {
  ...
  **/
  ...
  public TrackingDetailedStats visits(Integer visits) {
    this.visits = visits;
    return this;
  }
  ...
  **/
  ...
  public TrackingDetailedStats webauthn(Integer webauthn) {
  ...
  **/
  ...
  public TrackingDetailedStats platform(Integer platform) {
  ...
  **/
  ...
  public TrackingDetailedStats conditionalUi(Integer conditionalUi) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrackingDetailedStats trackingDetailedStats = (TrackingDetailedStats) o;
    return Objects.equals(this.timePoint, trackingDetailedStats.timePoint) &&
        Objects.equals(this.visits, trackingDetailedStats.visits) &&
        Objects.equals(this.webauthn, trackingDetailedStats.webauthn) &&
        Objects.equals(this.platform, trackingDetailedStats.platform) &&
        Objects.equals(this.conditionalUi, trackingDetailedStats.conditionalUi);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timePoint, visits, webauthn, platform, conditionalUi);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackingDetailedStats {\n");
  ...
  static {
    ...
    openapiFields.add("conditionalUi");
    ...
    openapiRequiredFields.add("conditionalUi");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingDetailedStats
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingDetailedStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingDetailedStats is not found in the empty JSON string", TrackingDetailedStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingDetailedStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingDetailedStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingDetailedStats.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingDetailedStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingDetailedStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingDetailedStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingDetailedStats.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingDetailedStats>() {
           @Override
           public void write(JsonWriter out, TrackingDetailedStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingDetailedStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingDetailedStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingDetailedStats
  * @throws IOException if the JSON string is invalid with respect to TrackingDetailedStats
  */
  public static TrackingDetailedStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingDetailedStats.class);
  }

 /**
  * Convert an instance of TrackingDetailedStats to an JSON string
  *
  * @return JSON string
  */
