...
public class PasskeyAppendFinishReq {
  ...
  public PasskeyAppendFinishReq trackingID(@javax.annotation.Nonnull String trackingID) {
   ...
   * @return the PasskeyAppendFinishReq instance itself
   */
  public PasskeyAppendFinishReq putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userID, passkeyAppendFinishReq.userID) &&
        ...
        Objects.equals(this.additionalProperties, passkeyAppendFinishReq.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userID, processID, attestationResponse, clientInformation, sendNotification, trackingID, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("userID", "processID", "attestationResponse", "clientInformation", "sendNotification", "trackingID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("userID", "processID", "attestationResponse", "clientInformation", "trackingID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasskeyAppendFinishReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PasskeyAppendFinishReq is not found in the empty JSON string", PasskeyAppendFinishReq.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("attestationResponse").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `attestationResponse` to be a primitive type in the JSON string but got `%s`", jsonObj.get("attestationResponse").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasskeyAppendFinishReq>() {
           ...
           public PasskeyAppendFinishReq read(JsonReader in) throws IOException {
             ...
             PasskeyAppendFinishReq instance = thisAdapter.fromJsonTree(jsonObj);
