...
public class PasskeyAppendFinishReq {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userID, processID, attestationResponse, clientInformation, sendNotification, trackingID);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PasskeyAppendFinishReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PasskeyAppendFinishReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
