...
public class RequestLogGetRsp {
  ...
  public RequestLogGetRsp() {
  }

  public RequestLogGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public RequestLogGetRsp message(String message) {
  ...
  **/
  ...
  public RequestLogGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public RequestLogGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public RequestLogGetRsp data(RequestLog data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public void setData(RequestLog data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    RequestLogGetRsp requestLogGetRsp = (RequestLogGetRsp) o;
    return Objects.equals(this.httpStatusCode, requestLogGetRsp.httpStatusCode) &&
        Objects.equals(this.message, requestLogGetRsp.message) &&
        Objects.equals(this.requestData, requestLogGetRsp.requestData) &&
        Objects.equals(this.runtime, requestLogGetRsp.runtime) &&
        Objects.equals(this.data, requestLogGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestLogGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to RequestLogGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestLogGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestLogGetRsp is not found in the empty JSON string", RequestLogGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestLogGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestLogGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestLogGetRsp.openapiRequiredFields) {
      ...
      RequestLog.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestLogGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestLogGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestLogGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestLogGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestLogGetRsp>() {
           @Override
           public void write(JsonWriter out, RequestLogGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestLogGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RequestLogGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RequestLogGetRsp
  * @throws IOException if the JSON string is invalid with respect to RequestLogGetRsp
  */
  public static RequestLogGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestLogGetRsp.class);
  }

 /**
  * Convert an instance of RequestLogGetRsp to an JSON string
  *
  * @return JSON string
  */
