...
import com.corbado.generated.model.ProjectConfig;
...
public class ProjectConfigGetRsp {
  ...
  private ProjectConfig data;

  public ProjectConfigGetRsp() {
  }

  public ProjectConfigGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public ProjectConfigGetRsp message(String message) {
  ...
  **/
  ...
  public ProjectConfigGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public ProjectConfigGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public ProjectConfigGetRsp data(ProjectConfig data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectConfigGetRsp projectConfigGetRsp = (ProjectConfigGetRsp) o;
    return Objects.equals(this.httpStatusCode, projectConfigGetRsp.httpStatusCode) &&
        Objects.equals(this.message, projectConfigGetRsp.message) &&
        Objects.equals(this.requestData, projectConfigGetRsp.requestData) &&
        Objects.equals(this.runtime, projectConfigGetRsp.runtime) &&
        Objects.equals(this.data, projectConfigGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectConfigGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectConfigGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectConfigGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectConfigGetRsp is not found in the empty JSON string", ProjectConfigGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectConfigGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectConfigGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectConfigGetRsp.openapiRequiredFields) {
      ...
      ProjectConfig.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectConfigGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectConfigGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectConfigGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectConfigGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectConfigGetRsp>() {
           @Override
           public void write(JsonWriter out, ProjectConfigGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectConfigGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectConfigGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectConfigGetRsp
  * @throws IOException if the JSON string is invalid with respect to ProjectConfigGetRsp
  */
  public static ProjectConfigGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectConfigGetRsp.class);
  }

 /**
  * Convert an instance of ProjectConfigGetRsp to an JSON string
  *
  * @return JSON string
  */
