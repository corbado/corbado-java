...
import com.corbado.generated.model.UserDevice;
...
public class UserDeviceListRsp {
  ...
  public UserDeviceListRsp() {
  }

  public UserDeviceListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserDeviceListRsp message(String message) {
  ...
  **/
  ...
  public UserDeviceListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserDeviceListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserDeviceListRsp devices(List<UserDevice> devices) {
    this.devices = devices;
    return this;
  }

  public UserDeviceListRsp addDevicesItem(UserDevice devicesItem) {
  ...
  **/
  ...
  public UserDeviceListRsp paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserDeviceListRsp userDeviceListRsp = (UserDeviceListRsp) o;
    return Objects.equals(this.httpStatusCode, userDeviceListRsp.httpStatusCode) &&
        Objects.equals(this.message, userDeviceListRsp.message) &&
        Objects.equals(this.requestData, userDeviceListRsp.requestData) &&
        Objects.equals(this.runtime, userDeviceListRsp.runtime) &&
        Objects.equals(this.devices, userDeviceListRsp.devices) &&
        Objects.equals(this.paging, userDeviceListRsp.paging);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, devices, paging);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserDeviceListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserDeviceListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserDeviceListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDeviceListRsp is not found in the empty JSON string", UserDeviceListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserDeviceListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserDeviceListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserDeviceListRsp.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydevices.size(); i++) {
        UserDevice.validateJsonElement(jsonArraydevices.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDeviceListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDeviceListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDeviceListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDeviceListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDeviceListRsp>() {
           @Override
           public void write(JsonWriter out, UserDeviceListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserDeviceListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserDeviceListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserDeviceListRsp
  * @throws IOException if the JSON string is invalid with respect to UserDeviceListRsp
  */
  public static UserDeviceListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDeviceListRsp.class);
  }

 /**
  * Convert an instance of UserDeviceListRsp to an JSON string
  *
  * @return JSON string
  */
