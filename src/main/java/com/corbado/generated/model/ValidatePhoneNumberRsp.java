...
import com.corbado.generated.model.PhoneNumberValidationResult;
...
public class ValidatePhoneNumberRsp {
  ...
  private PhoneNumberValidationResult data;

  public ValidatePhoneNumberRsp() {
  }

  public ValidatePhoneNumberRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public ValidatePhoneNumberRsp message(String message) {
  ...
  **/
  ...
  public ValidatePhoneNumberRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public ValidatePhoneNumberRsp runtime(Float runtime) {
  ...
  **/
  ...
  public ValidatePhoneNumberRsp data(PhoneNumberValidationResult data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public PhoneNumberValidationResult getData() {
    return data;
  }

  public void setData(PhoneNumberValidationResult data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidatePhoneNumberRsp validatePhoneNumberRsp = (ValidatePhoneNumberRsp) o;
    return Objects.equals(this.httpStatusCode, validatePhoneNumberRsp.httpStatusCode) &&
        Objects.equals(this.message, validatePhoneNumberRsp.message) &&
        Objects.equals(this.requestData, validatePhoneNumberRsp.requestData) &&
        Objects.equals(this.runtime, validatePhoneNumberRsp.runtime) &&
        Objects.equals(this.data, validatePhoneNumberRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidatePhoneNumberRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ValidatePhoneNumberRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidatePhoneNumberRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidatePhoneNumberRsp is not found in the empty JSON string", ValidatePhoneNumberRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidatePhoneNumberRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidatePhoneNumberRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidatePhoneNumberRsp.openapiRequiredFields) {
      ...
      PhoneNumberValidationResult.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidatePhoneNumberRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidatePhoneNumberRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidatePhoneNumberRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidatePhoneNumberRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidatePhoneNumberRsp>() {
           @Override
           public void write(JsonWriter out, ValidatePhoneNumberRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidatePhoneNumberRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ValidatePhoneNumberRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidatePhoneNumberRsp
  * @throws IOException if the JSON string is invalid with respect to ValidatePhoneNumberRsp
  */
  public static ValidatePhoneNumberRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidatePhoneNumberRsp.class);
  }

 /**
  * Convert an instance of ValidatePhoneNumberRsp to an JSON string
  *
  * @return JSON string
  */
