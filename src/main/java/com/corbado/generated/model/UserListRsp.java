...
import com.corbado.generated.model.UserListRspAllOfData;
...
public class UserListRsp {
  ...
  private UserListRspAllOfData data;

  public UserListRsp() {
  }

  public UserListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserListRsp message(String message) {
  ...
  **/
  ...
  public UserListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserListRsp data(UserListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserListRspAllOfData getData() {
    return data;
  }

  public void setData(UserListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserListRsp userListRsp = (UserListRsp) o;
    return Objects.equals(this.httpStatusCode, userListRsp.httpStatusCode) &&
        Objects.equals(this.message, userListRsp.message) &&
        Objects.equals(this.requestData, userListRsp.requestData) &&
        Objects.equals(this.runtime, userListRsp.runtime) &&
        Objects.equals(this.data, userListRsp.data);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserListRsp is not found in the empty JSON string", UserListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserListRsp.openapiRequiredFields) {
      ...
      UserListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserListRsp>() {
           @Override
           public void write(JsonWriter out, UserListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserListRsp
  * @throws IOException if the JSON string is invalid with respect to UserListRsp
  */
  public static UserListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserListRsp.class);
  }

 /**
  * Convert an instance of UserListRsp to an JSON string
  *
  * @return JSON string
  */
