...
import com.corbado.generated.model.SessionTokenVerifyRspAllOfData;
...
public class SessionTokenVerifyRsp {
  ...
  private SessionTokenVerifyRspAllOfData data;

  public SessionTokenVerifyRsp() {
  }

  public SessionTokenVerifyRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public SessionTokenVerifyRsp message(String message) {
  ...
  **/
  ...
  public SessionTokenVerifyRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public SessionTokenVerifyRsp runtime(Float runtime) {
  ...
  **/
  ...
  public SessionTokenVerifyRsp data(SessionTokenVerifyRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public SessionTokenVerifyRspAllOfData getData() {
    return data;
  }

  public void setData(SessionTokenVerifyRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SessionTokenVerifyRsp sessionTokenVerifyRsp = (SessionTokenVerifyRsp) o;
    return Objects.equals(this.httpStatusCode, sessionTokenVerifyRsp.httpStatusCode) &&
        Objects.equals(this.message, sessionTokenVerifyRsp.message) &&
        Objects.equals(this.requestData, sessionTokenVerifyRsp.requestData) &&
        Objects.equals(this.runtime, sessionTokenVerifyRsp.runtime) &&
        Objects.equals(this.data, sessionTokenVerifyRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionTokenVerifyRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SessionTokenVerifyRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionTokenVerifyRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionTokenVerifyRsp is not found in the empty JSON string", SessionTokenVerifyRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionTokenVerifyRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionTokenVerifyRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SessionTokenVerifyRsp.openapiRequiredFields) {
      ...
      SessionTokenVerifyRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionTokenVerifyRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionTokenVerifyRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionTokenVerifyRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionTokenVerifyRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionTokenVerifyRsp>() {
           @Override
           public void write(JsonWriter out, SessionTokenVerifyRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionTokenVerifyRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SessionTokenVerifyRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionTokenVerifyRsp
  * @throws IOException if the JSON string is invalid with respect to SessionTokenVerifyRsp
  */
  public static SessionTokenVerifyRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionTokenVerifyRsp.class);
  }

 /**
  * Convert an instance of SessionTokenVerifyRsp to an JSON string
  *
  * @return JSON string
  */
