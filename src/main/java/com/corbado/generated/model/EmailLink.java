...
public class EmailLink {
  ...
  **/
  ...
  public EmailLink userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public EmailLink email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public EmailLink userFullName(String userFullName) {
  ...
  **/
  ...
  public EmailLink purpose(String purpose) {
  ...
  **/
  ...
  public EmailLink created(String created) {
  ...
  **/
  ...
  public EmailLink updated(String updated) {
  ...
  **/
  ...
  public EmailLink status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EmailLink additionalPayload(String additionalPayload) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ID, emailLink.ID) &&
        Objects.equals(this.userID, emailLink.userID) &&
        Objects.equals(this.email, emailLink.email) &&
        Objects.equals(this.userFullName, emailLink.userFullName) &&
        Objects.equals(this.purpose, emailLink.purpose) &&
        Objects.equals(this.created, emailLink.created) &&
        Objects.equals(this.updated, emailLink.updated) &&
        Objects.equals(this.status, emailLink.status) &&
        Objects.equals(this.additionalPayload, emailLink.additionalPayload);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ID, userID, email, userFullName, purpose, created, updated, status, additionalPayload);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("additionalPayload");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLink
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLink is not found in the empty JSON string", EmailLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLink.openapiRequiredFields) {
      ...
      if (!jsonObj.get("additionalPayload").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLink.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLink>() {
           @Override
           public void write(JsonWriter out, EmailLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLink read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLink given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLink
  * @throws IOException if the JSON string is invalid with respect to EmailLink
  */
  public static EmailLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLink.class);
  }

 /**
  * Convert an instance of EmailLink to an JSON string
  *
  * @return JSON string
  */
