...
public class UserSocialAccount {
  ...
  public UserSocialAccount providerType(SocialProviderType providerType) {
  ...
  **/
  ...
  public UserSocialAccount identifierValue(String identifierValue) {
  ...
  **/
  ...
  public UserSocialAccount avatarUrl(String avatarUrl) {
  ...
  **/
  ...
  public UserSocialAccount fullName(String fullName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserSocialAccount userSocialAccount = (UserSocialAccount) o;
    return Objects.equals(this.providerType, userSocialAccount.providerType) &&
        Objects.equals(this.identifierValue, userSocialAccount.identifierValue) &&
        Objects.equals(this.avatarUrl, userSocialAccount.avatarUrl) &&
        Objects.equals(this.fullName, userSocialAccount.fullName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerType, identifierValue, avatarUrl, fullName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserSocialAccount {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserSocialAccount
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserSocialAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserSocialAccount is not found in the empty JSON string", UserSocialAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserSocialAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserSocialAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserSocialAccount.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserSocialAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserSocialAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserSocialAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserSocialAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<UserSocialAccount>() {
           @Override
           public void write(JsonWriter out, UserSocialAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserSocialAccount read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserSocialAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserSocialAccount
  * @throws IOException if the JSON string is invalid with respect to UserSocialAccount
  */
  public static UserSocialAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserSocialAccount.class);
  }

 /**
  * Convert an instance of UserSocialAccount to an JSON string
  *
  * @return JSON string
  */
