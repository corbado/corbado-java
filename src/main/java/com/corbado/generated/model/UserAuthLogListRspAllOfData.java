...
import com.corbado.generated.model.UserAuthLog;
...
public class UserAuthLogListRspAllOfData {
  public static final String SERIALIZED_NAME_ROWS = "rows";
  @SerializedName(SERIALIZED_NAME_ROWS)
  private List<UserAuthLog> rows = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public UserAuthLogListRspAllOfData() {
  }

  public UserAuthLogListRspAllOfData rows(List<UserAuthLog> rows) {
    this.rows = rows;
    return this;
  }

  public UserAuthLogListRspAllOfData addRowsItem(UserAuthLog rowsItem) {
    if (this.rows == null) {
  ...
  **/
  ...
  public List<UserAuthLog> getRows() {
    return rows;
  }

  public void setRows(List<UserAuthLog> rows) {
    this.rows = rows;
  }


  public UserAuthLogListRspAllOfData paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserAuthLogListRspAllOfData userAuthLogListRspAllOfData = (UserAuthLogListRspAllOfData) o;
    return Objects.equals(this.rows, userAuthLogListRspAllOfData.rows) &&
        Objects.equals(this.paging, userAuthLogListRspAllOfData.paging);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rows, paging);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserAuthLogListRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserAuthLogListRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAuthLogListRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAuthLogListRspAllOfData is not found in the empty JSON string", UserAuthLogListRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAuthLogListRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAuthLogListRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserAuthLogListRspAllOfData.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrows.size(); i++) {
        UserAuthLog.validateJsonElement(jsonArrayrows.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAuthLogListRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAuthLogListRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAuthLogListRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAuthLogListRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAuthLogListRspAllOfData>() {
           @Override
           public void write(JsonWriter out, UserAuthLogListRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAuthLogListRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserAuthLogListRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserAuthLogListRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to UserAuthLogListRspAllOfData
  */
  public static UserAuthLogListRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAuthLogListRspAllOfData.class);
  }

 /**
  * Convert an instance of UserAuthLogListRspAllOfData to an JSON string
  *
  * @return JSON string
  */
