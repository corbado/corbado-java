...
public class WebauthnSettingDeleteReq {
  ...
  public WebauthnSettingDeleteReq() {
  }

  public WebauthnSettingDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public WebauthnSettingDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingDeleteReq webauthnSettingDeleteReq = (WebauthnSettingDeleteReq) o;
    return Objects.equals(this.requestID, webauthnSettingDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, webauthnSettingDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnSettingDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingDeleteReq is not found in the empty JSON string", WebauthnSettingDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingDeleteReq>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingDeleteReq
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingDeleteReq
  */
  public static WebauthnSettingDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingDeleteReq.class);
  }

 /**
  * Convert an instance of WebauthnSettingDeleteReq to an JSON string
  *
  * @return JSON string
  */
