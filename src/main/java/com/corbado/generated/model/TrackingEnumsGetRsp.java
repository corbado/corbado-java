...
import com.corbado.generated.model.TrackingEnums;
...
public class TrackingEnumsGetRsp {
  ...
  private TrackingEnums data;

  public TrackingEnumsGetRsp() {
  }

  public TrackingEnumsGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public TrackingEnumsGetRsp message(String message) {
  ...
  **/
  ...
  public TrackingEnumsGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public TrackingEnumsGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public TrackingEnumsGetRsp data(TrackingEnums data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public TrackingEnums getData() {
    return data;
  }

  public void setData(TrackingEnums data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrackingEnumsGetRsp trackingEnumsGetRsp = (TrackingEnumsGetRsp) o;
    return Objects.equals(this.httpStatusCode, trackingEnumsGetRsp.httpStatusCode) &&
        Objects.equals(this.message, trackingEnumsGetRsp.message) &&
        Objects.equals(this.requestData, trackingEnumsGetRsp.requestData) &&
        Objects.equals(this.runtime, trackingEnumsGetRsp.runtime) &&
        Objects.equals(this.data, trackingEnumsGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrackingEnumsGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingEnumsGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingEnumsGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingEnumsGetRsp is not found in the empty JSON string", TrackingEnumsGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingEnumsGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingEnumsGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingEnumsGetRsp.openapiRequiredFields) {
      ...
      TrackingEnums.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingEnumsGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingEnumsGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingEnumsGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingEnumsGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingEnumsGetRsp>() {
           @Override
           public void write(JsonWriter out, TrackingEnumsGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingEnumsGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingEnumsGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingEnumsGetRsp
  * @throws IOException if the JSON string is invalid with respect to TrackingEnumsGetRsp
  */
  public static TrackingEnumsGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingEnumsGetRsp.class);
  }

 /**
  * Convert an instance of TrackingEnumsGetRsp to an JSON string
  *
  * @return JSON string
  */
