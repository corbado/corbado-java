...
public class SessionTokenVerifyReq {
  ...
  public SessionTokenVerifyReq() {
  }

  public SessionTokenVerifyReq token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public SessionTokenVerifyReq requestID(String requestID) {
  ...
  **/
  ...
  public SessionTokenVerifyReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SessionTokenVerifyReq sessionTokenVerifyReq = (SessionTokenVerifyReq) o;
    return Objects.equals(this.token, sessionTokenVerifyReq.token) &&
        Objects.equals(this.requestID, sessionTokenVerifyReq.requestID) &&
        Objects.equals(this.clientInfo, sessionTokenVerifyReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SessionTokenVerifyReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SessionTokenVerifyReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionTokenVerifyReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionTokenVerifyReq is not found in the empty JSON string", SessionTokenVerifyReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionTokenVerifyReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionTokenVerifyReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SessionTokenVerifyReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionTokenVerifyReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionTokenVerifyReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionTokenVerifyReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionTokenVerifyReq.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionTokenVerifyReq>() {
           @Override
           public void write(JsonWriter out, SessionTokenVerifyReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionTokenVerifyReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SessionTokenVerifyReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionTokenVerifyReq
  * @throws IOException if the JSON string is invalid with respect to SessionTokenVerifyReq
  */
  public static SessionTokenVerifyReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionTokenVerifyReq.class);
  }

 /**
  * Convert an instance of SessionTokenVerifyReq to an JSON string
  *
  * @return JSON string
  */
