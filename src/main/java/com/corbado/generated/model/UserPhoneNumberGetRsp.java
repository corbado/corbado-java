...
import com.corbado.generated.model.UserPhoneNumberGetRspAllOfData;
...
public class UserPhoneNumberGetRsp {
  ...
  private UserPhoneNumberGetRspAllOfData data;

  public UserPhoneNumberGetRsp() {
  }

  public UserPhoneNumberGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserPhoneNumberGetRsp message(String message) {
  ...
  **/
  ...
  public UserPhoneNumberGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserPhoneNumberGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserPhoneNumberGetRsp data(UserPhoneNumberGetRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserPhoneNumberGetRspAllOfData getData() {
    return data;
  }

  public void setData(UserPhoneNumberGetRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserPhoneNumberGetRsp userPhoneNumberGetRsp = (UserPhoneNumberGetRsp) o;
    return Objects.equals(this.httpStatusCode, userPhoneNumberGetRsp.httpStatusCode) &&
        Objects.equals(this.message, userPhoneNumberGetRsp.message) &&
        Objects.equals(this.requestData, userPhoneNumberGetRsp.requestData) &&
        Objects.equals(this.runtime, userPhoneNumberGetRsp.runtime) &&
        Objects.equals(this.data, userPhoneNumberGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPhoneNumberGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserPhoneNumberGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPhoneNumberGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPhoneNumberGetRsp is not found in the empty JSON string", UserPhoneNumberGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPhoneNumberGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPhoneNumberGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserPhoneNumberGetRsp.openapiRequiredFields) {
      ...
      UserPhoneNumberGetRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPhoneNumberGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPhoneNumberGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPhoneNumberGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPhoneNumberGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPhoneNumberGetRsp>() {
           @Override
           public void write(JsonWriter out, UserPhoneNumberGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPhoneNumberGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserPhoneNumberGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserPhoneNumberGetRsp
  * @throws IOException if the JSON string is invalid with respect to UserPhoneNumberGetRsp
  */
  public static UserPhoneNumberGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPhoneNumberGetRsp.class);
  }

 /**
  * Convert an instance of UserPhoneNumberGetRsp to an JSON string
  *
  * @return JSON string
  */
