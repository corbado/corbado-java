...
public class ConnectTokenDataPasskeyDelete {
  ...
  public ConnectTokenDataPasskeyDelete identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectTokenDataPasskeyDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ConnectTokenDataPasskeyDelete is not found in the empty JSON string", ConnectTokenDataPasskeyDelete.openapiRequiredFields.toString()));
        }
      }
