...
public class IOSAppConfigItem {
  ...
  public IOSAppConfigItem() {
  }

  public IOSAppConfigItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public IOSAppConfigItem projectID(String projectID) {
  ...
  **/
  ...
  public IOSAppConfigItem appIDPrefix(String appIDPrefix) {
  ...
  **/
  ...
  public IOSAppConfigItem bundleID(String bundleID) {
  ...
  **/
  ...
  public IOSAppConfigItem created(String created) {
  ...
  **/
  ...
  public IOSAppConfigItem updated(String updated) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IOSAppConfigItem iOSAppConfigItem = (IOSAppConfigItem) o;
    return Objects.equals(this.id, iOSAppConfigItem.id) &&
        Objects.equals(this.projectID, iOSAppConfigItem.projectID) &&
        Objects.equals(this.appIDPrefix, iOSAppConfigItem.appIDPrefix) &&
        Objects.equals(this.bundleID, iOSAppConfigItem.bundleID) &&
        Objects.equals(this.created, iOSAppConfigItem.created) &&
        Objects.equals(this.updated, iOSAppConfigItem.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, projectID, appIDPrefix, bundleID, created, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IOSAppConfigItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IOSAppConfigItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSAppConfigItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSAppConfigItem is not found in the empty JSON string", IOSAppConfigItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSAppConfigItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSAppConfigItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IOSAppConfigItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSAppConfigItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSAppConfigItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSAppConfigItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSAppConfigItem.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSAppConfigItem>() {
           @Override
           public void write(JsonWriter out, IOSAppConfigItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSAppConfigItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IOSAppConfigItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IOSAppConfigItem
  * @throws IOException if the JSON string is invalid with respect to IOSAppConfigItem
  */
  public static IOSAppConfigItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSAppConfigItem.class);
  }

 /**
  * Convert an instance of IOSAppConfigItem to an JSON string
  *
  * @return JSON string
  */
