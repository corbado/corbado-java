...
import com.corbado.generated.model.TrackingOSStatsListRspAllOfData;
...
public class TrackingOSStatsListRsp {
  ...
  private TrackingOSStatsListRspAllOfData data;

  public TrackingOSStatsListRsp() {
  }

  public TrackingOSStatsListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public TrackingOSStatsListRsp message(String message) {
  ...
  **/
  ...
  public TrackingOSStatsListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public TrackingOSStatsListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public TrackingOSStatsListRsp data(TrackingOSStatsListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public TrackingOSStatsListRspAllOfData getData() {
    return data;
  }

  public void setData(TrackingOSStatsListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrackingOSStatsListRsp trackingOSStatsListRsp = (TrackingOSStatsListRsp) o;
    return Objects.equals(this.httpStatusCode, trackingOSStatsListRsp.httpStatusCode) &&
        Objects.equals(this.message, trackingOSStatsListRsp.message) &&
        Objects.equals(this.requestData, trackingOSStatsListRsp.requestData) &&
        Objects.equals(this.runtime, trackingOSStatsListRsp.runtime) &&
        Objects.equals(this.data, trackingOSStatsListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrackingOSStatsListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingOSStatsListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingOSStatsListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingOSStatsListRsp is not found in the empty JSON string", TrackingOSStatsListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingOSStatsListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingOSStatsListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingOSStatsListRsp.openapiRequiredFields) {
      ...
      TrackingOSStatsListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingOSStatsListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingOSStatsListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingOSStatsListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingOSStatsListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingOSStatsListRsp>() {
           @Override
           public void write(JsonWriter out, TrackingOSStatsListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingOSStatsListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingOSStatsListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingOSStatsListRsp
  * @throws IOException if the JSON string is invalid with respect to TrackingOSStatsListRsp
  */
  public static TrackingOSStatsListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingOSStatsListRsp.class);
  }

 /**
  * Convert an instance of TrackingOSStatsListRsp to an JSON string
  *
  * @return JSON string
  */
