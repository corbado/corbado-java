...
public class WebAuthnCredentialReq {
  /**
   * Gets or Sets status
   */
  ...
  public WebAuthnCredentialReq() {
  }

  public WebAuthnCredentialReq status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public WebAuthnCredentialReq requestID(String requestID) {
  ...
  **/
  ...
  public WebAuthnCredentialReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnCredentialReq webAuthnCredentialReq = (WebAuthnCredentialReq) o;
    return Objects.equals(this.status, webAuthnCredentialReq.status) &&
        Objects.equals(this.requestID, webAuthnCredentialReq.requestID) &&
        Objects.equals(this.clientInfo, webAuthnCredentialReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnCredentialReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnCredentialReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnCredentialReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnCredentialReq is not found in the empty JSON string", WebAuthnCredentialReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnCredentialReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnCredentialReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnCredentialReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnCredentialReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnCredentialReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnCredentialReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnCredentialReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnCredentialReq>() {
           @Override
           public void write(JsonWriter out, WebAuthnCredentialReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnCredentialReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnCredentialReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnCredentialReq
  * @throws IOException if the JSON string is invalid with respect to WebAuthnCredentialReq
  */
  public static WebAuthnCredentialReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnCredentialReq.class);
  }

 /**
  * Convert an instance of WebAuthnCredentialReq to an JSON string
  *
  * @return JSON string
  */
