...
public class WebAuthnCredentialRsp {
  ...
  public WebAuthnCredentialRsp() {
  }

  public WebAuthnCredentialRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebAuthnCredentialRsp message(String message) {
  ...
  **/
  ...
  public WebAuthnCredentialRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebAuthnCredentialRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebAuthnCredentialRsp status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnCredentialRsp webAuthnCredentialRsp = (WebAuthnCredentialRsp) o;
    return Objects.equals(this.httpStatusCode, webAuthnCredentialRsp.httpStatusCode) &&
        Objects.equals(this.message, webAuthnCredentialRsp.message) &&
        Objects.equals(this.requestData, webAuthnCredentialRsp.requestData) &&
        Objects.equals(this.runtime, webAuthnCredentialRsp.runtime) &&
        Objects.equals(this.status, webAuthnCredentialRsp.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnCredentialRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnCredentialRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnCredentialRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnCredentialRsp is not found in the empty JSON string", WebAuthnCredentialRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnCredentialRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnCredentialRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnCredentialRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnCredentialRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnCredentialRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnCredentialRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnCredentialRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnCredentialRsp>() {
           @Override
           public void write(JsonWriter out, WebAuthnCredentialRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnCredentialRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnCredentialRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnCredentialRsp
  * @throws IOException if the JSON string is invalid with respect to WebAuthnCredentialRsp
  */
  public static WebAuthnCredentialRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnCredentialRsp.class);
  }

 /**
  * Convert an instance of WebAuthnCredentialRsp to an JSON string
  *
  * @return JSON string
  */
