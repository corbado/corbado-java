...
public class UserEmailCreateRspAllOfData {
  public static final String SERIALIZED_NAME_EMAIL_I_D = "emailID";
  @SerializedName(SERIALIZED_NAME_EMAIL_I_D)
  private String emailID;

  public UserEmailCreateRspAllOfData() {
  }

  public UserEmailCreateRspAllOfData emailID(String emailID) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserEmailCreateRspAllOfData userEmailCreateRspAllOfData = (UserEmailCreateRspAllOfData) o;
    return Objects.equals(this.emailID, userEmailCreateRspAllOfData.emailID);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserEmailCreateRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserEmailCreateRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEmailCreateRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserEmailCreateRspAllOfData is not found in the empty JSON string", UserEmailCreateRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEmailCreateRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserEmailCreateRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserEmailCreateRspAllOfData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserEmailCreateRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserEmailCreateRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserEmailCreateRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserEmailCreateRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<UserEmailCreateRspAllOfData>() {
           @Override
           public void write(JsonWriter out, UserEmailCreateRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserEmailCreateRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserEmailCreateRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserEmailCreateRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to UserEmailCreateRspAllOfData
  */
  public static UserEmailCreateRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserEmailCreateRspAllOfData.class);
  }

 /**
  * Convert an instance of UserEmailCreateRspAllOfData to an JSON string
  *
  * @return JSON string
  */
