...
public class EmailLinksDeleteReq {
  ...
  public EmailLinksDeleteReq() {
  }

  public EmailLinksDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public EmailLinksDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailLinksDeleteReq emailLinksDeleteReq = (EmailLinksDeleteReq) o;
    return Objects.equals(this.requestID, emailLinksDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, emailLinksDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLinksDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLinksDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLinksDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLinksDeleteReq is not found in the empty JSON string", EmailLinksDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLinksDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLinksDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLinksDeleteReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLinksDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLinksDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLinksDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLinksDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLinksDeleteReq>() {
           @Override
           public void write(JsonWriter out, EmailLinksDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLinksDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLinksDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLinksDeleteReq
  * @throws IOException if the JSON string is invalid with respect to EmailLinksDeleteReq
  */
  public static EmailLinksDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLinksDeleteReq.class);
  }

 /**
  * Convert an instance of EmailLinksDeleteReq to an JSON string
  *
  * @return JSON string
  */
