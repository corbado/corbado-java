...
public class UserUpdateReq {
  ...
  public UserUpdateReq name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public UserUpdateReq requestID(String requestID) {
  ...
  **/
  ...
  public UserUpdateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, userUpdateReq.name) &&
        Objects.equals(this.fullName, userUpdateReq.fullName) &&
        Objects.equals(this.status, userUpdateReq.status) &&
        Objects.equals(this.requestID, userUpdateReq.requestID) &&
        Objects.equals(this.clientInfo, userUpdateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, fullName, status, requestID, clientInfo);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserUpdateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserUpdateReq is not found in the empty JSON string", UserUpdateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserUpdateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserUpdateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
