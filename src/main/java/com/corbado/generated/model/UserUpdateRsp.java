...
public class UserUpdateRsp {
  ...
  public UserUpdateRsp() {
  }

  public UserUpdateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserUpdateRsp message(String message) {
  ...
  **/
  ...
  public UserUpdateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserUpdateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserUpdateRsp data(User data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserUpdateRsp userUpdateRsp = (UserUpdateRsp) o;
    return Objects.equals(this.httpStatusCode, userUpdateRsp.httpStatusCode) &&
        Objects.equals(this.message, userUpdateRsp.message) &&
        Objects.equals(this.requestData, userUpdateRsp.requestData) &&
        Objects.equals(this.runtime, userUpdateRsp.runtime) &&
        Objects.equals(this.data, userUpdateRsp.data);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserUpdateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserUpdateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserUpdateRsp is not found in the empty JSON string", UserUpdateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserUpdateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserUpdateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserUpdateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserUpdateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserUpdateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserUpdateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserUpdateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserUpdateRsp>() {
           @Override
           public void write(JsonWriter out, UserUpdateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserUpdateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserUpdateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserUpdateRsp
  * @throws IOException if the JSON string is invalid with respect to UserUpdateRsp
  */
  public static UserUpdateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserUpdateRsp.class);
  }

 /**
  * Convert an instance of UserUpdateRsp to an JSON string
  *
  * @return JSON string
  */
