...
public class SmsCodeValidateReq {
  ...
  public SmsCodeValidateReq() {
  }

  public SmsCodeValidateReq smsCode(String smsCode) {
  ...
  **/
  ...
  public SmsCodeValidateReq createLoginToken(Boolean createLoginToken) {
  ...
  **/
  ...
  public SmsCodeValidateReq requestID(String requestID) {
  ...
  **/
  ...
  public SmsCodeValidateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SmsCodeValidateReq smsCodeValidateReq = (SmsCodeValidateReq) o;
    return Objects.equals(this.smsCode, smsCodeValidateReq.smsCode) &&
        Objects.equals(this.createLoginToken, smsCodeValidateReq.createLoginToken) &&
        Objects.equals(this.requestID, smsCodeValidateReq.requestID) &&
        Objects.equals(this.clientInfo, smsCodeValidateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(smsCode, createLoginToken, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmsCodeValidateReq {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("smsCode");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to SmsCodeValidateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsCodeValidateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsCodeValidateReq is not found in the empty JSON string", SmsCodeValidateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsCodeValidateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsCodeValidateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsCodeValidateReq.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("smsCode").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsCodeValidateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsCodeValidateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsCodeValidateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsCodeValidateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsCodeValidateReq>() {
           @Override
           public void write(JsonWriter out, SmsCodeValidateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsCodeValidateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsCodeValidateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsCodeValidateReq
  * @throws IOException if the JSON string is invalid with respect to SmsCodeValidateReq
  */
  public static SmsCodeValidateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsCodeValidateReq.class);
  }

 /**
  * Convert an instance of SmsCodeValidateReq to an JSON string
  *
  * @return JSON string
  */
