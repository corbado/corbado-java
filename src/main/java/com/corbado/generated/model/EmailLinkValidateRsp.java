...
public class EmailLinkValidateRsp {
  ...
  public EmailLinkValidateRsp() {
  }

  public EmailLinkValidateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailLinkValidateRsp message(String message) {
  ...
  **/
  ...
  public EmailLinkValidateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailLinkValidateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailLinkValidateRsp additionalPayload(String additionalPayload) {
  ...
  **/
  ...
  public EmailLinkValidateRsp userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public EmailLinkValidateRsp userFullName(String userFullName) {
  ...
  **/
  ...
  public EmailLinkValidateRsp userEmail(String userEmail) {
  ...
  **/
  ...
  public EmailLinkValidateRsp loginToken(String loginToken) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailLinkValidateRsp emailLinkValidateRsp = (EmailLinkValidateRsp) o;
    return Objects.equals(this.httpStatusCode, emailLinkValidateRsp.httpStatusCode) &&
        Objects.equals(this.message, emailLinkValidateRsp.message) &&
        Objects.equals(this.requestData, emailLinkValidateRsp.requestData) &&
        Objects.equals(this.runtime, emailLinkValidateRsp.runtime) &&
        Objects.equals(this.additionalPayload, emailLinkValidateRsp.additionalPayload) &&
        Objects.equals(this.userID, emailLinkValidateRsp.userID) &&
        Objects.equals(this.userFullName, emailLinkValidateRsp.userFullName) &&
        Objects.equals(this.userEmail, emailLinkValidateRsp.userEmail) &&
        Objects.equals(this.loginToken, emailLinkValidateRsp.loginToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLinkValidateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLinkValidateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLinkValidateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLinkValidateRsp is not found in the empty JSON string", EmailLinkValidateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLinkValidateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLinkValidateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLinkValidateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLinkValidateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLinkValidateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLinkValidateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLinkValidateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLinkValidateRsp>() {
           @Override
           public void write(JsonWriter out, EmailLinkValidateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLinkValidateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLinkValidateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLinkValidateRsp
  * @throws IOException if the JSON string is invalid with respect to EmailLinkValidateRsp
  */
  public static EmailLinkValidateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLinkValidateRsp.class);
  }

 /**
  * Convert an instance of EmailLinkValidateRsp to an JSON string
  *
  * @return JSON string
  */
