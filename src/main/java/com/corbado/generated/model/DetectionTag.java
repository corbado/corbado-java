...
public class DetectionTag {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("category", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("category", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectionTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DetectionTag is not found in the empty JSON string", DetectionTag.openapiRequiredFields.toString()));
        }
      }
