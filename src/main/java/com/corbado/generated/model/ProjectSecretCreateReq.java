...
public class ProjectSecretCreateReq {
  ...
  public ProjectSecretCreateReq() {
  }

  public ProjectSecretCreateReq requestID(String requestID) {
  ...
  **/
  ...
  public ProjectSecretCreateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectSecretCreateReq projectSecretCreateReq = (ProjectSecretCreateReq) o;
    return Objects.equals(this.requestID, projectSecretCreateReq.requestID) &&
        Objects.equals(this.clientInfo, projectSecretCreateReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectSecretCreateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectSecretCreateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSecretCreateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSecretCreateReq is not found in the empty JSON string", ProjectSecretCreateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSecretCreateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSecretCreateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSecretCreateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSecretCreateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSecretCreateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSecretCreateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSecretCreateReq>() {
           @Override
           public void write(JsonWriter out, ProjectSecretCreateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSecretCreateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectSecretCreateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectSecretCreateReq
  * @throws IOException if the JSON string is invalid with respect to ProjectSecretCreateReq
  */
  public static ProjectSecretCreateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSecretCreateReq.class);
  }

 /**
  * Convert an instance of ProjectSecretCreateReq to an JSON string
  *
  * @return JSON string
  */
