...
public class SmsTemplateDeleteReq {
  ...
  public SmsTemplateDeleteReq() {
  }

  public SmsTemplateDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public SmsTemplateDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SmsTemplateDeleteReq smsTemplateDeleteReq = (SmsTemplateDeleteReq) o;
    return Objects.equals(this.requestID, smsTemplateDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, smsTemplateDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmsTemplateDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SmsTemplateDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsTemplateDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsTemplateDeleteReq is not found in the empty JSON string", SmsTemplateDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsTemplateDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsTemplateDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsTemplateDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsTemplateDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsTemplateDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsTemplateDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsTemplateDeleteReq>() {
           @Override
           public void write(JsonWriter out, SmsTemplateDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsTemplateDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsTemplateDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsTemplateDeleteReq
  * @throws IOException if the JSON string is invalid with respect to SmsTemplateDeleteReq
  */
  public static SmsTemplateDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsTemplateDeleteReq.class);
  }

 /**
  * Convert an instance of SmsTemplateDeleteReq to an JSON string
  *
  * @return JSON string
  */
