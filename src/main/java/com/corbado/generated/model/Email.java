...
public class Email {
  ...
  **/
  ...
  public Email created(String created) {
  ...
  **/
  ...
  public Email updated(String updated) {
  ...
  **/
  ...
  public Email deleted(String deleted) {
  ...
  **/
  ...
  public Email status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ID, email.ID) &&
        ...
        Objects.equals(this.updated, email.updated) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ID, email, created, updated, deleted, status);
  }
