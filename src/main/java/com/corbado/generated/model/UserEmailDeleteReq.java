...
public class UserEmailDeleteReq {
  ...
  public UserEmailDeleteReq() {
  }

  public UserEmailDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public UserEmailDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserEmailDeleteReq userEmailDeleteReq = (UserEmailDeleteReq) o;
    return Objects.equals(this.requestID, userEmailDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, userEmailDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserEmailDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserEmailDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEmailDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserEmailDeleteReq is not found in the empty JSON string", UserEmailDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEmailDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserEmailDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserEmailDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserEmailDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserEmailDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserEmailDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<UserEmailDeleteReq>() {
           @Override
           public void write(JsonWriter out, UserEmailDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserEmailDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserEmailDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserEmailDeleteReq
  * @throws IOException if the JSON string is invalid with respect to UserEmailDeleteReq
  */
  public static UserEmailDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserEmailDeleteReq.class);
  }

 /**
  * Convert an instance of UserEmailDeleteReq to an JSON string
  *
  * @return JSON string
  */
