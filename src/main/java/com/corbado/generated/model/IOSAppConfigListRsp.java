...
import com.corbado.generated.model.IOSAppConfigItem;
...
public class IOSAppConfigListRsp {
  ...
  private List<IOSAppConfigItem> rows = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public IOSAppConfigListRsp() {
  }

  public IOSAppConfigListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public IOSAppConfigListRsp message(String message) {
  ...
  **/
  ...
  public IOSAppConfigListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public IOSAppConfigListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public IOSAppConfigListRsp rows(List<IOSAppConfigItem> rows) {
    this.rows = rows;
    return this;
  }

  public IOSAppConfigListRsp addRowsItem(IOSAppConfigItem rowsItem) {
    if (this.rows == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<IOSAppConfigItem> getRows() {
    return rows;
  }

  public void setRows(List<IOSAppConfigItem> rows) {
    this.rows = rows;
  }


  public IOSAppConfigListRsp paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IOSAppConfigListRsp iOSAppConfigListRsp = (IOSAppConfigListRsp) o;
    return Objects.equals(this.httpStatusCode, iOSAppConfigListRsp.httpStatusCode) &&
        Objects.equals(this.message, iOSAppConfigListRsp.message) &&
        Objects.equals(this.requestData, iOSAppConfigListRsp.requestData) &&
        Objects.equals(this.runtime, iOSAppConfigListRsp.runtime) &&
        Objects.equals(this.rows, iOSAppConfigListRsp.rows) &&
        Objects.equals(this.paging, iOSAppConfigListRsp.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class IOSAppConfigListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IOSAppConfigListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSAppConfigListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSAppConfigListRsp is not found in the empty JSON string", IOSAppConfigListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSAppConfigListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSAppConfigListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IOSAppConfigListRsp.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrows.size(); i++) {
        IOSAppConfigItem.validateJsonElement(jsonArrayrows.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSAppConfigListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSAppConfigListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSAppConfigListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSAppConfigListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSAppConfigListRsp>() {
           @Override
           public void write(JsonWriter out, IOSAppConfigListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSAppConfigListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IOSAppConfigListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IOSAppConfigListRsp
  * @throws IOException if the JSON string is invalid with respect to IOSAppConfigListRsp
  */
  public static IOSAppConfigListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSAppConfigListRsp.class);
  }

 /**
  * Convert an instance of IOSAppConfigListRsp to an JSON string
  *
  * @return JSON string
  */
