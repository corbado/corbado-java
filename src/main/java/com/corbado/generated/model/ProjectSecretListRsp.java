...
import com.corbado.generated.model.ProjectSecretItem;
...
public class ProjectSecretListRsp {
  ...
  private List<ProjectSecretItem> rows = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public ProjectSecretListRsp() {
  }

  public ProjectSecretListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public ProjectSecretListRsp message(String message) {
  ...
  **/
  ...
  public ProjectSecretListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public ProjectSecretListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public ProjectSecretListRsp rows(List<ProjectSecretItem> rows) {
    this.rows = rows;
    return this;
  }

  public ProjectSecretListRsp addRowsItem(ProjectSecretItem rowsItem) {
    if (this.rows == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<ProjectSecretItem> getRows() {
    return rows;
  }

  public void setRows(List<ProjectSecretItem> rows) {
    this.rows = rows;
  }


  public ProjectSecretListRsp paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectSecretListRsp projectSecretListRsp = (ProjectSecretListRsp) o;
    return Objects.equals(this.httpStatusCode, projectSecretListRsp.httpStatusCode) &&
        Objects.equals(this.message, projectSecretListRsp.message) &&
        Objects.equals(this.requestData, projectSecretListRsp.requestData) &&
        Objects.equals(this.runtime, projectSecretListRsp.runtime) &&
        Objects.equals(this.rows, projectSecretListRsp.rows) &&
        Objects.equals(this.paging, projectSecretListRsp.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectSecretListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectSecretListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSecretListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSecretListRsp is not found in the empty JSON string", ProjectSecretListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSecretListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSecretListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectSecretListRsp.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrows.size(); i++) {
        ProjectSecretItem.validateJsonElement(jsonArrayrows.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSecretListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSecretListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSecretListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSecretListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSecretListRsp>() {
           @Override
           public void write(JsonWriter out, ProjectSecretListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSecretListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectSecretListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectSecretListRsp
  * @throws IOException if the JSON string is invalid with respect to ProjectSecretListRsp
  */
  public static ProjectSecretListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSecretListRsp.class);
  }

 /**
  * Convert an instance of ProjectSecretListRsp to an JSON string
  *
  * @return JSON string
  */
