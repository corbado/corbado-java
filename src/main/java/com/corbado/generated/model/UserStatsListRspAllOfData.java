...
import com.corbado.generated.model.UserStats;
...
public class UserStatsListRspAllOfData {
  ...
  public UserStatsListRspAllOfData() {
  }

  public UserStatsListRspAllOfData stats(List<UserStats> stats) {
    this.stats = stats;
    return this;
  }

  public UserStatsListRspAllOfData addStatsItem(UserStats statsItem) {
    if (this.stats == null) {
  ...
  **/
  ...
  public UserStatsListRspAllOfData paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserStatsListRspAllOfData userStatsListRspAllOfData = (UserStatsListRspAllOfData) o;
    return Objects.equals(this.stats, userStatsListRspAllOfData.stats) &&
        Objects.equals(this.paging, userStatsListRspAllOfData.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserStatsListRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserStatsListRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserStatsListRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserStatsListRspAllOfData is not found in the empty JSON string", UserStatsListRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserStatsListRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserStatsListRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserStatsListRspAllOfData.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraystats.size(); i++) {
        UserStats.validateJsonElement(jsonArraystats.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserStatsListRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserStatsListRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserStatsListRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserStatsListRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<UserStatsListRspAllOfData>() {
           @Override
           public void write(JsonWriter out, UserStatsListRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserStatsListRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserStatsListRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserStatsListRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to UserStatsListRspAllOfData
  */
  public static UserStatsListRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserStatsListRspAllOfData.class);
  }

 /**
  * Convert an instance of UserStatsListRspAllOfData to an JSON string
  *
  * @return JSON string
  */
