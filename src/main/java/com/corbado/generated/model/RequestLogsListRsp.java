...
import com.corbado.generated.model.RequestLogsListRspAllOfData;
...
public class RequestLogsListRsp {
  ...
  private RequestLogsListRspAllOfData data;

  public RequestLogsListRsp() {
  }

  public RequestLogsListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public RequestLogsListRsp message(String message) {
  ...
  **/
  ...
  public RequestLogsListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public RequestLogsListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public RequestLogsListRsp data(RequestLogsListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public RequestLogsListRspAllOfData getData() {
    return data;
  }

  public void setData(RequestLogsListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    RequestLogsListRsp requestLogsListRsp = (RequestLogsListRsp) o;
    return Objects.equals(this.httpStatusCode, requestLogsListRsp.httpStatusCode) &&
        Objects.equals(this.message, requestLogsListRsp.message) &&
        Objects.equals(this.requestData, requestLogsListRsp.requestData) &&
        Objects.equals(this.runtime, requestLogsListRsp.runtime) &&
        Objects.equals(this.data, requestLogsListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestLogsListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to RequestLogsListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestLogsListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestLogsListRsp is not found in the empty JSON string", RequestLogsListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestLogsListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestLogsListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestLogsListRsp.openapiRequiredFields) {
      ...
      RequestLogsListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestLogsListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestLogsListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestLogsListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestLogsListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestLogsListRsp>() {
           @Override
           public void write(JsonWriter out, RequestLogsListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestLogsListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RequestLogsListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RequestLogsListRsp
  * @throws IOException if the JSON string is invalid with respect to RequestLogsListRsp
  */
  public static RequestLogsListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestLogsListRsp.class);
  }

 /**
  * Convert an instance of RequestLogsListRsp to an JSON string
  *
  * @return JSON string
  */
