...
public class EmailCodeSendReq {
  ...
  public EmailCodeSendReq() {
  }

  public EmailCodeSendReq email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public EmailCodeSendReq create(Boolean create) {
    this.create = create;
    return this;
  }
  ...
  **/
  ...
  public EmailCodeSendReq tokenLifetime(String tokenLifetime) {
  ...
  **/
  ...
  public EmailCodeSendReq userFullName(String userFullName) {
  ...
  **/
  ...
  public EmailCodeSendReq templateName(String templateName) {
  ...
  **/
  ...
  public EmailCodeSendReq additionalPayload(String additionalPayload) {
  ...
  **/
  ...
  public EmailCodeSendReq requestID(String requestID) {
  ...
  **/
  ...
  public EmailCodeSendReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailCodeSendReq emailCodeSendReq = (EmailCodeSendReq) o;
    return Objects.equals(this.email, emailCodeSendReq.email) &&
        Objects.equals(this.create, emailCodeSendReq.create) &&
        Objects.equals(this.tokenLifetime, emailCodeSendReq.tokenLifetime) &&
        Objects.equals(this.userFullName, emailCodeSendReq.userFullName) &&
        Objects.equals(this.templateName, emailCodeSendReq.templateName) &&
        Objects.equals(this.additionalPayload, emailCodeSendReq.additionalPayload) &&
        Objects.equals(this.requestID, emailCodeSendReq.requestID) &&
        Objects.equals(this.clientInfo, emailCodeSendReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, create, tokenLifetime, userFullName, templateName, additionalPayload, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailCodeSendReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailCodeSendReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailCodeSendReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCodeSendReq is not found in the empty JSON string", EmailCodeSendReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailCodeSendReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCodeSendReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCodeSendReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCodeSendReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCodeSendReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCodeSendReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCodeSendReq.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCodeSendReq>() {
           @Override
           public void write(JsonWriter out, EmailCodeSendReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCodeSendReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCodeSendReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCodeSendReq
  * @throws IOException if the JSON string is invalid with respect to EmailCodeSendReq
  */
  public static EmailCodeSendReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCodeSendReq.class);
  }

 /**
  * Convert an instance of EmailCodeSendReq to an JSON string
  *
  * @return JSON string
  */
