...
public class ParsedDeviceInfo {
   ...
   * @return the ParsedDeviceInfo instance itself
   */
  public ParsedDeviceInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.browserName, parsedDeviceInfo.browserName) &&
        ...
        Objects.equals(this.additionalProperties, parsedDeviceInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(browserName, browserVersion, osName, osVersion, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParsedDeviceInfo>() {
           ...
           public ParsedDeviceInfo read(JsonReader in) throws IOException {
             ...
             ParsedDeviceInfo instance = thisAdapter.fromJsonTree(jsonObj);
