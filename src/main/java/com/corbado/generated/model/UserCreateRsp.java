...
import com.corbado.generated.model.UserCreateRspAllOfData;
...
public class UserCreateRsp {
  ...
  private UserCreateRspAllOfData data;

  public UserCreateRsp() {
  }

  public UserCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserCreateRsp message(String message) {
  ...
  **/
  ...
  public UserCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserCreateRsp data(UserCreateRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserCreateRspAllOfData getData() {
    return data;
  }

  public void setData(UserCreateRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserCreateRsp userCreateRsp = (UserCreateRsp) o;
    return Objects.equals(this.httpStatusCode, userCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, userCreateRsp.message) &&
        Objects.equals(this.requestData, userCreateRsp.requestData) &&
        Objects.equals(this.runtime, userCreateRsp.runtime) &&
        Objects.equals(this.data, userCreateRsp.data);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserCreateRsp is not found in the empty JSON string", UserCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserCreateRsp.openapiRequiredFields) {
      ...
      UserCreateRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserCreateRsp>() {
           @Override
           public void write(JsonWriter out, UserCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserCreateRsp
  * @throws IOException if the JSON string is invalid with respect to UserCreateRsp
  */
  public static UserCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserCreateRsp.class);
  }

 /**
  * Convert an instance of UserCreateRsp to an JSON string
  *
  * @return JSON string
  */
