...
import com.corbado.generated.model.SmsTemplateCreateRspAllOfData;
...
public class SmsTemplateCreateRsp {
  ...
  private SmsTemplateCreateRspAllOfData data;

  public SmsTemplateCreateRsp() {
  }

  public SmsTemplateCreateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public SmsTemplateCreateRsp message(String message) {
  ...
  **/
  ...
  public SmsTemplateCreateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public SmsTemplateCreateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public SmsTemplateCreateRsp data(SmsTemplateCreateRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public SmsTemplateCreateRspAllOfData getData() {
    return data;
  }

  public void setData(SmsTemplateCreateRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SmsTemplateCreateRsp smsTemplateCreateRsp = (SmsTemplateCreateRsp) o;
    return Objects.equals(this.httpStatusCode, smsTemplateCreateRsp.httpStatusCode) &&
        Objects.equals(this.message, smsTemplateCreateRsp.message) &&
        Objects.equals(this.requestData, smsTemplateCreateRsp.requestData) &&
        Objects.equals(this.runtime, smsTemplateCreateRsp.runtime) &&
        Objects.equals(this.data, smsTemplateCreateRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmsTemplateCreateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SmsTemplateCreateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsTemplateCreateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsTemplateCreateRsp is not found in the empty JSON string", SmsTemplateCreateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsTemplateCreateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsTemplateCreateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsTemplateCreateRsp.openapiRequiredFields) {
      ...
      SmsTemplateCreateRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsTemplateCreateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsTemplateCreateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsTemplateCreateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsTemplateCreateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsTemplateCreateRsp>() {
           @Override
           public void write(JsonWriter out, SmsTemplateCreateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsTemplateCreateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsTemplateCreateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsTemplateCreateRsp
  * @throws IOException if the JSON string is invalid with respect to SmsTemplateCreateRsp
  */
  public static SmsTemplateCreateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsTemplateCreateRsp.class);
  }

 /**
  * Convert an instance of SmsTemplateCreateRsp to an JSON string
  *
  * @return JSON string
  */
