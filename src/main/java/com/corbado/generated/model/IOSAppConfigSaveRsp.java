...
public class IOSAppConfigSaveRsp {
  ...
  public IOSAppConfigSaveRsp() {
  }

  public IOSAppConfigSaveRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp message(String message) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp runtime(Float runtime) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public IOSAppConfigSaveRsp projectID(String projectID) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp appIDPrefix(String appIDPrefix) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp bundleID(String bundleID) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp created(String created) {
  ...
  **/
  ...
  public IOSAppConfigSaveRsp updated(String updated) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IOSAppConfigSaveRsp iOSAppConfigSaveRsp = (IOSAppConfigSaveRsp) o;
    return Objects.equals(this.httpStatusCode, iOSAppConfigSaveRsp.httpStatusCode) &&
        Objects.equals(this.message, iOSAppConfigSaveRsp.message) &&
        Objects.equals(this.requestData, iOSAppConfigSaveRsp.requestData) &&
        Objects.equals(this.runtime, iOSAppConfigSaveRsp.runtime) &&
        Objects.equals(this.id, iOSAppConfigSaveRsp.id) &&
        Objects.equals(this.projectID, iOSAppConfigSaveRsp.projectID) &&
        Objects.equals(this.appIDPrefix, iOSAppConfigSaveRsp.appIDPrefix) &&
        Objects.equals(this.bundleID, iOSAppConfigSaveRsp.bundleID) &&
        Objects.equals(this.created, iOSAppConfigSaveRsp.created) &&
        Objects.equals(this.updated, iOSAppConfigSaveRsp.updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class IOSAppConfigSaveRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IOSAppConfigSaveRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSAppConfigSaveRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSAppConfigSaveRsp is not found in the empty JSON string", IOSAppConfigSaveRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSAppConfigSaveRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSAppConfigSaveRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IOSAppConfigSaveRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSAppConfigSaveRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSAppConfigSaveRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSAppConfigSaveRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSAppConfigSaveRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSAppConfigSaveRsp>() {
           @Override
           public void write(JsonWriter out, IOSAppConfigSaveRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSAppConfigSaveRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IOSAppConfigSaveRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IOSAppConfigSaveRsp
  * @throws IOException if the JSON string is invalid with respect to IOSAppConfigSaveRsp
  */
  public static IOSAppConfigSaveRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSAppConfigSaveRsp.class);
  }

 /**
  * Convert an instance of IOSAppConfigSaveRsp to an JSON string
  *
  * @return JSON string
  */
