...
public class PasskeyAppendFinishRsp {
   ...
   * @return the PasskeyAppendFinishRsp instance itself
   */
  public PasskeyAppendFinishRsp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.passkeyData, passkeyAppendFinishRsp.passkeyData)&&
        Objects.equals(this.additionalProperties, passkeyAppendFinishRsp.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(passkeyData, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("passkeyData"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasskeyAppendFinishRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PasskeyAppendFinishRsp is not found in the empty JSON string", PasskeyAppendFinishRsp.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasskeyAppendFinishRsp>() {
           ...
           public PasskeyAppendFinishRsp read(JsonReader in) throws IOException {
             ...
             PasskeyAppendFinishRsp instance = thisAdapter.fromJsonTree(jsonObj);
