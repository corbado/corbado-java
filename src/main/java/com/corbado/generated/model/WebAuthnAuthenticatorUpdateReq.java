...
public class WebAuthnAuthenticatorUpdateReq {
  ...
  public WebAuthnAuthenticatorUpdateReq() {
  }

  public WebAuthnAuthenticatorUpdateReq name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebAuthnAuthenticatorUpdateReq requestID(String requestID) {
  ...
  **/
  ...
  public WebAuthnAuthenticatorUpdateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnAuthenticatorUpdateReq webAuthnAuthenticatorUpdateReq = (WebAuthnAuthenticatorUpdateReq) o;
    return Objects.equals(this.name, webAuthnAuthenticatorUpdateReq.name) &&
        Objects.equals(this.requestID, webAuthnAuthenticatorUpdateReq.requestID) &&
        Objects.equals(this.clientInfo, webAuthnAuthenticatorUpdateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnAuthenticatorUpdateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnAuthenticatorUpdateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnAuthenticatorUpdateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnAuthenticatorUpdateReq is not found in the empty JSON string", WebAuthnAuthenticatorUpdateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnAuthenticatorUpdateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnAuthenticatorUpdateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnAuthenticatorUpdateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnAuthenticatorUpdateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnAuthenticatorUpdateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnAuthenticatorUpdateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnAuthenticatorUpdateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnAuthenticatorUpdateReq>() {
           @Override
           public void write(JsonWriter out, WebAuthnAuthenticatorUpdateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnAuthenticatorUpdateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnAuthenticatorUpdateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnAuthenticatorUpdateReq
  * @throws IOException if the JSON string is invalid with respect to WebAuthnAuthenticatorUpdateReq
  */
  public static WebAuthnAuthenticatorUpdateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnAuthenticatorUpdateReq.class);
  }

 /**
  * Convert an instance of WebAuthnAuthenticatorUpdateReq to an JSON string
  *
  * @return JSON string
  */
