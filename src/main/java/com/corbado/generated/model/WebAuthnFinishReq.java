...
public class WebAuthnFinishReq {
  public static final String SERIALIZED_NAME_PUBLIC_KEY_CREDENTIAL = "publicKeyCredential";
  @SerializedName(SERIALIZED_NAME_PUBLIC_KEY_CREDENTIAL)
  ...
  public WebAuthnFinishReq publicKeyCredential(String publicKeyCredential) {
  ...
  **/
  ...
  public WebAuthnFinishReq requestID(String requestID) {
  ...
  **/
  ...
  public WebAuthnFinishReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnFinishReq webAuthnFinishReq = (WebAuthnFinishReq) o;
    return Objects.equals(this.publicKeyCredential, webAuthnFinishReq.publicKeyCredential) &&
        Objects.equals(this.requestID, webAuthnFinishReq.requestID) &&
        Objects.equals(this.clientInfo, webAuthnFinishReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publicKeyCredential, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnFinishReq {\n");
  ...
  static {
    ...
    openapiFields.add("publicKeyCredential");
    openapiFields.add("requestID");
    openapiFields.add("clientInfo");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("publicKeyCredential");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnFinishReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnFinishReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnFinishReq is not found in the empty JSON string", WebAuthnFinishReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnFinishReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnFinishReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnFinishReq.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("publicKeyCredential").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `publicKeyCredential` to be a primitive type in the JSON string but got `%s`", jsonObj.get("publicKeyCredential").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnFinishReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnFinishReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnFinishReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnFinishReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnFinishReq>() {
           @Override
           public void write(JsonWriter out, WebAuthnFinishReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnFinishReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnFinishReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnFinishReq
  * @throws IOException if the JSON string is invalid with respect to WebAuthnFinishReq
  */
  public static WebAuthnFinishReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnFinishReq.class);
  }

 /**
  * Convert an instance of WebAuthnFinishReq to an JSON string
  *
  * @return JSON string
  */
