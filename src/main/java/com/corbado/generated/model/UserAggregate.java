...
public class UserAggregate {
   ...
   * @return the UserAggregate instance itself
   */
  public UserAggregate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userID, userAggregate.userID) &&
        ...
        Objects.equals(this.additionalProperties, userAggregate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userID, fullName, status, explicitWebauthnID, emailIdentifiers, phoneNumberIdentifiers, usernameIdentifiers, socialAccounts, created, createdMS, updated, updatedMs, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserAggregate>() {
           ...
           public UserAggregate read(JsonReader in) throws IOException {
             ...
             UserAggregate instance = thisAdapter.fromJsonTree(jsonObj);
