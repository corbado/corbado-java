...
public class SessionTokenCreateReq {
  ...
  public SessionTokenCreateReq() {
  }

  public SessionTokenCreateReq userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public SessionTokenCreateReq userData(String userData) {
  ...
  **/
  ...
  public SessionTokenCreateReq requestID(String requestID) {
  ...
  **/
  ...
  public SessionTokenCreateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SessionTokenCreateReq sessionTokenCreateReq = (SessionTokenCreateReq) o;
    return Objects.equals(this.userID, sessionTokenCreateReq.userID) &&
        Objects.equals(this.userData, sessionTokenCreateReq.userData) &&
        Objects.equals(this.requestID, sessionTokenCreateReq.requestID) &&
        Objects.equals(this.clientInfo, sessionTokenCreateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userID, userData, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SessionTokenCreateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SessionTokenCreateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionTokenCreateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionTokenCreateReq is not found in the empty JSON string", SessionTokenCreateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionTokenCreateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionTokenCreateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SessionTokenCreateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionTokenCreateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionTokenCreateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionTokenCreateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionTokenCreateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionTokenCreateReq>() {
           @Override
           public void write(JsonWriter out, SessionTokenCreateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionTokenCreateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SessionTokenCreateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionTokenCreateReq
  * @throws IOException if the JSON string is invalid with respect to SessionTokenCreateReq
  */
  public static SessionTokenCreateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionTokenCreateReq.class);
  }

 /**
  * Convert an instance of SessionTokenCreateReq to an JSON string
  *
  * @return JSON string
  */
