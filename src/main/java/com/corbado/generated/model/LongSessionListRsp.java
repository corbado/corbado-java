...
import com.corbado.generated.model.LongSessionListRspAllOfData;
...
public class LongSessionListRsp {
  ...
  private LongSessionListRspAllOfData data;

  public LongSessionListRsp() {
  }

  public LongSessionListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public LongSessionListRsp message(String message) {
  ...
  **/
  ...
  public LongSessionListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public LongSessionListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public LongSessionListRsp data(LongSessionListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public LongSessionListRspAllOfData getData() {
    return data;
  }

  public void setData(LongSessionListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    LongSessionListRsp longSessionListRsp = (LongSessionListRsp) o;
    return Objects.equals(this.httpStatusCode, longSessionListRsp.httpStatusCode) &&
        Objects.equals(this.message, longSessionListRsp.message) &&
        Objects.equals(this.requestData, longSessionListRsp.requestData) &&
        Objects.equals(this.runtime, longSessionListRsp.runtime) &&
        Objects.equals(this.data, longSessionListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class LongSessionListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LongSessionListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongSessionListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongSessionListRsp is not found in the empty JSON string", LongSessionListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongSessionListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongSessionListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LongSessionListRsp.openapiRequiredFields) {
      ...
      LongSessionListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongSessionListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongSessionListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongSessionListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongSessionListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<LongSessionListRsp>() {
           @Override
           public void write(JsonWriter out, LongSessionListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongSessionListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LongSessionListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LongSessionListRsp
  * @throws IOException if the JSON string is invalid with respect to LongSessionListRsp
  */
  public static LongSessionListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongSessionListRsp.class);
  }

 /**
  * Convert an instance of LongSessionListRsp to an JSON string
  *
  * @return JSON string
  */
