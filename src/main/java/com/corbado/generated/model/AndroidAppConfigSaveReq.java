...
public class AndroidAppConfigSaveReq {
  ...
  public AndroidAppConfigSaveReq() {
  }

  public AndroidAppConfigSaveReq packageName(String packageName) {
  ...
  **/
  ...
  public AndroidAppConfigSaveReq fingerprint(String fingerprint) {
  ...
  **/
  ...
  public AndroidAppConfigSaveReq requestID(String requestID) {
  ...
  **/
  ...
  public AndroidAppConfigSaveReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AndroidAppConfigSaveReq androidAppConfigSaveReq = (AndroidAppConfigSaveReq) o;
    return Objects.equals(this.packageName, androidAppConfigSaveReq.packageName) &&
        Objects.equals(this.fingerprint, androidAppConfigSaveReq.fingerprint) &&
        Objects.equals(this.requestID, androidAppConfigSaveReq.requestID) &&
        Objects.equals(this.clientInfo, androidAppConfigSaveReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class AndroidAppConfigSaveReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AndroidAppConfigSaveReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AndroidAppConfigSaveReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AndroidAppConfigSaveReq is not found in the empty JSON string", AndroidAppConfigSaveReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AndroidAppConfigSaveReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AndroidAppConfigSaveReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AndroidAppConfigSaveReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AndroidAppConfigSaveReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AndroidAppConfigSaveReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AndroidAppConfigSaveReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AndroidAppConfigSaveReq.class));

       return (TypeAdapter<T>) new TypeAdapter<AndroidAppConfigSaveReq>() {
           @Override
           public void write(JsonWriter out, AndroidAppConfigSaveReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AndroidAppConfigSaveReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AndroidAppConfigSaveReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AndroidAppConfigSaveReq
  * @throws IOException if the JSON string is invalid with respect to AndroidAppConfigSaveReq
  */
  public static AndroidAppConfigSaveReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AndroidAppConfigSaveReq.class);
  }

 /**
  * Convert an instance of AndroidAppConfigSaveReq to an JSON string
  *
  * @return JSON string
  */
