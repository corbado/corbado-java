...
import com.corbado.generated.model.TrackingRawListRow;
...
public class TrackingRawListRsp {
  ...
  private List<TrackingRawListRow> rows = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public TrackingRawListRsp() {
  }

  public TrackingRawListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public TrackingRawListRsp message(String message) {
  ...
  **/
  ...
  public TrackingRawListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public TrackingRawListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public TrackingRawListRsp rows(List<TrackingRawListRow> rows) {
    this.rows = rows;
    return this;
  }

  public TrackingRawListRsp addRowsItem(TrackingRawListRow rowsItem) {
    if (this.rows == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<TrackingRawListRow> getRows() {
    return rows;
  }

  public void setRows(List<TrackingRawListRow> rows) {
    this.rows = rows;
  }


  public TrackingRawListRsp paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrackingRawListRsp trackingRawListRsp = (TrackingRawListRsp) o;
    return Objects.equals(this.httpStatusCode, trackingRawListRsp.httpStatusCode) &&
        Objects.equals(this.message, trackingRawListRsp.message) &&
        Objects.equals(this.requestData, trackingRawListRsp.requestData) &&
        Objects.equals(this.runtime, trackingRawListRsp.runtime) &&
        Objects.equals(this.rows, trackingRawListRsp.rows) &&
        Objects.equals(this.paging, trackingRawListRsp.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrackingRawListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingRawListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingRawListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingRawListRsp is not found in the empty JSON string", TrackingRawListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingRawListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingRawListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingRawListRsp.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrows.size(); i++) {
        TrackingRawListRow.validateJsonElement(jsonArrayrows.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingRawListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingRawListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingRawListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingRawListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingRawListRsp>() {
           @Override
           public void write(JsonWriter out, TrackingRawListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingRawListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingRawListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingRawListRsp
  * @throws IOException if the JSON string is invalid with respect to TrackingRawListRsp
  */
  public static TrackingRawListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingRawListRsp.class);
  }

 /**
  * Convert an instance of TrackingRawListRsp to an JSON string
  *
  * @return JSON string
  */
