...
public class TrackingOSStats {
  ...
  public TrackingOSStats timePoint(String timePoint) {
  ...
  **/
  ...
  public TrackingOSStats macos(Integer macos) {
    this.macos = macos;
    return this;
  }
  ...
  **/
  ...
  public TrackingOSStats windows(Integer windows) {
  ...
  **/
  ...
  public TrackingOSStats ios(Integer ios) {
    this.ios = ios;
    return this;
  }
  ...
  **/
  ...
  public TrackingOSStats android(Integer android) {
  ...
  **/
  ...
  public TrackingOSStats other(Integer other) {
    this.other = other;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrackingOSStats trackingOSStats = (TrackingOSStats) o;
    return Objects.equals(this.timePoint, trackingOSStats.timePoint) &&
        Objects.equals(this.macos, trackingOSStats.macos) &&
        Objects.equals(this.windows, trackingOSStats.windows) &&
        Objects.equals(this.ios, trackingOSStats.ios) &&
        Objects.equals(this.android, trackingOSStats.android) &&
        Objects.equals(this.other, trackingOSStats.other);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timePoint, macos, windows, ios, android, other);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackingOSStats {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("macos");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingOSStats
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingOSStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingOSStats is not found in the empty JSON string", TrackingOSStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingOSStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingOSStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingOSStats.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingOSStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingOSStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingOSStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingOSStats.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingOSStats>() {
           @Override
           public void write(JsonWriter out, TrackingOSStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingOSStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingOSStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingOSStats
  * @throws IOException if the JSON string is invalid with respect to TrackingOSStats
  */
  public static TrackingOSStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingOSStats.class);
  }

 /**
  * Convert an instance of TrackingOSStats to an JSON string
  *
  * @return JSON string
  */
