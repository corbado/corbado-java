...
public class WebauthnSettingGetRsp {
  ...
  public WebauthnSettingGetRsp() {
  }

  public WebauthnSettingGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebauthnSettingGetRsp message(String message) {
  ...
  **/
  ...
  public WebauthnSettingGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebauthnSettingGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebauthnSettingGetRsp name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingGetRsp origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingGetRsp id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingGetRsp created(String created) {
  ...
  **/
  ...
  public WebauthnSettingGetRsp updated(String updated) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingGetRsp webauthnSettingGetRsp = (WebauthnSettingGetRsp) o;
    return Objects.equals(this.httpStatusCode, webauthnSettingGetRsp.httpStatusCode) &&
        Objects.equals(this.message, webauthnSettingGetRsp.message) &&
        Objects.equals(this.requestData, webauthnSettingGetRsp.requestData) &&
        Objects.equals(this.runtime, webauthnSettingGetRsp.runtime) &&
        Objects.equals(this.name, webauthnSettingGetRsp.name) &&
        Objects.equals(this.origin, webauthnSettingGetRsp.origin) &&
        Objects.equals(this.id, webauthnSettingGetRsp.id) &&
        Objects.equals(this.created, webauthnSettingGetRsp.created) &&
        Objects.equals(this.updated, webauthnSettingGetRsp.updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnSettingGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingGetRsp is not found in the empty JSON string", WebauthnSettingGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingGetRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingGetRsp>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingGetRsp
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingGetRsp
  */
  public static WebauthnSettingGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingGetRsp.class);
  }

 /**
  * Convert an instance of WebauthnSettingGetRsp to an JSON string
  *
  * @return JSON string
  */
