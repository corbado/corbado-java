...
import com.corbado.generated.model.EmailLinkGetRspAllOfData;
...
public class EmailLinkGetRsp {
  ...
  private EmailLinkGetRspAllOfData data;

  public EmailLinkGetRsp() {
  }

  public EmailLinkGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailLinkGetRsp message(String message) {
  ...
  **/
  ...
  public EmailLinkGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailLinkGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailLinkGetRsp data(EmailLinkGetRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public EmailLinkGetRspAllOfData getData() {
    return data;
  }

  public void setData(EmailLinkGetRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailLinkGetRsp emailLinkGetRsp = (EmailLinkGetRsp) o;
    return Objects.equals(this.httpStatusCode, emailLinkGetRsp.httpStatusCode) &&
        Objects.equals(this.message, emailLinkGetRsp.message) &&
        Objects.equals(this.requestData, emailLinkGetRsp.requestData) &&
        Objects.equals(this.runtime, emailLinkGetRsp.runtime) &&
        Objects.equals(this.data, emailLinkGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLinkGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailLinkGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailLinkGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailLinkGetRsp is not found in the empty JSON string", EmailLinkGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailLinkGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailLinkGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailLinkGetRsp.openapiRequiredFields) {
      ...
      EmailLinkGetRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailLinkGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailLinkGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailLinkGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailLinkGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailLinkGetRsp>() {
           @Override
           public void write(JsonWriter out, EmailLinkGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailLinkGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailLinkGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailLinkGetRsp
  * @throws IOException if the JSON string is invalid with respect to EmailLinkGetRsp
  */
  public static EmailLinkGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailLinkGetRsp.class);
  }

 /**
  * Convert an instance of EmailLinkGetRsp to an JSON string
  *
  * @return JSON string
  */
