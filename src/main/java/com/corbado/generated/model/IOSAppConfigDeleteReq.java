...
public class IOSAppConfigDeleteReq {
  ...
  public IOSAppConfigDeleteReq() {
  }

  public IOSAppConfigDeleteReq requestID(String requestID) {
  ...
  **/
  ...
  public IOSAppConfigDeleteReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IOSAppConfigDeleteReq iOSAppConfigDeleteReq = (IOSAppConfigDeleteReq) o;
    return Objects.equals(this.requestID, iOSAppConfigDeleteReq.requestID) &&
        Objects.equals(this.clientInfo, iOSAppConfigDeleteReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class IOSAppConfigDeleteReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IOSAppConfigDeleteReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSAppConfigDeleteReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSAppConfigDeleteReq is not found in the empty JSON string", IOSAppConfigDeleteReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSAppConfigDeleteReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSAppConfigDeleteReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSAppConfigDeleteReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSAppConfigDeleteReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSAppConfigDeleteReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSAppConfigDeleteReq.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSAppConfigDeleteReq>() {
           @Override
           public void write(JsonWriter out, IOSAppConfigDeleteReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSAppConfigDeleteReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IOSAppConfigDeleteReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IOSAppConfigDeleteReq
  * @throws IOException if the JSON string is invalid with respect to IOSAppConfigDeleteReq
  */
  public static IOSAppConfigDeleteReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSAppConfigDeleteReq.class);
  }

 /**
  * Convert an instance of IOSAppConfigDeleteReq to an JSON string
  *
  * @return JSON string
  */
