...
public class WebAuthnMediationStartReq {
  ...
  public WebAuthnMediationStartReq() {
  }

  public WebAuthnMediationStartReq username(String username) {
  ...
  **/
  ...
  public WebAuthnMediationStartReq requestID(String requestID) {
  ...
  **/
  ...
  public WebAuthnMediationStartReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnMediationStartReq webAuthnMediationStartReq = (WebAuthnMediationStartReq) o;
    return Objects.equals(this.username, webAuthnMediationStartReq.username) &&
        Objects.equals(this.requestID, webAuthnMediationStartReq.requestID) &&
        Objects.equals(this.clientInfo, webAuthnMediationStartReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebAuthnMediationStartReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnMediationStartReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnMediationStartReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnMediationStartReq is not found in the empty JSON string", WebAuthnMediationStartReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnMediationStartReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnMediationStartReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnMediationStartReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnMediationStartReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnMediationStartReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnMediationStartReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnMediationStartReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnMediationStartReq>() {
           @Override
           public void write(JsonWriter out, WebAuthnMediationStartReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnMediationStartReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnMediationStartReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnMediationStartReq
  * @throws IOException if the JSON string is invalid with respect to WebAuthnMediationStartReq
  */
  public static WebAuthnMediationStartReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnMediationStartReq.class);
  }

 /**
  * Convert an instance of WebAuthnMediationStartReq to an JSON string
  *
  * @return JSON string
  */
