...
import com.corbado.generated.model.EmailValidationResult;
...
public class ValidateEmailRsp {
  ...
  private EmailValidationResult data;

  public ValidateEmailRsp() {
  }

  public ValidateEmailRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public ValidateEmailRsp message(String message) {
  ...
  **/
  ...
  public ValidateEmailRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public ValidateEmailRsp runtime(Float runtime) {
  ...
  **/
  ...
  public ValidateEmailRsp data(EmailValidationResult data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public EmailValidationResult getData() {
    return data;
  }

  public void setData(EmailValidationResult data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidateEmailRsp validateEmailRsp = (ValidateEmailRsp) o;
    return Objects.equals(this.httpStatusCode, validateEmailRsp.httpStatusCode) &&
        Objects.equals(this.message, validateEmailRsp.message) &&
        Objects.equals(this.requestData, validateEmailRsp.requestData) &&
        Objects.equals(this.runtime, validateEmailRsp.runtime) &&
        Objects.equals(this.data, validateEmailRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidateEmailRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ValidateEmailRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidateEmailRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidateEmailRsp is not found in the empty JSON string", ValidateEmailRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidateEmailRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidateEmailRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidateEmailRsp.openapiRequiredFields) {
      ...
      EmailValidationResult.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidateEmailRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidateEmailRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidateEmailRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidateEmailRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidateEmailRsp>() {
           @Override
           public void write(JsonWriter out, ValidateEmailRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidateEmailRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ValidateEmailRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidateEmailRsp
  * @throws IOException if the JSON string is invalid with respect to ValidateEmailRsp
  */
  public static ValidateEmailRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidateEmailRsp.class);
  }

 /**
  * Convert an instance of ValidateEmailRsp to an JSON string
  *
  * @return JSON string
  */
