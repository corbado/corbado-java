...
import com.corbado.generated.model.UserEmailGetRspAllOfData;
...
public class UserEmailGetRsp {
  ...
  private UserEmailGetRspAllOfData data;

  public UserEmailGetRsp() {
  }

  public UserEmailGetRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserEmailGetRsp message(String message) {
  ...
  **/
  ...
  public UserEmailGetRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserEmailGetRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserEmailGetRsp data(UserEmailGetRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserEmailGetRspAllOfData getData() {
    return data;
  }

  public void setData(UserEmailGetRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserEmailGetRsp userEmailGetRsp = (UserEmailGetRsp) o;
    return Objects.equals(this.httpStatusCode, userEmailGetRsp.httpStatusCode) &&
        Objects.equals(this.message, userEmailGetRsp.message) &&
        Objects.equals(this.requestData, userEmailGetRsp.requestData) &&
        Objects.equals(this.runtime, userEmailGetRsp.runtime) &&
        Objects.equals(this.data, userEmailGetRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserEmailGetRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserEmailGetRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEmailGetRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserEmailGetRsp is not found in the empty JSON string", UserEmailGetRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEmailGetRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserEmailGetRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserEmailGetRsp.openapiRequiredFields) {
      ...
      UserEmailGetRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserEmailGetRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserEmailGetRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserEmailGetRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserEmailGetRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserEmailGetRsp>() {
           @Override
           public void write(JsonWriter out, UserEmailGetRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserEmailGetRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserEmailGetRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserEmailGetRsp
  * @throws IOException if the JSON string is invalid with respect to UserEmailGetRsp
  */
  public static UserEmailGetRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserEmailGetRsp.class);
  }

 /**
  * Convert an instance of UserEmailGetRsp to an JSON string
  *
  * @return JSON string
  */
