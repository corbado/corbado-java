...
public class PasskeyEvent {
   ...
   * @return the PasskeyEvent instance itself
   */
  public PasskeyEvent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.passkeyEventID, passkeyEvent.passkeyEventID) &&
        ...
        Objects.equals(this.additionalProperties, passkeyEvent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(passkeyEventID, userID, eventType, clientEnvID, processID, credentialID, expires, created, createdMs, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasskeyEvent>() {
           ...
           public PasskeyEvent read(JsonReader in) throws IOException {
             ...
             PasskeyEvent instance = thisAdapter.fromJsonTree(jsonObj);
