...
public class UserPhoneNumberCreateReq {
  ...
  public UserPhoneNumberCreateReq() {
  }

  public UserPhoneNumberCreateReq phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public UserPhoneNumberCreateReq requestID(String requestID) {
  ...
  **/
  ...
  public UserPhoneNumberCreateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserPhoneNumberCreateReq userPhoneNumberCreateReq = (UserPhoneNumberCreateReq) o;
    return Objects.equals(this.phoneNumber, userPhoneNumberCreateReq.phoneNumber) &&
        Objects.equals(this.requestID, userPhoneNumberCreateReq.requestID) &&
        Objects.equals(this.clientInfo, userPhoneNumberCreateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(phoneNumber, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserPhoneNumberCreateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserPhoneNumberCreateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPhoneNumberCreateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPhoneNumberCreateReq is not found in the empty JSON string", UserPhoneNumberCreateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPhoneNumberCreateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPhoneNumberCreateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserPhoneNumberCreateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPhoneNumberCreateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPhoneNumberCreateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPhoneNumberCreateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPhoneNumberCreateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPhoneNumberCreateReq>() {
           @Override
           public void write(JsonWriter out, UserPhoneNumberCreateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPhoneNumberCreateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserPhoneNumberCreateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserPhoneNumberCreateReq
  * @throws IOException if the JSON string is invalid with respect to UserPhoneNumberCreateReq
  */
  public static UserPhoneNumberCreateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPhoneNumberCreateReq.class);
  }

 /**
  * Convert an instance of UserPhoneNumberCreateReq to an JSON string
  *
  * @return JSON string
  */
