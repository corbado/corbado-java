...
public class UserEmailCreateReq {
  ...
  public UserEmailCreateReq() {
  }

  public UserEmailCreateReq email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public UserEmailCreateReq requestID(String requestID) {
  ...
  **/
  ...
  public UserEmailCreateReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserEmailCreateReq userEmailCreateReq = (UserEmailCreateReq) o;
    return Objects.equals(this.email, userEmailCreateReq.email) &&
        Objects.equals(this.requestID, userEmailCreateReq.requestID) &&
        Objects.equals(this.clientInfo, userEmailCreateReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserEmailCreateReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserEmailCreateReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEmailCreateReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserEmailCreateReq is not found in the empty JSON string", UserEmailCreateReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEmailCreateReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserEmailCreateReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserEmailCreateReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserEmailCreateReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserEmailCreateReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserEmailCreateReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserEmailCreateReq.class));

       return (TypeAdapter<T>) new TypeAdapter<UserEmailCreateReq>() {
           @Override
           public void write(JsonWriter out, UserEmailCreateReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserEmailCreateReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserEmailCreateReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserEmailCreateReq
  * @throws IOException if the JSON string is invalid with respect to UserEmailCreateReq
  */
  public static UserEmailCreateReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserEmailCreateReq.class);
  }

 /**
  * Convert an instance of UserEmailCreateReq to an JSON string
  *
  * @return JSON string
  */
