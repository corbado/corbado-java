...
public class PasswordManager {
   ...
   * @return the PasswordManager instance itself
   */
  public PasswordManager putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, passwordManager.id) &&
        ...
        Objects.equals(this.additionalProperties, passwordManager.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, userID, clientEnvID, credentialID, aaguid, status, score, createdMs, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "userID", "clientEnvID", "credentialID", "aaguid", "status", "score", "createdMs"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "userID", "clientEnvID", "credentialID", "aaguid", "status", "score", "createdMs"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasswordManager.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PasswordManager is not found in the empty JSON string", PasswordManager.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasswordManager>() {
           ...
           public PasswordManager read(JsonReader in) throws IOException {
             ...
             PasswordManager instance = thisAdapter.fromJsonTree(jsonObj);
