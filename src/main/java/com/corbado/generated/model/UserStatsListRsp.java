...
import com.corbado.generated.model.UserStatsListRspAllOfData;
...
public class UserStatsListRsp {
  ...
  private UserStatsListRspAllOfData data;

  public UserStatsListRsp() {
  }

  public UserStatsListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public UserStatsListRsp message(String message) {
  ...
  **/
  ...
  public UserStatsListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public UserStatsListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public UserStatsListRsp data(UserStatsListRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public UserStatsListRspAllOfData getData() {
    return data;
  }

  public void setData(UserStatsListRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserStatsListRsp userStatsListRsp = (UserStatsListRsp) o;
    return Objects.equals(this.httpStatusCode, userStatsListRsp.httpStatusCode) &&
        Objects.equals(this.message, userStatsListRsp.message) &&
        Objects.equals(this.requestData, userStatsListRsp.requestData) &&
        Objects.equals(this.runtime, userStatsListRsp.runtime) &&
        Objects.equals(this.data, userStatsListRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserStatsListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserStatsListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserStatsListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserStatsListRsp is not found in the empty JSON string", UserStatsListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserStatsListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserStatsListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserStatsListRsp.openapiRequiredFields) {
      ...
      UserStatsListRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserStatsListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserStatsListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserStatsListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserStatsListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<UserStatsListRsp>() {
           @Override
           public void write(JsonWriter out, UserStatsListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserStatsListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserStatsListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserStatsListRsp
  * @throws IOException if the JSON string is invalid with respect to UserStatsListRsp
  */
  public static UserStatsListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserStatsListRsp.class);
  }

 /**
  * Convert an instance of UserStatsListRsp to an JSON string
  *
  * @return JSON string
  */
