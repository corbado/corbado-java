...
import com.corbado.generated.model.EmailCodeSendRspAllOfData;
...
public class EmailCodeSendRsp {
  ...
  private EmailCodeSendRspAllOfData data;

  public EmailCodeSendRsp() {
  }

  public EmailCodeSendRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public EmailCodeSendRsp message(String message) {
  ...
  **/
  ...
  public EmailCodeSendRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public EmailCodeSendRsp runtime(Float runtime) {
  ...
  **/
  ...
  public EmailCodeSendRsp data(EmailCodeSendRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public EmailCodeSendRspAllOfData getData() {
    return data;
  }

  public void setData(EmailCodeSendRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailCodeSendRsp emailCodeSendRsp = (EmailCodeSendRsp) o;
    return Objects.equals(this.httpStatusCode, emailCodeSendRsp.httpStatusCode) &&
        Objects.equals(this.message, emailCodeSendRsp.message) &&
        Objects.equals(this.requestData, emailCodeSendRsp.requestData) &&
        Objects.equals(this.runtime, emailCodeSendRsp.runtime) &&
        Objects.equals(this.data, emailCodeSendRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailCodeSendRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmailCodeSendRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailCodeSendRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCodeSendRsp is not found in the empty JSON string", EmailCodeSendRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailCodeSendRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCodeSendRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailCodeSendRsp.openapiRequiredFields) {
      ...
      EmailCodeSendRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCodeSendRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCodeSendRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCodeSendRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCodeSendRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCodeSendRsp>() {
           @Override
           public void write(JsonWriter out, EmailCodeSendRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCodeSendRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCodeSendRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCodeSendRsp
  * @throws IOException if the JSON string is invalid with respect to EmailCodeSendRsp
  */
  public static EmailCodeSendRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCodeSendRsp.class);
  }

 /**
  * Convert an instance of EmailCodeSendRsp to an JSON string
  *
  * @return JSON string
  */
