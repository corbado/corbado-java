...
public class WebAuthnCredentialExistsRsp {
  ...
  public WebAuthnCredentialExistsRsp() {
  }

  public WebAuthnCredentialExistsRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebAuthnCredentialExistsRsp message(String message) {
  ...
  **/
  ...
  public WebAuthnCredentialExistsRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebAuthnCredentialExistsRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebAuthnCredentialExistsRsp exists(Boolean exists) {
    this.exists = exists;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnCredentialExistsRsp webAuthnCredentialExistsRsp = (WebAuthnCredentialExistsRsp) o;
    return Objects.equals(this.httpStatusCode, webAuthnCredentialExistsRsp.httpStatusCode) &&
        Objects.equals(this.message, webAuthnCredentialExistsRsp.message) &&
        Objects.equals(this.requestData, webAuthnCredentialExistsRsp.requestData) &&
        Objects.equals(this.runtime, webAuthnCredentialExistsRsp.runtime) &&
        Objects.equals(this.exists, webAuthnCredentialExistsRsp.exists);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, exists);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnCredentialExistsRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnCredentialExistsRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnCredentialExistsRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnCredentialExistsRsp is not found in the empty JSON string", WebAuthnCredentialExistsRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnCredentialExistsRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnCredentialExistsRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnCredentialExistsRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnCredentialExistsRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnCredentialExistsRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnCredentialExistsRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnCredentialExistsRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnCredentialExistsRsp>() {
           @Override
           public void write(JsonWriter out, WebAuthnCredentialExistsRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnCredentialExistsRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnCredentialExistsRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnCredentialExistsRsp
  * @throws IOException if the JSON string is invalid with respect to WebAuthnCredentialExistsRsp
  */
  public static WebAuthnCredentialExistsRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnCredentialExistsRsp.class);
  }

 /**
  * Convert an instance of WebAuthnCredentialExistsRsp to an JSON string
  *
  * @return JSON string
  */
