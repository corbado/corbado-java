...
public class IdentifierList {
   ...
   * @return the IdentifierList instance itself
   */
  public IdentifierList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifiers, identifierList.identifiers) &&
        ...
        Objects.equals(this.additionalProperties, identifierList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifiers, paging, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IdentifierList>() {
           ...
           public IdentifierList read(JsonReader in) throws IOException {
             ...
             IdentifierList instance = thisAdapter.fromJsonTree(jsonObj);
