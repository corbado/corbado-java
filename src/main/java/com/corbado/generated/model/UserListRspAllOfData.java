...
public class UserListRspAllOfData {
  public static final String SERIALIZED_NAME_USERS = "users";
  @SerializedName(SERIALIZED_NAME_USERS)
  private List<FullUser> users = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public UserListRspAllOfData() {
  }

  public UserListRspAllOfData users(List<FullUser> users) {
    this.users = users;
    return this;
  }

  public UserListRspAllOfData addUsersItem(FullUser usersItem) {
    if (this.users == null) {
  ...
  **/
  ...
  public List<FullUser> getUsers() {
    return users;
  }

  public void setUsers(List<FullUser> users) {
    this.users = users;
  }


  public UserListRspAllOfData paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserListRspAllOfData userListRspAllOfData = (UserListRspAllOfData) o;
    return Objects.equals(this.users, userListRspAllOfData.users) &&
        Objects.equals(this.paging, userListRspAllOfData.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserListRspAllOfData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserListRspAllOfData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserListRspAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserListRspAllOfData is not found in the empty JSON string", UserListRspAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserListRspAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserListRspAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserListRspAllOfData.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayusers.size(); i++) {
        FullUser.validateJsonElement(jsonArrayusers.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserListRspAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserListRspAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserListRspAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserListRspAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<UserListRspAllOfData>() {
           @Override
           public void write(JsonWriter out, UserListRspAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserListRspAllOfData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserListRspAllOfData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserListRspAllOfData
  * @throws IOException if the JSON string is invalid with respect to UserListRspAllOfData
  */
  public static UserListRspAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserListRspAllOfData.class);
  }

 /**
  * Convert an instance of UserListRspAllOfData to an JSON string
  *
  * @return JSON string
  */
