...
public class WebAuthnMediationStartRsp {
  ...
  public WebAuthnMediationStartRsp() {
  }

  public WebAuthnMediationStartRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebAuthnMediationStartRsp message(String message) {
  ...
  **/
  ...
  public WebAuthnMediationStartRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebAuthnMediationStartRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebAuthnMediationStartRsp challenge(String challenge) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnMediationStartRsp webAuthnMediationStartRsp = (WebAuthnMediationStartRsp) o;
    return Objects.equals(this.httpStatusCode, webAuthnMediationStartRsp.httpStatusCode) &&
        Objects.equals(this.message, webAuthnMediationStartRsp.message) &&
        Objects.equals(this.requestData, webAuthnMediationStartRsp.requestData) &&
        Objects.equals(this.runtime, webAuthnMediationStartRsp.runtime) &&
        Objects.equals(this.challenge, webAuthnMediationStartRsp.challenge);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, challenge);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnMediationStartRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnMediationStartRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnMediationStartRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnMediationStartRsp is not found in the empty JSON string", WebAuthnMediationStartRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnMediationStartRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnMediationStartRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnMediationStartRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnMediationStartRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnMediationStartRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnMediationStartRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnMediationStartRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnMediationStartRsp>() {
           @Override
           public void write(JsonWriter out, WebAuthnMediationStartRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnMediationStartRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnMediationStartRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnMediationStartRsp
  * @throws IOException if the JSON string is invalid with respect to WebAuthnMediationStartRsp
  */
  public static WebAuthnMediationStartRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnMediationStartRsp.class);
  }

 /**
  * Convert an instance of WebAuthnMediationStartRsp to an JSON string
  *
  * @return JSON string
  */
