...
import com.corbado.generated.model.WebAuthnCredentialItemRsp;
...
public class WebAuthnCredentialListRsp {
  ...
  private List<WebAuthnCredentialItemRsp> rows = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGING = "paging";
  @SerializedName(SERIALIZED_NAME_PAGING)
  private Paging paging;

  public WebAuthnCredentialListRsp() {
  }

  public WebAuthnCredentialListRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebAuthnCredentialListRsp message(String message) {
  ...
  **/
  ...
  public WebAuthnCredentialListRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebAuthnCredentialListRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebAuthnCredentialListRsp rows(List<WebAuthnCredentialItemRsp> rows) {
    this.rows = rows;
    return this;
  }

  public WebAuthnCredentialListRsp addRowsItem(WebAuthnCredentialItemRsp rowsItem) {
    if (this.rows == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<WebAuthnCredentialItemRsp> getRows() {
    return rows;
  }

  public void setRows(List<WebAuthnCredentialItemRsp> rows) {
    this.rows = rows;
  }


  public WebAuthnCredentialListRsp paging(Paging paging) {
    this.paging = paging;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnCredentialListRsp webAuthnCredentialListRsp = (WebAuthnCredentialListRsp) o;
    return Objects.equals(this.httpStatusCode, webAuthnCredentialListRsp.httpStatusCode) &&
        Objects.equals(this.message, webAuthnCredentialListRsp.message) &&
        Objects.equals(this.requestData, webAuthnCredentialListRsp.requestData) &&
        Objects.equals(this.runtime, webAuthnCredentialListRsp.runtime) &&
        Objects.equals(this.rows, webAuthnCredentialListRsp.rows) &&
        Objects.equals(this.paging, webAuthnCredentialListRsp.paging);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebAuthnCredentialListRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnCredentialListRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnCredentialListRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnCredentialListRsp is not found in the empty JSON string", WebAuthnCredentialListRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnCredentialListRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnCredentialListRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnCredentialListRsp.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrows.size(); i++) {
        WebAuthnCredentialItemRsp.validateJsonElement(jsonArrayrows.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnCredentialListRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnCredentialListRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnCredentialListRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnCredentialListRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnCredentialListRsp>() {
           @Override
           public void write(JsonWriter out, WebAuthnCredentialListRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnCredentialListRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnCredentialListRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnCredentialListRsp
  * @throws IOException if the JSON string is invalid with respect to WebAuthnCredentialListRsp
  */
  public static WebAuthnCredentialListRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnCredentialListRsp.class);
  }

 /**
  * Convert an instance of WebAuthnCredentialListRsp to an JSON string
  *
  * @return JSON string
  */
