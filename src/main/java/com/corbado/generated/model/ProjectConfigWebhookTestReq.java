...
public class ProjectConfigWebhookTestReq {
  /**
   * Gets or Sets action
   */
  ...
  public ProjectConfigWebhookTestReq() {
  }

  public ProjectConfigWebhookTestReq action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  **/
  ...
  public ProjectConfigWebhookTestReq requestID(String requestID) {
  ...
  **/
  ...
  public ProjectConfigWebhookTestReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectConfigWebhookTestReq projectConfigWebhookTestReq = (ProjectConfigWebhookTestReq) o;
    return Objects.equals(this.action, projectConfigWebhookTestReq.action) &&
        Objects.equals(this.requestID, projectConfigWebhookTestReq.requestID) &&
        Objects.equals(this.clientInfo, projectConfigWebhookTestReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectConfigWebhookTestReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectConfigWebhookTestReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectConfigWebhookTestReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectConfigWebhookTestReq is not found in the empty JSON string", ProjectConfigWebhookTestReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectConfigWebhookTestReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectConfigWebhookTestReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectConfigWebhookTestReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectConfigWebhookTestReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectConfigWebhookTestReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectConfigWebhookTestReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectConfigWebhookTestReq.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectConfigWebhookTestReq>() {
           @Override
           public void write(JsonWriter out, ProjectConfigWebhookTestReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectConfigWebhookTestReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectConfigWebhookTestReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectConfigWebhookTestReq
  * @throws IOException if the JSON string is invalid with respect to ProjectConfigWebhookTestReq
  */
  public static ProjectConfigWebhookTestReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectConfigWebhookTestReq.class);
  }

 /**
  * Convert an instance of ProjectConfigWebhookTestReq to an JSON string
  *
  * @return JSON string
  */
