...
import com.corbado.generated.model.WebauthnStatsTypeRspAllOfData;
...
public class WebauthnStatsTypeRsp {
  ...
  private WebauthnStatsTypeRspAllOfData data;

  public WebauthnStatsTypeRsp() {
  }

  public WebauthnStatsTypeRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebauthnStatsTypeRsp message(String message) {
  ...
  **/
  ...
  public WebauthnStatsTypeRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebauthnStatsTypeRsp runtime(Float runtime) {
  ...
  **/
  ...
  public WebauthnStatsTypeRsp data(WebauthnStatsTypeRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  public WebauthnStatsTypeRspAllOfData getData() {
    return data;
  }

  public void setData(WebauthnStatsTypeRspAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebauthnStatsTypeRsp webauthnStatsTypeRsp = (WebauthnStatsTypeRsp) o;
    return Objects.equals(this.httpStatusCode, webauthnStatsTypeRsp.httpStatusCode) &&
        Objects.equals(this.message, webauthnStatsTypeRsp.message) &&
        Objects.equals(this.requestData, webauthnStatsTypeRsp.requestData) &&
        Objects.equals(this.runtime, webauthnStatsTypeRsp.runtime) &&
        Objects.equals(this.data, webauthnStatsTypeRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebauthnStatsTypeRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnStatsTypeRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnStatsTypeRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnStatsTypeRsp is not found in the empty JSON string", WebauthnStatsTypeRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnStatsTypeRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnStatsTypeRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnStatsTypeRsp.openapiRequiredFields) {
      ...
      WebauthnStatsTypeRspAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnStatsTypeRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnStatsTypeRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnStatsTypeRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnStatsTypeRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnStatsTypeRsp>() {
           @Override
           public void write(JsonWriter out, WebauthnStatsTypeRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnStatsTypeRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnStatsTypeRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnStatsTypeRsp
  * @throws IOException if the JSON string is invalid with respect to WebauthnStatsTypeRsp
  */
  public static WebauthnStatsTypeRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnStatsTypeRsp.class);
  }

 /**
  * Convert an instance of WebauthnStatsTypeRsp to an JSON string
  *
  * @return JSON string
  */
