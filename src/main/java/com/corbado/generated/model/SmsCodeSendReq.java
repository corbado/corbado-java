...
public class SmsCodeSendReq {
  ...
  public SmsCodeSendReq() {
  }

  public SmsCodeSendReq phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public SmsCodeSendReq create(Boolean create) {
    this.create = create;
    return this;
  }
  ...
  **/
  ...
  public SmsCodeSendReq userFullName(String userFullName) {
  ...
  **/
  ...
  public SmsCodeSendReq templateName(String templateName) {
  ...
  **/
  ...
  public SmsCodeSendReq requestID(String requestID) {
  ...
  **/
  ...
  public SmsCodeSendReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SmsCodeSendReq smsCodeSendReq = (SmsCodeSendReq) o;
    return Objects.equals(this.phoneNumber, smsCodeSendReq.phoneNumber) &&
        Objects.equals(this.create, smsCodeSendReq.create) &&
        Objects.equals(this.userFullName, smsCodeSendReq.userFullName) &&
        Objects.equals(this.templateName, smsCodeSendReq.templateName) &&
        Objects.equals(this.requestID, smsCodeSendReq.requestID) &&
        Objects.equals(this.clientInfo, smsCodeSendReq.clientInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(phoneNumber, create, userFullName, templateName, requestID, clientInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmsCodeSendReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SmsCodeSendReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsCodeSendReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsCodeSendReq is not found in the empty JSON string", SmsCodeSendReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsCodeSendReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsCodeSendReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsCodeSendReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsCodeSendReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsCodeSendReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsCodeSendReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsCodeSendReq.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsCodeSendReq>() {
           @Override
           public void write(JsonWriter out, SmsCodeSendReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsCodeSendReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsCodeSendReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsCodeSendReq
  * @throws IOException if the JSON string is invalid with respect to SmsCodeSendReq
  */
  public static SmsCodeSendReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsCodeSendReq.class);
  }

 /**
  * Convert an instance of SmsCodeSendReq to an JSON string
  *
  * @return JSON string
  */
