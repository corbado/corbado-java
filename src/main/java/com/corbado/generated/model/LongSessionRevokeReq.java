...
public class LongSessionRevokeReq {
  ...
  public LongSessionRevokeReq() {
  }

  public LongSessionRevokeReq requestID(String requestID) {
  ...
  **/
  ...
  public LongSessionRevokeReq clientInfo(ClientInfo clientInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LongSessionRevokeReq longSessionRevokeReq = (LongSessionRevokeReq) o;
    return Objects.equals(this.requestID, longSessionRevokeReq.requestID) &&
        Objects.equals(this.clientInfo, longSessionRevokeReq.clientInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class LongSessionRevokeReq {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LongSessionRevokeReq
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongSessionRevokeReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongSessionRevokeReq is not found in the empty JSON string", LongSessionRevokeReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongSessionRevokeReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongSessionRevokeReq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongSessionRevokeReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongSessionRevokeReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongSessionRevokeReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongSessionRevokeReq.class));

       return (TypeAdapter<T>) new TypeAdapter<LongSessionRevokeReq>() {
           @Override
           public void write(JsonWriter out, LongSessionRevokeReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongSessionRevokeReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LongSessionRevokeReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LongSessionRevokeReq
  * @throws IOException if the JSON string is invalid with respect to LongSessionRevokeReq
  */
  public static LongSessionRevokeReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongSessionRevokeReq.class);
  }

 /**
  * Convert an instance of LongSessionRevokeReq to an JSON string
  *
  * @return JSON string
  */
