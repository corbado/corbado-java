...
public class WebAuthnAuthenticateSuccess {
  ...
  public WebAuthnAuthenticateSuccess() {
  }

  public WebAuthnAuthenticateSuccess httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess message(String message) {
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess requestData(RequestData requestData) {
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess runtime(Float runtime) {
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess userID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess username(String username) {
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess credentialID(String credentialID) {
  ...
  **/
  ...
  public WebAuthnAuthenticateSuccess userFullName(String userFullName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebAuthnAuthenticateSuccess webAuthnAuthenticateSuccess = (WebAuthnAuthenticateSuccess) o;
    return Objects.equals(this.httpStatusCode, webAuthnAuthenticateSuccess.httpStatusCode) &&
        Objects.equals(this.message, webAuthnAuthenticateSuccess.message) &&
        Objects.equals(this.requestData, webAuthnAuthenticateSuccess.requestData) &&
        Objects.equals(this.runtime, webAuthnAuthenticateSuccess.runtime) &&
        Objects.equals(this.userID, webAuthnAuthenticateSuccess.userID) &&
        Objects.equals(this.username, webAuthnAuthenticateSuccess.username) &&
        Objects.equals(this.credentialID, webAuthnAuthenticateSuccess.credentialID) &&
        Objects.equals(this.userFullName, webAuthnAuthenticateSuccess.userFullName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(httpStatusCode, message, requestData, runtime, userID, username, credentialID, userFullName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAuthnAuthenticateSuccess {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebAuthnAuthenticateSuccess
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAuthnAuthenticateSuccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAuthnAuthenticateSuccess is not found in the empty JSON string", WebAuthnAuthenticateSuccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAuthnAuthenticateSuccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAuthnAuthenticateSuccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAuthnAuthenticateSuccess.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAuthnAuthenticateSuccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAuthnAuthenticateSuccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAuthnAuthenticateSuccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAuthnAuthenticateSuccess.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAuthnAuthenticateSuccess>() {
           @Override
           public void write(JsonWriter out, WebAuthnAuthenticateSuccess value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAuthnAuthenticateSuccess read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebAuthnAuthenticateSuccess given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebAuthnAuthenticateSuccess
  * @throws IOException if the JSON string is invalid with respect to WebAuthnAuthenticateSuccess
  */
  public static WebAuthnAuthenticateSuccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAuthnAuthenticateSuccess.class);
  }

 /**
  * Convert an instance of WebAuthnAuthenticateSuccess to an JSON string
  *
  * @return JSON string
  */
