...
public class AuthTokenValidateRsp {
  ...
  public AuthTokenValidateRsp() {
  }

  public AuthTokenValidateRsp httpStatusCode(Integer httpStatusCode) {
  ...
  **/
  ...
  public AuthTokenValidateRsp message(String message) {
  ...
  **/
  ...
  public AuthTokenValidateRsp requestData(RequestData requestData) {
  ...
  **/
  ...
  public AuthTokenValidateRsp runtime(Float runtime) {
  ...
  **/
  ...
  public AuthTokenValidateRsp data(SessionTokenVerifyRspAllOfData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthTokenValidateRsp authTokenValidateRsp = (AuthTokenValidateRsp) o;
    return Objects.equals(this.httpStatusCode, authTokenValidateRsp.httpStatusCode) &&
        Objects.equals(this.message, authTokenValidateRsp.message) &&
        Objects.equals(this.requestData, authTokenValidateRsp.requestData) &&
        Objects.equals(this.runtime, authTokenValidateRsp.runtime) &&
        Objects.equals(this.data, authTokenValidateRsp.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthTokenValidateRsp {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuthTokenValidateRsp
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthTokenValidateRsp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthTokenValidateRsp is not found in the empty JSON string", AuthTokenValidateRsp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthTokenValidateRsp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthTokenValidateRsp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthTokenValidateRsp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthTokenValidateRsp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthTokenValidateRsp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthTokenValidateRsp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthTokenValidateRsp.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthTokenValidateRsp>() {
           @Override
           public void write(JsonWriter out, AuthTokenValidateRsp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthTokenValidateRsp read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AuthTokenValidateRsp given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthTokenValidateRsp
  * @throws IOException if the JSON string is invalid with respect to AuthTokenValidateRsp
  */
  public static AuthTokenValidateRsp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthTokenValidateRsp.class);
  }

 /**
  * Convert an instance of AuthTokenValidateRsp to an JSON string
  *
  * @return JSON string
  */
