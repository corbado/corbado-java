...
public class TrackingBrowserDetailedStats {
  ...
  public TrackingBrowserDetailedStats() {
  }

  public TrackingBrowserDetailedStats timePoint(String timePoint) {
  ...
  **/
  ...
  public TrackingBrowserDetailedStats browserName(String browserName) {
  ...
  **/
  ...
  public TrackingBrowserDetailedStats browserVersion(String browserVersion) {
  ...
  **/
  ...
  public TrackingBrowserDetailedStats cnt(Integer cnt) {
    this.cnt = cnt;
    return this;
  }
  ...
  **/
  ...
  public TrackingBrowserDetailedStats webauthn(Integer webauthn) {
  ...
  **/
  ...
  public TrackingBrowserDetailedStats platform(Integer platform) {
  ...
  **/
  ...
  public TrackingBrowserDetailedStats conditionalUi(Integer conditionalUi) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrackingBrowserDetailedStats trackingBrowserDetailedStats = (TrackingBrowserDetailedStats) o;
    return Objects.equals(this.timePoint, trackingBrowserDetailedStats.timePoint) &&
        Objects.equals(this.browserName, trackingBrowserDetailedStats.browserName) &&
        Objects.equals(this.browserVersion, trackingBrowserDetailedStats.browserVersion) &&
        Objects.equals(this.cnt, trackingBrowserDetailedStats.cnt) &&
        Objects.equals(this.webauthn, trackingBrowserDetailedStats.webauthn) &&
        Objects.equals(this.platform, trackingBrowserDetailedStats.platform) &&
        Objects.equals(this.conditionalUi, trackingBrowserDetailedStats.conditionalUi);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timePoint, browserName, browserVersion, cnt, webauthn, platform, conditionalUi);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackingBrowserDetailedStats {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrackingBrowserDetailedStats
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingBrowserDetailedStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingBrowserDetailedStats is not found in the empty JSON string", TrackingBrowserDetailedStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingBrowserDetailedStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingBrowserDetailedStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackingBrowserDetailedStats.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingBrowserDetailedStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingBrowserDetailedStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingBrowserDetailedStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingBrowserDetailedStats.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingBrowserDetailedStats>() {
           @Override
           public void write(JsonWriter out, TrackingBrowserDetailedStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingBrowserDetailedStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackingBrowserDetailedStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackingBrowserDetailedStats
  * @throws IOException if the JSON string is invalid with respect to TrackingBrowserDetailedStats
  */
  public static TrackingBrowserDetailedStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingBrowserDetailedStats.class);
  }

 /**
  * Convert an instance of TrackingBrowserDetailedStats to an JSON string
  *
  * @return JSON string
  */
