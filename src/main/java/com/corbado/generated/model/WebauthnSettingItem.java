...
public class WebauthnSettingItem {
  ...
  public WebauthnSettingItem() {
  }

  public WebauthnSettingItem name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingItem origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WebauthnSettingItem created(String created) {
  ...
  **/
  ...
  public WebauthnSettingItem updated(String updated) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebauthnSettingItem webauthnSettingItem = (WebauthnSettingItem) o;
    return Objects.equals(this.name, webauthnSettingItem.name) &&
        Objects.equals(this.origin, webauthnSettingItem.origin) &&
        Objects.equals(this.id, webauthnSettingItem.id) &&
        Objects.equals(this.created, webauthnSettingItem.created) &&
        Objects.equals(this.updated, webauthnSettingItem.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, origin, id, created, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebauthnSettingItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebauthnSettingItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebauthnSettingItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebauthnSettingItem is not found in the empty JSON string", WebauthnSettingItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebauthnSettingItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebauthnSettingItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebauthnSettingItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebauthnSettingItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebauthnSettingItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebauthnSettingItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebauthnSettingItem.class));

       return (TypeAdapter<T>) new TypeAdapter<WebauthnSettingItem>() {
           @Override
           public void write(JsonWriter out, WebauthnSettingItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebauthnSettingItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebauthnSettingItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebauthnSettingItem
  * @throws IOException if the JSON string is invalid with respect to WebauthnSettingItem
  */
  public static WebauthnSettingItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebauthnSettingItem.class);
  }

 /**
  * Convert an instance of WebauthnSettingItem to an JSON string
  *
  * @return JSON string
  */
