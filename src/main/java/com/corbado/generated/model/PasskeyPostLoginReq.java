...
public class PasskeyPostLoginReq {
   ...
   * @return the PasskeyPostLoginReq instance itself
   */
  public PasskeyPostLoginReq putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.signedPasskeyData, passkeyPostLoginReq.signedPasskeyData)&&
        Objects.equals(this.additionalProperties, passkeyPostLoginReq.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signedPasskeyData, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("signedPasskeyData"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("signedPasskeyData"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasskeyPostLoginReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PasskeyPostLoginReq is not found in the empty JSON string", PasskeyPostLoginReq.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasskeyPostLoginReq>() {
           ...
           public PasskeyPostLoginReq read(JsonReader in) throws IOException {
             ...
             PasskeyPostLoginReq instance = thisAdapter.fromJsonTree(jsonObj);
