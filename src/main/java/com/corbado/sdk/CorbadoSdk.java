 ...
 *
 * <p>
 * This class serves as the central hub for interacting with the Corbado
 * authentication system. It provides access to all major services including
 * user management, session handling, and identifier management.
 *
 * <p>
 * The SDK supports:
 *
 ...
 *
 * <p>
 * It automatically handles API client initialization, authentication, and
 * service management.
 *
...
public class CorbadoSdk {
     ...
     *
     * <p>
     * This constructor initializes the SDK with the provided configuration and
     * sets up the API client with proper authentication and headers.
     *
     * @param config the configuration object containing all necessary settings
     * @throws StandardException if there is an error initializing the API
     * client
     */
     ...
     * </ul>
     *
     * @throws StandardException if there is an error setting up the API client
     */
     ...
     *
     * <p>
     * This method retrieves the Java version from the system properties. In the
     * extremely unlikely case that the "java.version" property is not set, it
     * will return "unknown" instead of null.
     *
     * @return the Java version string, or "unknown" if the version cannot be
     * determined
     */
